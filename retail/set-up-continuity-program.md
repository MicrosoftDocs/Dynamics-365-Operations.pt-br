...
3.  Crie um produto pai que representa o programa a continuidade criada na tarefa. 2. Se adicionar esses produtos a uma ordem de venda, ** continuidade ** abre a página. Em seguida, você poderá usar essa página para criar a ordem de continuidade. O produto pai não especifica os produtos individuais que o cliente recebe em cada remessa.
