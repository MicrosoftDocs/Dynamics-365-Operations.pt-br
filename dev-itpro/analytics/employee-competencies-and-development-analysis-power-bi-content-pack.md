...
Este tópico descreve o Dynamics 365 for Operations - Conteúdo de Competências e Desenvolvimento de Funcionários do Power BI. Ele explica como acessar os relatórios incluídos no pacote de conteúdo, além de fornecer informações sobre o modelo de dados e as entidades usados para criar o pacote de conteúdo.

<a name="accessing-the-content-pack"></a>Acessando o pacote de conteúdo
--------------------------

Você pode encontrar o pacote de conteúdo Competências e Desenvolvimento de Funcionários na biblioteca de ativos compartilhados em Microsoft Dynamics Lifecycle Services (LCS). Para obter mais informações sobre como baixar o pacote de conteúdo e conectá-lo a seus dados do Microsoft Dynamics 365 for Operations, consulte [Conteúdo do Power BI no LCS da Microsoft e seus parceiros](power-bi-content-microsoft-partners.md).
...
Os dados do Dynamics 365 for Operations são usados para preencher os relatórios no pacote de conteúdo Desenvolvimento e Competências dos Funcionários. A seguinte tabela mostra as entidades nas quais o pacote de conteúdo foi baseado.
