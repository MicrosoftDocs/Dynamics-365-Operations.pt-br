...
description: "Este tópico descreve o Finance and Operations - Conteúdo de Remuneração e Benefícios do Power BI. Ele explica como acessar os relatórios incluídos no pacote de conteúdo, além de fornecer informações sobre o modelo de dados e as entidades usados para criar o pacote de conteúdo."
author: twheeloc
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
Este tópico descreve o Finance and Operations - Conteúdo de Remuneração e Benefícios do Power BI. Ele explica como acessar os relatórios incluídos no pacote de conteúdo, além de fornecer informações sobre o modelo de dados e as entidades usados para criar o pacote de conteúdo.
