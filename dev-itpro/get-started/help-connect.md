...
Após completar essas etapas, você pode abrir o painel de **Ajuda** e clicar na aba **Guias de tarefas**. Agora você verá as guias de tarefas que se aplicam à página que está sendo atualmente usada no Finance and Operations. Se nenhum guia de tarefa for encontrado, você pode inserir palavra-chave para refinar a pesquisa.
