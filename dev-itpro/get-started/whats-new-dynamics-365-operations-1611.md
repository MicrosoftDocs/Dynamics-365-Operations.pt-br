...
| Usar períodos de revisão para definir o prazo para a revisão.                                    | Você pode definir um período para avaliação de desempenho, com as datas inicial e final da revisão sendo inseridas automaticamente. Entretanto, você pode alterar essas datas padrão quando necessário.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Conteúdo de O power BI de acesso cinco o novo pacote para recursos humanos                                     | Novos blocos de conteúdo habilitam organizações de recursos humanos e gerentes recursos humanos para analisar o seguinte: Medidor de força de trabalho • Divisões demográficas por idade, por sexo, estado civil e • Compare o ano de taxas de atrito sobre o ano e consulte uma lista de motivos que funcionários da organização inserido deixando • Exiba uma lista de posições abertas, além comparação de aberto para remuneração fechada e os benefícios posições • Compare funcionários por hora e remunerados • Exiba o número de funcionários inscritos em benefícios disponíveis • Exibe funcionários ao recrutamento do tipo de emprego • Analisar os candidatos no número de candidatos, de onde venham, posições e que estão aplicando de treinamento organizacional • Curso o registro pela localização • Participação de Couse por status • A lista de funcionários e competências registrada para desenvolvimento de funcionários de cursos • Lista de habilidades retidas por funcionários • Divisão de tipos de habilidades por membro de equipe |
...
<td>Vários de LC bancárias. Formato da alocação de encargos para a Arábia Saudita</td>
</tr>
<tr class="odd">
...
| O que você pode fazer                                                                                                                                                                                                      | Por que isso é importante                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Definir configurações padrão de ordem de venda e compra, com base em qualquer dimensão do produto ativo no produto mestre. Portanto, você pode definir configurações padrão de ordem para a unidade de manutenção de estoque (SKU) ou uma SKU parcial. | Você pode especificar configurações de ordem padrão que se aplicam a uma dimensão do produto ou uma combinação de dimensões de produto ativas. ** Exemplo ** você vende um produto que T-shirt são nomeados Vertical. Esse produto está disponível em duas cores: verde e azul. Também está disponível em dois tamanhos: pequeno e médio. Cor e tamanho são dimensões de produto ativas para camiseta polo. É possível bloquear compras de todas as camisetas polo verdes, independentemente do tamanho. |
...
<td>Esse recurso é uma melhoria de produtividade. <strong>Example</strong> You sell a product that is named Polo T-shirt. Esse produto está disponível em duas cores: verde e azul. Também está disponível em dois tamanhos: pequeno e médio. Cor e tamanho são dimensões de produto ativas para camiseta polo. Quando você insere uma linha de venda para camiseta polo de cor verde e tamanho pequeno, não é preciso inserir dados nos campos <strong>Número de item</strong>, <strong>Cor</strong> e <strong>Tamanho</strong>. Você pode criar a linha seguindo uma das seguintes etapas:
<ul>
...
### <a name="personalized-product-recommendations"></a>Recomendações personalizadas de produto

| O que você pode fazer                                                                                                                                                                                                                                                                        | Por que isso é importante                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Exiba recomendações personalizadas de produto em vários touchpoints de venda (POS) determinar em que um cliente pode ser baseado interessado no histórico de compra, em itens da lista de objetivos pretendidos, e em itens que compraram online outros clientes e em lojas físicas almofariz | Para fornecedores com grandes catálogos, recomendações personalizadas ajuda o cliente com descoberta de produto e autorizam associa de armazenamento com clienteling inteligente. Passando produtos destinados os juros de um cliente e a hábitos de compra, recomendações de produto podem ajudar fornecedores com upsell podendo aprimorar a retenção de clientes. Em dynamics 365 para operações - venda para varejo, recomendações de produto são cognitivos serviços powered by e do computador do Microsoft Azure saber. |
...
| Saiba mais sobre suporte de consignação no Dynamics 365 for Operations                                                                                                         | Para obter mais informações sobre o suporte a processos de remessa, consulte [] remessa (/dynamics365/operations/scm/inventory/consignment) [] remessa, a configuração (/dynamics365/operations/scm/inventory/setup-consignment) [, crie uma ordem de reabastecimento de remessa (guia de tarefas)]http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), e ([alterar a propriedade de estoque de remessa com base na demanda de produção (guia de tarefas)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Saiba mais sobre suporte para colaboração de fornecedor no Dynamics 365 for Operations. | Para obter mais informações sobre colaboração de fornecedor, consulte [Colaboração de fornecedores com fornecedores externos](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors), [Colaboração do fornecedor com clientes](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Gerenciar usuários de colaboração do fornecedor](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users), [Configurar e manter colaboração de fornecedor](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration) e [Espaço de trabalho de faturamento de colaboração do fornecedor](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
...
<tbody>
<tr class="odd">
<td>Definir, diretamente nas linhas de ordem de venda, de onde e como a demanda deve se originar. <strong>Exemplo</strong> Crie uma linha de ordem de venda, e especificar a entrega direta como o tipo de entrega. O fornecedor primário é adicionado à linha de ordem de venda como o ponto de fornecimento.</td>
...
<tr class="even">
<td>Criar uma promessa de ordem diretamente das linhas de ordem de venda. <strong>Exemplo</strong> Crie uma linha de ordem de venda que é originária de um fornecedor intercompanhia. Deixar a linha. As datas de entrega são calculadas de acordo com a disponibilidade na empresa de fornecimento.</td>
