...
| Saiba mais sobre suporte de consignação no Dynamics 365 for Operations                                                                                                         | Para obter mais informações sobre o suporte para processos de consignação, consulte [Consignação](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Configurando consignação](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Criar uma ordem de reabastecimento de consignação (guia de tarefas)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) e [Alterar a propriedade de estoque de remessa com base na demanda de produção (guia de tarefas)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
