...
<td>Várias LC bancárias. Formato de Alocação de Carga para Arábia Saudita</td>
</tr>
<tr class="odd">
...
| Saiba mais sobre suporte de consignação no Dynamics 365 for Operations                                                                                                         | Para obter mais informações sobre o suporte para processos de consignação, consulte [Consignação](/dynamics365/operations/scm/inventory/consignment), [Configurando consignação](/dynamics365/operations/scm/inventory/set-up-consignment), [Criar uma ordem de reabastecimento de consignação (guia de tarefas)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) e [Alterar a propriedade de estoque de remessa com base na demanda de produção (guia de tarefas)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
