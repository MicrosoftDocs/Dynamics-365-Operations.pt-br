...
| Saiba mais sobre suporte de consignação no Dynamics 365 for Operations                                                                                                         | Para obter mais informações sobre o suporte para processos de consignação, consulte [Consignação](/dynamics365/operations/supply-chain/inventory/consignment), [Configurando consignação](/dynamics365/operations/supply-chain/inventory/set-up-consignment), [Criar uma ordem de reabastecimento de consignação (guia de tarefas)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) e [Alterar a propriedade de estoque de remessa com base na demanda de produção (guia de tarefas)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Saiba mais sobre suporte para colaboração de fornecedor no Dynamics 365 for Operations. | Para obter mais informações sobre colaboração de fornecedor, consulte [Colaboração de fornecedores com fornecedores externos](/dynamics365/operations/supply-chain/procurement/vendor-collaboration-work-external-vendors), [Colaboração do fornecedor com clientes](/dynamics365/operations/supply-chain/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Gerenciar usuários de colaboração do fornecedor](/dynamics365/operations/supply-chain/procurement/manage-vendor-collaboration-users), [Configurar e manter colaboração de fornecedor](/dynamics365/operations/supply-chain/procurement/set-up-maintain-vendor-collaboration) e [Espaço de trabalho de faturamento de colaboração do fornecedor](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
