---
title: "Página inicial de gerenciamento de caixa e bancos"
description: "Você pode usar o Gerenciamento de caixa e de bancos para manter as contas bancárias e os instrumentos financeiros da entidade legal associados a essas contas bancárias."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
-   [Cartas de crédito e coleções de importações](letters-of-credit-import-collections.md)
-   [Carta de garantia](letters-of-guarantee.md)
-   [Visão geral da reconciliação bancária avançada](advanced-bank-reconciliation-overview.md)
-   [Configure advanced bank reconciliation](configure-advanced-bank-reconciliation.md)
-   [Configurar a importação de reconciliação bancária avançada](set-up-advanced-bank-reconciliation-import-process.md)
-   [Reconciliar extratos bancários usando a reconciliação bancária avançada](reconcile-bank-statements-advanced-bank-reconciliation.md)
...
-   [Cenário: Manuseio de desconto à vista para pagamentos a maior](../cash-bank-management/cash-discount-handling-overpayments.md)
