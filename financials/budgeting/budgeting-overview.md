...
description: "Este tópico fornece uma visão geral dos componentes de orçamento da funcionalidade, ferramentas de orçamento, relatando recursos do Microsoft Dynamics 365 para as operações."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
Este tópico fornece uma visão geral dos componentes de orçamento da funcionalidade, ferramentas de orçamento, relatando recursos do Microsoft Dynamics 365 para as operações.
...
-   [] Documentos justificação de planejamento de orçamento (budget-planning-justification-docs.md)
...
[ferramentas![orçamento do![(]. /media/budgeting-tools.jpg)](. /media/budgeting-tools.jpg) 
...
-   ** Previsão de demanda ** com base em dados históricos de transação, você pode estimar a demanda futura de estoque e criar previsões de demanda.
