...
Ao criar um período de fechamento, selecione um período que tenha um status Aberto e com as datas que deseja usar. O novo período de fechamento copiará as datas inicial e final do período existente. O período original continuará a existir. Por exemplo, selecione o período 12, o último período no ano fiscal, e se tiver de datas do 1º de agosto ao 31 de agosto. Você digitar um nome para o período de fechamento, como o fechamento. Depois de criar o novo período de fechamento, você terá o período original e o período de fechamento. Os dois têm as datas que iniciam em 1º de agosto e terminam em 31 de agosto.
