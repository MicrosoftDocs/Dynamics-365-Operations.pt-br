...
Os valores redondos - fora de depreciação são definidos para cada registro. Os valores redondos - fora de depreciações são usados - o perfil de depreciação de ativo fixo que mostra a depreciação e o valor futuro do ativo fixo no ativo fixo, mas também nas propostas de depreciação. Insira o menor valor de depreciação que é permitido para o registro. 
