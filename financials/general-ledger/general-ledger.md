...
description: "Use a Contabilidade para definir e gerenciar os registros financeiros da entidade legal. A contabilidade é um registro de entradas de débito e crédito. Essas entradas são classificadas usando as contas listadas em um plano de contas."
author: twheeloc
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
