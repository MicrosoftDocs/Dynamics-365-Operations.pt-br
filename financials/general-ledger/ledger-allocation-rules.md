...
-   **Origem** – Esse componente é onde o usuário especifica os dados de origem da alocação. Alocação pode ser baseada nos saldos do razão (** fonte de dados = ** ** ** razão) ou valores corrigidos (** fonte de dados = ** ** valor fixo **). Quando a **Fonte de dados** estiver definida como **Razão**, os critérios de filtragem de origem devem ser definidos para a regra de alocação do razão (por exemplo, para as despesas publicitárias).
