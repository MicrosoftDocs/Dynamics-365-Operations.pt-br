...
Para obter mais informações, consulte [determinando taxas de imposto de venda com base nos campos marginais] de base e do método de cálculo (marginal-base-field.md).
