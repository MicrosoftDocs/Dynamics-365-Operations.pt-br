...
*Um valor em branco no campo **Fazer a correspondência de número de conta** significa que todas as contas correspondentes na estrutura de conta definida fazem parte da regra correspondente.
