...
### <a name="set-up-the-permission-to-move-reserved-inventory-for-individual-workers"></a>Configurar permissão para mover o estoque reservado para trabalhadores individuais
