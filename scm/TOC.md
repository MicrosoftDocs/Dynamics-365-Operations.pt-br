...
## [Visão geral de processo de produção](production-control/production-process-overview.md)
## [Plano em modo misto: combinar discreto, processo e lean sourcing](production-control/mixed-mode-plan.md)
...
### [Conteúdo de depósito do Power BI](/dynamics365/operations/dev-itpro/analytics/warehouse-power-bi-content?toc=/dynamics365/operations/scm/toc.json)
...
# Outros recursos
## [Glossário do Dynamics 365 for Operations](/dynamics365/operations/get-started/glossary?toc=/dynamics365/operations/supply-chain/toc.json)
## [Novidades ou alterações](/dynamics365/operations/dev-itpro/get-started/whats-new-changed?toc=/dynamics365/operations/supply-chain/toc.json)
