...
# <a name="set-up-consignment"></a>Remessa de instalação
...
[giro proprietários![(]. /media/inventory-owners.png)](. /media/inventory-owners.png)
...
[acompanhamento-dimensão- grupo![(]. /media/tracking-dimension-group.png)](. /media/tracking-dimension-group.png)
