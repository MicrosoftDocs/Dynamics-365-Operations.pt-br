---
title: Planejamento de trabalhos kanban para o lean manufacturing
...
# <a name="kanban-job-scheduling-for-lean-manufacturing"></a>Planejamento de trabalhos kanban para o lean manufacturing
...
O planejamento pode ser disparado automaticamente se você definir ** quantidade planejamento automático ** o parâmetro na regra kanban. Se você definir ** quantidade automático de planejamento ** a ** ** 1 cada, trabalhos kanban será planejada imediatamente quando criarem. O resultado é uma série de operações por ordem de chegada. Se você definir **Quantidade de planejamento automático** com um valor maior que 1, os trabalhos kanban serão agrupados antes de serem planejados. Este conceito permite a redução de tamanhos do kanban abaixo dos tamanhos reais do lote econômico. Por exemplo, o tamanho de lote econômico para um item específico (ou a família de itens) é 30. Em vez de criar os kanban com a quantidade de bens, 30, você pode configurar a regra kanban de forma que tem uma quantidade de bens de 10 e ** quantidade planejamento automático ** um valor de 3. ** ** Embora o planejamento automático agende os trabalhos kanban para a célula de trabalho somente quando existem três trabalhos não planejados, é totalmente transparente para o planejador e o supervisor de chão de fábrica que dois trabalhos não planejados podem estar aguardando execução. O planejador ou gerente de chão de fábrica pode executar esses dois trabalhos na produção, planejando-os manualmente ou criando kanbans adicionais.
