...
A execução de fabricação é destinada principalmente para ser usada por empresas de manufatura. Os trabalhadores podem registrar o tempo e o consumo de itens em trabalhos de produção usando a página **Registro de trabalho**. Todos os registros forem aprovados e transferidos posteriormente a módulos relevantes. A aprovação e a transferência contínuas de registros permitem que os gerentes rastreiem com facilidade os custos reais em ordens de produção.
...
| Termo                          | descrição                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Execução de fabricação       | Uma função que é usada para registrar o tempo, o consumo de material, custo em trabalhos de produção, projetos, e atividades indiretas. O registro é concluído no cliente de registro da execução de fabricação.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   ** Taxas de projeto de registro e de itens de projeto ** (disponível com tempo e participação) – funcionários podem registrar taxas (despesa) associadas a um projeto em um diário de taxas de projeto, como quilometragem e o de. ponte pedágio Os funcionários podem também registrar o consumo de itens em projetos. Isso é feito em um diário de item do projeto.
