...
1. Clique em Adicionar linha.
    * Existem duas maneiras de adicionar linhas à requisição de compra. Se você já sabe o número do produto ou sabe que está solicitando um produto que não está no catálogo de produtos, então é possível adicionar a linha diretamente com "Adicionar linha". A outra maneira é utilizar "Adicionar produtos", onde é possível usar pesquisa e filtragem para localizar os itens no catálogo de produtos.    
...
3. No campo Número de item, digite um valor.
    * Os itens disponíveis para você são limitados pela política de acesso à categoria e pelo catálogo de compras para a entidade legal compradora.   
...
10. Clique em Adicionar produto não listado às linhas para adicionar um produto que não esteja listado no catálogo de compras.
...
19. No campo Número externo do item, digite um valor.
    * Este é um número de referência para o produto que é conhecido pelo fornecedor. Por exemplo, poderia ser o número de item do produto no catálogo do próprio fornecedor.  
20. Clique em OK.
