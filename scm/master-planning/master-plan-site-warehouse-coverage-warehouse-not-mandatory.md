---
title: "Planejamento mestre o planejamento da cobertura de site e depósito, depósito não obrigatório"
...
# <a name="master-planning-for-site-and-warehouse-coverage-warehouse-not-mandatory"></a>Planejamento mestre o planejamento da cobertura de site e depósito, depósito não obrigatório
...
-   O depósito está definido como Manual. Clique ** depósitos &gt; de divisão &gt; de estoque a configuração &gt; de gerenciamento de estoque. ** Na Guia Rápida **Planejamento mestre**, consulte o campo **Manual**.
