...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Revise e modificar a nova versão de custos para o registro de conversão
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. Identifique os itens para a conversão em custo padrão
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Insira ou calcule o custo padrão pendente para cada item que está sendo convertido
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Verifique e resolva os problemas dos itens que estão sendo convertidos
...
## <a name="7-back-up-the-database-before-conversion"></a>7. Fazer backup do base de dados antes da conversão
O backup permite que você restaure o banco de dados se forem encontrados erros durante a conversão.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. Executar conversão quando o registro de conversão tem o status pronto
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. Valide e reconcilie os valores de estoque dos itens convertidos
