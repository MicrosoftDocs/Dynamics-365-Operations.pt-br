...
Um grupo de cálculo padrão é necessário na página **Parâmetros de gerenciamento de estoque e de depósito** ou um grupo de cálculo específico do produto é necessário na página **Divulgou detalhes do produto**. O sistema procura primeiro a configuração de grupo de cálculo ** detalhes liberados ** de produto na página. Se não for encontrada um grupo de cálculo, é ali ** estoque e depósito parâmetros de gerenciamento ** na página. Se o sistema não pode encontrar um grupo de cálculo, o usuário receberá um erro durante o cálculo. Um grupo de cálculo contém as regras para o modelo de preço de custo, o modelo de preço de venda e a lista de verificação de avisos. As configurações de cálculo a partir do grupo de cálculo são usadas como valores padrão na página **Cálculo de BOM** no momento do cálculo de BOM.
