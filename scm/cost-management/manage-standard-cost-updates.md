---
title: "Gerenciar atualizações de custo padrão"
description: "As atualizações para dados de custo previsto padrão podem ser gerenciadas usando duas abordagens diferentes a abordagem de uma versão e a de duas versões."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="manage-standard-cost-updates"></a>Gerenciar atualizações de custo padrão

As atualizações para dados de custo previsto padrão podem ser gerenciadas usando duas abordagens diferentes a abordagem de uma versão e a de duas versões. 
