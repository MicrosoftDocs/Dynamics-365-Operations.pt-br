...
Você pode usar a página **Ajuste de estoque disponível** para ajustar o valor de custo das quantidades de estoque disponível após a execução de um processo de fechamento de estoque. ** Observação: ** Abra ** ajuste de estoque disponível ** a página, ** fechamento e ajuste ** na página, selecione o registro de um processo de fechamento de estoque concluído, clique em ajuste ** ** &gt; ** ** disponível. **Exemplo:** você tem estas transações em fevereiro:
...
Esse item foi configurado com o modelo de estoque de (FIFO) de primeiro a entrar, primeiro a sair, e o fechamento de estoque foi executado o 28 de fevereiro. A transação de saída financeira de BRL 11.00 será liquidada no recebimento financeiro que está datado do 1º de fevereiro, e um ajuste de BRL 1.00 será feito. Os seguintes recebimentos de estoque conterão, assim, quantidades de estoque em aberto:
