...
description: Este artigo descreve os recursos novos ou alterados no Dynamics 365 Supply Chain Management 10.0.18.
author: kamaybac
ms.date: 03/01/2021
ms.topic: article
ms.prod: ''
...
Este artigo lista os recursos novos ou alterados no Microsoft Dynamics 365 Supply Chain Management 10.0.18. Esta versão tem um número de compilação de 10.0.793 e está disponível da seguinte maneira:

- **Versão preliminar:** março de 2021
- **Disponibilidade geral da versão (autoatualização):** abril de 2021
- **Disponibilidade geral da versão (atualização automática):** maio de 2021
...
- Liberação automática de ordens de compra (aprimoramento para [Execução de depósito com unidades de escala na nuvem](/dynamics365-release-plan/2021wave1/finance-operations/dynamics365-supply-chain-management/warehouse-execution-scale-units-cloud))<br> - Para obter mais informações, consulte [Cargas de trabalho de gerenciamento de depósito para unidades de escala de nuvem e de borda](../cloud-edge/cloud-edge-workload-warehousing.md).

- [Criar e exibir certificações na interface de colaboração entre fornecedores](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/create-view-certifications-vendor-collaboration-interface)<br> - Para obter mais informações, consulte [Manter certificação do fornecedor](../../finance/public-sector/manage-vendor-certification.md).

- [Arquivamento e aprimoramentos no desempenho de estoque em escala empresarial](/dynamics365-release-plan/2021wave1/finance-operations/dynamics365-supply-chain-management/enterprise-scale-inventory-performance-improvements-archiving)<br> - Para obter mais informações, consulte [Arquivo de transações de estoque](../inventory/archive-inventory-transactions.md).
...
- [Suplemento de Visibilidade de Estoque](../inventory/inventory-visibility.md)
- [Módulo Custo de entrega](../landed-cost/landed-cost-overview.md)
- [Interface de equipamento de manuseio de materiais (MHAX)](../warehousing/mhax.md)
- [Análise de ajuste da Otimização do Planejamento](../master-planning/planning-optimization/planning-optimization-fit-analysis.md)
...
O Microsoft Dynamics 365 Supply Chain Management 10.0.18 inclui atualizações de plataforma. Para saber mais, consulte [Atualizações da plataforma para a versão 10.0.18 de aplicativos de finanças e operações (maio de 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-18.md).

### <a name="bug-fixes"></a>Correções de bug

Para obter informações sobre as correções de bug incluídas em cada uma das atualizações que fazem parte do 10.0.18, faça logon no Lifecycle Services (LCS) e exiba o [Artigo da base de dados de conhecimento](https://fix.lcs.dynamics.com/Issue/Details?bugId=561679&dbType=3&qc=13bb1641c1be430ead8b21ae3d4e0f800d5b81c39b3a56e890db1de7ede59e46).
