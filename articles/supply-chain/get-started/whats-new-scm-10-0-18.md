...
O Microsoft Dynamics 365 Supply Chain Management 10.0.18 inclui atualizações de plataforma. Para saber mais, consulte [Atualizações de plataforma para a versão 10.0.18 de aplicativos de finanças e operações (maio de 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-18.md).
