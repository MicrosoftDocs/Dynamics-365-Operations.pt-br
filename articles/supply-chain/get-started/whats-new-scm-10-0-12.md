...
Este tópico lista os recursos novos ou alterados no Microsoft Dynamics 365 Supply Chain Management 10.0.12. Esta versão tem um número de compilação de 10.0.507 e está disponível da seguinte maneira:
