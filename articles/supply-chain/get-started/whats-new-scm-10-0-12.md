...
description: Este artigo descreve os recursos novos ou alterados no Dynamics 365 Supply Chain Management 10.0.12.
author: kamaybac
ms.date: 05/29/2020
ms.topic: article
ms.prod: ''
...
Este artigo lista os recursos novos ou alterados no Microsoft Dynamics 365 Supply Chain Management 10.0.12. Esta versão tem um número de compilação de 10.0.507 e está disponível da seguinte maneira:
...
O Microsoft Dynamics 365 Supply Chain Management 10.0.12 inclui atualizações de plataforma. Para saber mais, consulte [Atualizações da plataforma para a versão 10.0.12 dos aplicativos de finanças e operações (agosto de 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-10-0-12.md).
