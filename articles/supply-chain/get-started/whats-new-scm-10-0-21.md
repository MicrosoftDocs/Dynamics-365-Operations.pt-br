...
**Mensagem de aviso**: falha na execução do script [SetupDiagnostics] na VM

A implantação funcionará apesar do aviso, mas os seguintes problemas conhecidos podem ocorrer no Lifecycle Services (LCS):
...
| Estoque&nbsp;e&nbsp;logística | [Digitalizar códigos de barras no depósito usando padrões de formato GS1](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/scan-barcodes-warehouse-using-gs1-format-standards) | *Em breve*<!-- KFM: Add doc link when ready. --> |
| Estoque&nbsp;e&nbsp;logística | Lances lacrados <!-- KFM: Add RP link when available --> | *Em breve*<!-- KFM: Add doc link when ready. --> |
...
| Estoque&nbsp;e&nbsp;logística | [Instruções da etapa do aplicativo de depósito](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/warehouse-management-mobile-app-step-instructions) | *Em breve*<!-- KFM: Add doc link when ready --> |
...
| Planejamento Mestre | (Versão Preliminar) Suporte ao MRP baseado em prioridade para a Otimização de Planejamento | Esta versão prévia do recurso da Otimização de Planejamento habilita o planejamento mestre baseado em prioridade de planejamento com ponto de reordenação. As alterações realçadas incluem: campo **Prioridade de planejamento** nas linhas de ordem de venda, linhas de ordem de compra, previsão de demanda e ordens planejadas; uma nova opção de código de cobertura; campo **Cobertura de item** para ponto de reordenação; os formulários de configuração do planejamento mestre para controlar a configuração da prioridade de planejamento; e lógica de cálculo da Otimização de Planejamento para definir e respeitar a prioridade de planejamento. |
