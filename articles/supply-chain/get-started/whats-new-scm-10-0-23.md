...
Este tópico lista os recursos novos ou alterados na versão preliminar da versão 10.0.23 do Microsoft Dynamics 365 Supply Chain Management. Esta versão tem um número de compilação de 10.0.1037 e está disponível da seguinte maneira:
...
| Vendas e marketing | Limpar histórico de atualizações de ordens de venda | Esse recurso permite que você limpe registros históricos temporários relacionados a atualizações de ordens de venda. Ele adiciona um novo botão chamado **Limpar histórico de atualização de vendas** ao Painel de Ações das páginas de detalhes e lista para ordens de venda. |
