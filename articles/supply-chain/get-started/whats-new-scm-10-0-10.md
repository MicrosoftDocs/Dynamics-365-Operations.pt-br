...
description: Este artigo descreve os recursos novos ou alterados no Dynamics 365 Supply Chain Management 10.0.10.
author: kamaybac
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
Este artigo lista os recursos novos ou alterados no Microsoft Dynamics 365 Supply Chain Management 10.0.10. Esta versão tem um número de compilação de 10.0.420 e está disponível da seguinte maneira:
...
O Dynamics 365 Supply Chain Management 10.0.10 inclui atualizações de plataforma. Para saber mais, consulte [Atualizações da plataforma para a versão 10.0.10 de aplicativos de finanças e operações](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md).
