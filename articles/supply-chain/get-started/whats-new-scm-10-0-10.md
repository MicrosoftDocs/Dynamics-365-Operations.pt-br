...
Este tópico lista os recursos novos ou alterados no Microsoft Dynamics 365 Supply Chain Management 10.0.10. Esta versão tem um número de compilação de 10.0.420 e está disponível da seguinte maneira:

- **Versão de pré-visualização:** março de 2020
- **Disponibilidade geral (autoatualização):** abril de 2020
- **Atualização automática:** maio de 2020
...
- [Aprimoramento para usar as marcas de peso variável existentes com gerenciamento de depósito](/dynamics365-release-plan/2020wave1/dynamics365-supply-chain-management/enhancement-use-existing-catch-weight-tags-warehouse-management)
...
O Dynamics 365 Supply Chain Management 10.0.10 inclui atualizações de plataforma. Para saber mais, consulte [Atualizações de plataforma para a versão 10.0.10 dos aplicativos do Finance and Operations](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md).

### <a name="bug-fixes"></a>Correções de bug

Para obter informações sobre as correções de bug incluídas nesta atualização, faça logon no Lifecycle Services (LCS) e exiba o [Artigo da base de dados de conhecimento](https://fix.lcs.dynamics.com/Issue/Details?bugId=424137&dbType=3&qc=bf63d49dcc96e51eb42ac1dd66c6c5e5d7548f1e176f729e324ea3353b9860cb).
