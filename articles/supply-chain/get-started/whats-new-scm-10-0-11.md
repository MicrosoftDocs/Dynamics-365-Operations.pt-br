...
description: Este artigo descreve os recursos novos ou alterados no Dynamics 365 Supply Chain Management 10.0.11.
author: kamaybac
ms.date: 04/17/2020
ms.topic: article
ms.prod: ''
...
Este artigo lista os recursos novos ou alterados no Microsoft Dynamics 365 Supply Chain Management 10.0.11. Esta versão tem um número de compilação de 10.0.464 e está disponível da seguinte maneira:
...
O Microsoft Dynamics 365 Supply Chain Management 10.0.11 inclui atualizações de plataforma. Para saber mais, consulte [Atualizações de plataforma para a versão 10.0.11 de aplicativos de Finanças e Operações (Julho de 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-35.md).
