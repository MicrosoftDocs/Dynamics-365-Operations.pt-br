...
Este tópico lista os recursos novos ou alterados no Microsoft Dynamics 365 Supply Chain Management, versão 10.0.14. Esta versão tem um número de compilação de 10.0.605 e está disponível da seguinte maneira:
