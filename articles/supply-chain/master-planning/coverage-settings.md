...
description: Este artigo fornece informações sobre as configurações de cobertura que o agendamento do planejamento mestre usa para calcular os requisitos do item.
author: t-benebo
ms.date: 09/13/2019
ms.topic: article
ms.prod: ''
