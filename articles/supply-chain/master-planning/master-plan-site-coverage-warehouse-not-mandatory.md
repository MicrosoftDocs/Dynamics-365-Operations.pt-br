...
description: Este artigo descreve como um item com o conjunto de dimensões do local da cobertura é planejado.
author: t-benebo
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Este artigo descreve como um item com o conjunto de dimensões do local da cobertura é planejado.
