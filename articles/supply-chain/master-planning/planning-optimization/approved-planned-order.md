...
description: Este artigo fornece informações sobre como exibir, gerenciar e aprovar ordens planejadas.
author: t-benebo
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9740949"
---
# <a name="view-manage-and-approve-planned-orders"></a>Exibir, gerenciar e aprovar ordens planejadas

[!include [banner](../../includes/banner.md)]

Este artigo fornece informações sobre como exibir, gerenciar e aprovar ordens planejadas.
