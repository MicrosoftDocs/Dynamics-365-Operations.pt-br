...
description: Este tópico descreve os cenários de extensão na Otimização de Planejamento.
author: t-benebo
ms.date: 08/05/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8468878"
---
# <a name="planning-optimization-extensibility"></a>Extensibilidade da Otimização de Planejamento

[!include [banner](../../includes/banner.md)]

Este tópico descreve os cenários de extensão que estão relacionados a um planejamento e fornecidos na Otimização de Planejamento. Esses recursos estão disponíveis a partir da versão 10.0.13 do Microsoft Dynamics 365 Supply Chain Management.
