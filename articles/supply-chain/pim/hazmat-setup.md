...
description: Este artigo explica como configurar os dados necessários para classificar itens como materiais perigosos. Quando você cria uma ordem de venda que inclui um item classificado como um material perigoso, o sistema gera uma documentação de materiais perigosos para essa ordem de venda quando ela é enviada.
author: t-benebo
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
