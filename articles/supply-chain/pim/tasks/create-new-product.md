...
Este tópico descreve como criar um novo produto compartilhado. Geralmente é realizado por um designer do produto. A empresa de dados demo usada para criar esta tarefa é USMF.
...
1. Selecione **Grupos de dimensões** para abrir a caixa de diálogo suspensa.
2. No campo **Grupo de dimensões de armazenamento**, insira ou selecione um valor. O grupo de dimensões de armazenamento determina quais dimensões de estoque você deve inserir em cada transação para o produto e como são rastreados no estoque.  
