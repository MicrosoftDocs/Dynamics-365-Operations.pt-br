...
| Entidade | Nome do árvore de objetos de aplicativo (AOT) (tipo) | Anotações |
|--------|-------------------------------------------|-------|
...
| Item - código de barras | EcoResProductBarcodeEntity | Esta entidade é usada para exportar produtos e códigos de barras. |
