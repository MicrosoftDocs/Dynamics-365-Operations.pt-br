...
description: Este artigo descreve como configurar informações de remessa para o módulo Custo de entrega.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
Este artigo descreve como configurar informações de remessa para o módulo **Custo de entrega**.
