...
description: Este artigo descreve como trabalhar com fólios. Um fólio geralmente consiste em mercadorias de um fornecedor para uma entidade ou empresa por remessa. As mercadorias em um fólio podem estar em um contêiner ou podem ser espalhadas entre vários contêineres.
author: Weijiesa
ms.date: 12/14/2020
ms.topic: article
ms.prod: ''
...
Um fólio costuma ser determinado pelas regulamentações alfandegárias. Ele consiste em mercadorias de um fornecedor para uma entidade ou empresa por remessa. As mercadorias em um fólio são gerenciadas em um contêiner.
...
A FastTab **Fólio** na exibição **Linhas** mostra informações sobre o fólio. A maioria dessas informações também aparecem na exibição **Cabeçalho**, conforme descrito anteriormente neste artigo.
