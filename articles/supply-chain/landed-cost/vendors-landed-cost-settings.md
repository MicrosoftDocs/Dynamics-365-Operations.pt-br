...
description: Este artigo descreve os novos campos que são adicionados à página Fornecedores existente ao habilitar o módulo Custo de entrega. Use esses campos para configurar os fornecedores que serão usados juntamente com recursos de Custo de entrega.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
