...
description: Este artigo descreve como configurar informações de entrega para o módulo Custo de entrega.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895602"
---
# <a name="delivery-information-setup"></a>Configuração de informações de entrega

[!include [banner](../../includes/banner.md)]

Este artigo descreve como configurar informações de entrega para o módulo **Custo de entrega**.
