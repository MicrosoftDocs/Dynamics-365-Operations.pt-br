...
description: Este tópico fornece informações sobre atividades de contêiner, que são usadas para rastrear o progresso de contêineres de remessa.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
