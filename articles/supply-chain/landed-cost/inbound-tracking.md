...
description: Este artigo explica como você pode usar a página Acompanhamento de entrada para rastrear o progresso de viagens e os percursos do contêiner de remessa.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
