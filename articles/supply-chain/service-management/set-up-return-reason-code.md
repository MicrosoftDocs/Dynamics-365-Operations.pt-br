...
4.  No campo **Descrição**, digite uma frase curta para explicar como o grupo será usado.
...
3.  No campo **Código de motivo de devolução**, insira texto para identificar esse código.

4.  No campo **Descrição**, insira texto para descrever o código de motivo de devolução.

5.  Use a lista suspensa **Grupo de códigos de motivo de devolução** para adicionar o código a um grupo de códigos de motivo de devolução.

## <a name="see-also"></a>Consulte também

[Grupos de códigos de motivo de devolução (formulário)](https://technet.microsoft.com/en-us/library/hh209604\(v=ax.60\))

[Códigos de motivo de devolução (formulário)](https://technet.microsoft.com/en-us/library/hh227372\(v=ax.60\))
