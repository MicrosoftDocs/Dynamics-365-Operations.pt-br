---
title: Princípios de redução de reembolsos
description: Este artigo descreve como configurar princípios de redução. Os princípios de redução controlam o comportamento quando vários reembolsos se aplicam ao mesmo item ou transação.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
