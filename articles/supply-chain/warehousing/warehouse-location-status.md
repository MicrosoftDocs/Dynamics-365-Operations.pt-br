...
1. No dispositivo móvel, Acesse **Entrada \> Recebimento de compra**.
...
1. No dispositivo móvel, Acesse **Entrada \> Armazenamento de compra**.
...
1. No Dynamics 365 Supply Chain Management, Acesse **Gerenciamento de depósito \> Configuração \> Depósito \> Localizações**.
...
1. No dispositivo móvel, Acesse **Qualidade \> Movimento**.
...
1. No dispositivo móvel, Acesse **Saída \> Separação de venda**.
