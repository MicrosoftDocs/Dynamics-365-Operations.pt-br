...
Este tópico descreve como configurar parâmetros de depósito para o processamento do ciclo. Você pode usar o processamento do ciclo para agrupar o trabalho de separação para várias ordens de serviço em um único ciclo.
