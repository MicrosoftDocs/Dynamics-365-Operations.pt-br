---
title: Digitalizar códigos de barras usando uma câmera no aplicativo móvel Warehouse Management
description: Este artigo explica como configurar o aplicativo móvel de gerenciamento de depósito para digitalizar códigos de barras usando uma câmera em um dispositivo móvel.
author: Mirzaab
ms.date: 01/03/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8862327"
---
# <a name="scan-bar-codes-using-a-camera-in-the-warehouse-management-mobile-app"></a>Digitalizar códigos de barras usando uma câmera no aplicativo móvel Warehouse Management

[!include [banner](../includes/banner.md)]

Este artigo explica como configurar o aplicativo móvel de gerenciamento de depósito para digitalizar códigos de barras usando uma câmera em um dispositivo móvel.
