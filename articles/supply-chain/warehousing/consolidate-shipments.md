...
---
# <a name="consolidate-shipments-by-using-shipment-consolidation-policies"></a>Consolidar remessas usando políticas de consolidação de remessa

[!include [banner](../includes/banner.md)]

Os seguintes cenários explicam o processo de consolidação de remessa que usa políticas de consolidação de remessa durante a liberação automatizada e manual para o depósito:
