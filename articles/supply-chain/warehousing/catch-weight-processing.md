...
description: Este artigo descreve como usar modelos de trabalho e diretivas de localização para determinar como e onde o trabalho é realizado no depósito.
author: perlynne
ms.date: 08/13/2020
ms.topic: article
ms.prod: ''
