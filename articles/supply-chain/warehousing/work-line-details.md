...
description: Este artigo fornece informações sobre a página Detalhes da linha de trabalho, que mostra uma lista abrangente, classificável e filtrável das linhas de trabalho individuais no sistema.
author: Mirzaab
ms.date: 07/01/2020
ms.topic: article
ms.prod: ''
