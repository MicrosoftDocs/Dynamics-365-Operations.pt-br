...
description: Este artigo descreve como você pode usar o reabastecimento imediato para reabastecer o estoque quando uma diretiva de local não atribua o estoque.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
