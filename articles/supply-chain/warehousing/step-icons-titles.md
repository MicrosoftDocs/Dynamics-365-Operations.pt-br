...
<tr>
<td><img src="media/step-icons-whs-adjustment-type.png" alt="WMS adjustment type step icon" title="Ícone de etapa do tipo de ajuste WMS"><br>WHSAdjustmentType</td>
<td><img src="media/step-icons-whs-receiving-exception.png" alt="WMS receiving exception step icon" title="Ícone de etapa de exceção de recebimento WMS"><br>WHSReceivingException</td>
