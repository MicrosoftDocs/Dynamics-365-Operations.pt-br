...
> [!NOTE]
> Este recurso foi substituído. Para obter mais informações, consulte [Recursos removidos ou substituídos](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
