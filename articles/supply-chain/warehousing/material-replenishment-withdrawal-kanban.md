...
description: Este artigo descreve como o kanban de retirada é usado para o reabastecimento de material para atividades de fabricação.
author: perlynne
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863698"
---
# <a name="replenishment-with-withdrawal-kanbans"></a>Reabastecimento com kanbans de retirada

[!include [banner](../includes/banner.md)]

Este artigo descreve como o kanban de retirada é usado para o reabastecimento de material para atividades de fabricação.
