...
1. Digite as seguintes informações:
    ...
    - **Recurso do Active directory** – Especifique a URL raiz do Supply Chain Management.
        ...
        > Verifique se o certificado HTTPS (SSL) é válido.
