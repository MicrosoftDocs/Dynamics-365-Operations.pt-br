...
Este cenário mostra como as configurações descritas anteriormente neste tópico afetam as operações de depósito durante o processamento de uma ordem de venda. Este cenário usa os dados de demonstração da **USMF** junto com outros valores de demonstração fornecidos nessas instruções de configuração.
