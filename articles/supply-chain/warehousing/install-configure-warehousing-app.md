...
3.  No portal de Azure, no painel de navegação esquerdo, clique em **Azure Active Directory**.
...
5.  Na lista, clique em **Registros de aplicativos**. 
...
7.  Insira um nome para o aplicativo e selecione **Contas somente neste diretório organizacional**. Clique em **Registrar**.  
...
8.  O novo registro de aplicativo será aberto. 
...
10. Clique em **Certificado e segredos** no painel **Gerenciar** . Clique em **Novo segredo do cliente**. 
...
11. Crie uma chave inserindo uma descrição de chave e uma duração na seção **Senhas**. Clique em **Adicionar** e copie a chave. Esta chave será mencionada posteriormente como **Segredo do cliente**. 
...
1.  Crie um usuário que corresponda às credenciais de usuário do aplicativo Warehousing.
    ...
    3.  Atribua o usuário do dispositivo móvel do Warehouse, conforme mostrado na seguinte captura de tela. 
...
2.  Associe o aplicativo Azure Active Directory ao usuário do aplicativo Warehousing.
    ...
    3.  Insira o **ID do Cliente** (obtido na última seção), forneça um nome e selecione o usuário criado anteriormente. É recomendável marcar todos os dispositivos para que você possa remover facilmente o acesso deles ao Supply Chain Management desta página, em caso de perda. 
...
2.  Desmarque o campo **Modo de demonstração**. <br>
...
3.  Digite as seguintes informações: 
    ...
    + **Recurso do Azure Active Directory** - O recurso do Azure AD exibe a URL raiz do Supply Chain Management. 
    
        > [!NOTE]
        > Não termine esse campo com um caractere de barra (/). 
