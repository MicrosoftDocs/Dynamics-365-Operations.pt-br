...
<span data-ttu-id="757f6-108">O aplicativo de depósito do Microsoft Dynamics 365 for Finance and Operations foi testado com uma seleção de dispositivos habilitados para Android para a digitalização de códigos de barras.</span><span class="sxs-lookup"><span data-stu-id="757f6-108">The Warehousing app for Microsoft Dynamics 365 for Finance and Operations has been tested with a selection of Android powered devices for bar code scanning.</span></span> <span data-ttu-id="757f6-109">Esses testes abrangem apenas uma amostra dos dispositivos disponíveis no mercado.</span><span class="sxs-lookup"><span data-stu-id="757f6-109">These tests only cover a sample of the devices that are available on the market.</span></span>

<span data-ttu-id="757f6-110">Como cliente, recomendamos que você teste o aplicativo móvel de digitalização de depósito em hardware selecionado antes de escolher o hardware que você deseja comprar.</span><span class="sxs-lookup"><span data-stu-id="757f6-110">As a customer, we recommend that you test the Warehouse mobile scanning app on selected hardware before you decide on the hardware that you want to buy.</span></span>
