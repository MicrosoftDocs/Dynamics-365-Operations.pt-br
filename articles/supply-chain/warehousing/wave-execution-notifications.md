...
description: Este artigo descreve as notificações de execução do ciclo e explica como configurá-las.
author: Mirzaab
ms.date: 08/09/2022
ms.topic: article
ms.prod: ''
