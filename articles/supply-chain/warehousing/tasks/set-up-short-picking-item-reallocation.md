...
description: Este artigo mostra como permitir que os trabalhadores do depósito encontrem rapidamente locais alternativos se não houver estoque suficiente no local para o qual eles foram direcionados.
author: Mirzaab
ms.date: 06/29/2020
