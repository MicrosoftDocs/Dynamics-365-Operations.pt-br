...
Na ilustração a seguir, (a) é a BOM dos produtos H e peças F e G, e (b) é a planilha de roteiro dos produtos H e peça F.

![Exemplo de uma estrutura de BOM em dois níveis.](media/product-H-part-F.png)
...
![A BOM de Engenharia do produto H.](media/product-H-part-B.png)
...
![O tipo de linha fantasma usado em estruturas de BOM de vários níveis.](media/product-G-route-sheet-G.png)
...
![Exemplo de uma rede de roteiro usada em uma BOM de vários níveis.](media/product-G-part-F.png)

Na ilustração a seguir, (a) é a BOM do produto G e peça F, e (b) é a planilha de roteiro do produto G e peça F.

![A BOM para o produto G e a peça F e a folha de roteiro para o produto G e a peça F.](media/product-G-part-F-with-route-sheet.png)
