...
Esse tópico o ajudará a criar um passo a passo da subcontratação na fabricação no Microsoft Dynamics 365 for Finance and Operations. A primeira parte desse tópico descreve a configuração dos dados. A segunda parte fornece orientações sobre as etapas do passo a passo.
