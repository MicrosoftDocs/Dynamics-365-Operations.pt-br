...
Esse tópico ajudará você a criar um passo a passo de subcontratação de fabricação no Microsoft Dynamics 365 for Finance and Operations. A primeira parte desse tópico descreve a configuração dos dados. A segunda parte fornece orientações sobre as etapas do passo a passo.
