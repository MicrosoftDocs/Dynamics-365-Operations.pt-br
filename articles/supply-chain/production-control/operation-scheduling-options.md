...
description: Este artigo descreve as opções para o plano de operações. Você pode usar o plano de operações para fornecer uma estimativa geral do processo de produção ao longo do tempo.
...
ms.locfileid: "8907251"
---
# <a name="operations-scheduling-options"></a>Opções de plano de operações

[!include [banner](../includes/banner.md)]

Este artigo descreve as opções para o plano de operações. Você pode usar o plano de operações para fornecer uma estimativa geral do processo de produção ao longo do tempo.
