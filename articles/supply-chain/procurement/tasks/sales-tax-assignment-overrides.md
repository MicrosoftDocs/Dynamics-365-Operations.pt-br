...
4. Clique em Salvar.
5. Feche a página.
6. Vá para Varejo e comércio > Configuração de canal > Impostos > Substituições de impostos.
7. Clique em Novo.
...
13. Clique em Salvar.
14. Feche a página.
15. Vá para Varejo e comércio > Configuração de canal > Impostos > Grupos de substituições de impostos.
