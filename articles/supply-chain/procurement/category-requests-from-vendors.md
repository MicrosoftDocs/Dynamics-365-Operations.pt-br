...
description: Este artigo descreve como os fornecedores podem solicitar categorias de compras para sua conta. Também descreve o processo de aprovação que é preenchido pelos agentes de compras.
