...
description: Este artigo descreve como estabelecer valores comuns usados para parâmetros em várias partes do gerenciamento de alterações de engenharia.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
