...
description: Este artigo descreve as diferentes opções disponíveis para reservar estoque.
author: yufeihuang
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Este artigo descreve as diferentes opções disponíveis para reservar estoque.
