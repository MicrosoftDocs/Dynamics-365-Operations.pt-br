...
description: Este artigo fornece um exemplo que mostra como adicionar campos estendidos às exibições INVENTORSITEONHANDENTITY e INVENTWAREHOUSEONHANDENTITY, de forma que os recursos das entidades de dados disponíveis de estoque possam trabalhar com as extensões.
author: yufeihuang
ms.date: 07/27/2020
ms.topic: article
ms.prod: ''
