...
description: Este artigo descreve como criar testes que possam ser usados para ordens de qualidade no Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857595"
---
# <a name="quality-management-tests"></a>Testes de gerenciamento de qualidade

[!include [banner](../includes/banner.md)]

Este artigo descreve como criar testes que possam ser usados para ordens de qualidade no Microsoft Dynamics 365 Supply Chain Management.
