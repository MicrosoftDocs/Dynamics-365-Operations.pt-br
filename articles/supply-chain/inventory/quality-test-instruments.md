...
description: Este artigo descreve como criar instrumentos de teste que possam ser usados para testes em ordens de qualidade no Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857653"
---
# <a name="quality-management-test-instruments"></a>Instrumentos de teste de gerenciamento de qualidade

[!include [banner](../includes/banner.md)]

Este artigo descreve como criar instrumentos de teste que possam ser usados para testes em ordens de qualidade no Microsoft Dynamics 365 Supply Chain Management.
