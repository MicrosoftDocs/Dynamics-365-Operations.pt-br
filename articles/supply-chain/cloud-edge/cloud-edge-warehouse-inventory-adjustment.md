...
description: Este artigo fornece informações sobre o diário de ajuste de estoque de depósito e o processamento quando você está usando unidades de escala.
author: perlynne
ms.date: 04/22/2021
ms.topic: article
ms.prod: ''
