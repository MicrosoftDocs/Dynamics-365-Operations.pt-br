...
Para obter informações sobre o Dynamics 365 Finance, acesse a página [Home page de gerenciamento financeiro](../finance/index.md).

## <a name="videos"></a>Vídeos

Estes vídeos curtos ajudam você a conhecer os novos recursos incluídos no Microsoft Dynamics 365 for Finance and Operations versão 8.0 (abril de 2018).
