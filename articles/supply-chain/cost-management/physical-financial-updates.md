...
description: Este artigo fornece uma visão geral dos tipos de transação que aumentam ou diminuem quantidades em estoque.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Este artigo fornece uma visão geral dos tipos de transação que aumentam ou diminuem quantidades em estoque. 
