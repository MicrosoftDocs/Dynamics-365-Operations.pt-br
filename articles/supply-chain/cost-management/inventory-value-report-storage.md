...
## <a name="turn-on-the-inventory-value-report-storage-feature"></a>Habilite o recurso Armazenamento de relatórios de valor de estoque

O relatório **Valor de estoque** padrão está habilitado por padrão. No entanto, se quiser gerar o relatório **Armazenamento de relatórios de valor de estoque** mais avançado, você deverá ativar o recurso no sistema. Os administradores podem usar as configurações de [gerenciamento de recursos](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) para verificar o status do recurso e ativá-lo se necessário. No espaço de trabalho **Gerenciamento de recursos**, o recurso está listado da seguinte forma:

- **Módulo:** *Gerenciamento de custos*
- **Nome do recurso:** *Armazenamento de relatórios de valor de estoque*
