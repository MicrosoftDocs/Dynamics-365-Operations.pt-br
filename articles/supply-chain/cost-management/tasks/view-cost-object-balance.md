...
3. Use o Filtro Rápido para filtrar o campo Número de item com o valor 'm0004'.
4. No Painel de Ação, clique em Gerenciar custos.
5. Clique em Objetos de custo.
6. Clique em Quantidade física.
7. Clique em Exibição de dimensões.
