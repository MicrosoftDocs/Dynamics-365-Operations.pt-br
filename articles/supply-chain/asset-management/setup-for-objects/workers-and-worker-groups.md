...
description: Este artigo explica os funcionários de manutenção e os grupos de trabalhadores no Gerenciamento de ativos.
...
Este artigo explica os funcionários de manutenção e os grupos de trabalhadores no Gerenciamento de ativos. No Gerenciamento de ativos, você pode conectar funcionários de manutenção a locais funcionais. (Para obter mais informações sobre locais funcionais, consulte [Criar locais funcionais](../functional-locations/create-functional-locations.md).) Esta funcionalidade pode ser útil se, por exemplo, você estiver agendando um trabalho de manutenção em um computador que localizado em um local funcional 01 e quiser alocar funcionários de manutenção do mesmo local para executar o trabalho.
