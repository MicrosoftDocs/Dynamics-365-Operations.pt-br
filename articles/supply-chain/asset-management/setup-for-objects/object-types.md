...
Este tópico explica como criar tipos de ativo. Também mostra os elementos relacionados aos tipos de ativo. O tipos de ativo são usados como categorias gerais para ativos. Os exemplos incluem máquinas CNC, equipamento de medição e motores de caminhão. Os tipos de ativo são usados para gerenciar os tipos de trabalho (tarefas de manutenção), os estados de ciclo de vida de ativo, medidas de ativo, atributos de ativo, modelos de avaliação de condição e modelos de ativo que podem ser selecionados para um ativo. Quando cria um ativo, você deve especificar o tipo de ativo.
...
7. Selecione **Salvar**.
8. Na Guia Rápida **Tipos de trabalho**, selecione os tipos de trabalho que devem estar relacionados ao tipo de ativo:

    - Para selecionar um tipo de trabalho, selecione-o no campo **Tipos de trabalho restantes** e selecione o botão de seta para a direita ![Botão de seta para a direita](media/29-setup-for-objects.png) para movê-lo para a seção **Tipos de trabalho selecionados**.
    - Para selecionar todos os tipos de trabalhos disponíveis, selecione o botão ![seta Encaminhar todos](media/30-setup-for-objects.png). Todos os tipos de trabalho são transferidos do campo **Tipos de trabalho restantes** para o campo **Tipos de trabalho selecionados**.
    - Para cancelar a seleção de um tipo de trabalho, selecione-o no campo **Tipos de trabalho selecionados** e selecione o botão de seta para a esquerda ![Botão de seta para a esquerda](media/31-setup-for-objects.png) para movê-lo para o campo **Tipos de trabalho restantes**.

9. Você também pode selecionar as medidas de ativo que devem estar relacionadas ao tipo de ativo. Na Guia Rápida **Medidas de ativo**, faça as seleções usando os métodos descritos para tipos de trabalho na etapa 8. Para obter mais informações sobre a configuração de medidas de ativos, consulte [Medidas de ativos de manutenção](counters.md).
10. Você também pode selecionar os tipos de atributo que devem estar relacionados ao tipo de ativo. Na Guia Rápida **Tipos de atributo**, faça as seleções usando os métodos descritos para tipos de trabalho na etapa 8. Em seguida, para criar a sequência preferencial de tipos de atributo, selecione um atributo no campo **Tipos de atributo selecionados** e use os botões de seta para cima e para baixo para movê-lo. A sequência de tipos de atributo será mostrada nos ativos que usam esse tipo de ativo. Para obter mais informações sobre os atributos de ativo, consulte [Tipos de atributo de manutenção](../setup-for-functional-locations/specification-types.md).
...
11. Você também pode selecionar os modelos de avaliação de condição que devem estar relacionados ao tipo de ativo. Na Guia Rápida **Avaliações de condição**, faça as seleções usando os métodos descritos para tipos de trabalho na etapa 8. Para obter mais informações sobre modelos e registros de avaliação de condição, consulte [Avaliação de condição](../setup-for-objects/condition-assessment.md).
...
> [!NOTE]
> - Se você selecionar as medidas de ativo em um tipo de ativo, as seleções serão automaticamente atualizadas na página **Medidas de ativo** (**Gerenciamento de ativos** \> **Configuração** \> **Ativos** \> **Tipos de ativo** \> **Medidas de ativo**).
> - Os campos na seção **Detalhes** da Guia Rápida **Geral** mostram o número de tipos de trabalho, medidas de ativo, atributos e assim por diante, configurados no tipo de ativo selecionado.

Normalmente, as ordens de trabalho criadas manualmente estão relacionadas à manutenção corretiva, enquanto as ordens de trabalho criados automaticamente estão relacionadas à manutenção preventiva. Quando você cria manualmente ordens de serviço, somente os tipos de trabalho selecionados na Guia Rápida **Tipos de trabalho** da página **Tipos de ativo** podem ser usados. Entretanto, as ordens de serviço criadas automaticamente podem usar todos os tipos de trabalho que você cria na página **Tipos de trabalho** (**Gerenciamento de ativos** \> **Configuração** \> **Trabalhos** \> **Tipos de trabalho**).
