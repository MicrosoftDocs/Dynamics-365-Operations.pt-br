...
description: Este artigo explica como criar tipos de atributo no Gerenciamento de Ativos.
...
Este artigo explica como criar tipos de atributo no Gerenciamento de Ativos. Os atributos são usados para descrever as propriedades dos vários elementos. Você pode configurar atributos nos seguintes elementos:
