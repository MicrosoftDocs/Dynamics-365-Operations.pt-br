...
### <a name="contact-to-contact-example"></a>Exemplo de Contato para contato

![Mapeamento do modelo Contato para contato no Integrador de dados.](./media/contacts-direct-template-mapping-data-integrator-1.png)

### <a name="contact-to-customer-example"></a>Exemplo de Contato para cliente
