...
description: Este artigo explica ordens intercompanhia e ordens de devolução
author: Henrikan
ms.date: 09/01/2021
ms.topic: article
...
ms.locfileid: "8859017"
---
# <a name="intercompany-orders-and-return-orders"></a>Ordens intercompanhia e ordens de devolução

[!include [banner](../../includes/banner.md)]

Este artigo descreve como ordens de compra intercompanhia, ordens de venda, ordens de devolução, contratos de compra e contratos de venda são criados e atualizados.
