...
- Dois hotfixes para Dynamics 365 for Finance and Operations, Enterprise Edition (julho de 2017).
...
**Nota**: Somente é necessário instalar o KB4036524 porque a instalação inclui as alterações do KB4036461.
 
## <a name="system-requirements-for-dynamics-365-for-sales"></a>Requisitos do sistema do Dynamics 365 for Sales

Para usar a solução Prospect to cash, instale o seguinte:

- Versão 1612 (8.2.1.207) (DB 8.2.1.207) on-line ou posterior do Dynamics 365 for Sales.
