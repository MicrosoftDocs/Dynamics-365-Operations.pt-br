...
Para obter mais informações sobre a integração do cliente potencial ao pagamento à vista, assista ao vídeo curto no YouTube [Integração do cliente potencial ao pagamento à vista](https://www.youtube.com/watch?v=AVV9x5x-XCg).
...
- Solução Prospect to cash para Dynamics 365 for Sales, versão 1.15.0.0 ou posterior. A solução está disponível para download no AppSource. [Download do Dynamics 365, Prospect to Cash](https://appsource.microsoft.com/en-us/product/dynamics-365/mscrm.c7a48b40-eed3-4d67-93ba-f2364281feb3).
