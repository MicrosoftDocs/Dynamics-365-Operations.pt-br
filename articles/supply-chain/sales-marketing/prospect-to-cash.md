...
- Solução Prospect to cash para o Dynamics 365 for Sales, versão 1.15.0.0 ou uma versão posterior. A solução está disponível para download no AppSource. [Download do Dynamics 365, Prospect to Cash](https://appsource.microsoft.com/product/dynamics-365/mscrm.c7a48b40-eed3-4d67-93ba-f2364281feb3).
