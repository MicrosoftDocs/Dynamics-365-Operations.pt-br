...
description: Este artigo descreve como configurar a autenticação de servidor para servidor para integrações com base na API de integração do ATS (Sistema de Acompanhamento de Candidato) do Dynamics 365 Human Resources.
author: jaredha
ms.date: 06/30/2021
ms.topic: article
ms.prod: ''
