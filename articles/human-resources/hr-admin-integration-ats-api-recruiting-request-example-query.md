...
ms.locfileid: "8066234"
---
# <a name="example-query-for-recruiting-request"></a>Consulta de exemplo de solicitação de recrutamento
...
Este tópico fornece um exemplo de consulta para a entidade de solicitação de recrutamento no Dynamics 365 Human Resources.

A consulta a seguir mostra como você pode usar a opção de consulta $expand em uma operação GET para recuperar um registro de solicitação de recrutamento especificado e todas as posições associadas, habilidades necessárias e requisitos educacionais para a solicitação especificada. A resposta de exemplo mostra uma solicitação de recrutamento para duas posições, bem como as habilidades necessárias e a formação educacional para as posições solicitadas.
