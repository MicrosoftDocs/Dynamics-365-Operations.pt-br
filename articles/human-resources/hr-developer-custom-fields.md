...
A maioria das tabelas do Dataverse dão suporte a campos personalizados. Para obter uma lista completa de tabelas do Dataverse, consulte [Tabelas do Dataverse](https://docs.microsoft.com/dynamics365/human-resources/hr-developer-entities). 
