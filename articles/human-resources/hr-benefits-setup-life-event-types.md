...
| **Alteração do status do emprego** |<br><ul><li>Trabalhador > Emprego</li><li>Página de histórico de emprego</li></ul> | Para um trabalhador com um detalhe de emprego existente, a criação de um novo detalhe de emprego com outro status de emprego disparará um evento de vida.  Atualizar um detalhe de emprego existente com outro status de emprego também disparará um evento de vida.  |
| **Alteração de endereço do funcionário** |<br><ul><li>Trabalhador > Perfil > Endereços</li><li>Trabalhador > Informações pessoais > Contatos pessoais > Endereço</li></ul> | Alteração no endereço. O endereço deve ser **Principal** para disparar um evento de vida. |
