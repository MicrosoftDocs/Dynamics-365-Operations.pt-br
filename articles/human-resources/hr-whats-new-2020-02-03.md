...
## <a name="cant-remove-activities-from-performance-review-form-403542"></a>Não é possível remover atividades do formulário de avaliação de desempenho (403542)

Agora você pode excluir atividades selecionadas usando o botão **Remover** no formulário **Avaliação de desempenho**.
