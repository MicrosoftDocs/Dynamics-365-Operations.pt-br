...
- <span data-ttu-id="40b8a-111">Dados de recursos humanos</span><span class="sxs-lookup"><span data-stu-id="40b8a-111">Human resources data</span></span>
...
<span data-ttu-id="40b8a-127">Para obter mais informações sobre as contas de armazenamento do Azure e as cadeias de conexão do Armazenamento do Azure, consulte os seguintes artigos do Azure:</span><span class="sxs-lookup"><span data-stu-id="40b8a-127">For more information about Azure storage accounts and Azure Storage connection strings, see the following Azure articles:</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="40b8a-141">Configurar seus dados</span><span class="sxs-lookup"><span data-stu-id="40b8a-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="40b8a-158">Benefícios</span><span class="sxs-lookup"><span data-stu-id="40b8a-158">Benefits</span></span>
...
<span data-ttu-id="40b8a-187">Para obter mais informações sobre como definir e gerenciar um programa de benefícios, consulte os seguintes artigos:</span><span class="sxs-lookup"><span data-stu-id="40b8a-187">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- [<span data-ttu-id="40b8a-204">Definir processo de remuneração e calcular resultados</span><span class="sxs-lookup"><span data-stu-id="40b8a-204">Define compensation process and calculate results</span></span>](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/define-compensation-process-calculate-results)
...
- <span data-ttu-id="40b8a-226">Ciclo de pagamento (obrigatório)</span><span class="sxs-lookup"><span data-stu-id="40b8a-226">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="40b8a-241">Ciclos de pagamento e períodos de pagamento</span><span class="sxs-lookup"><span data-stu-id="40b8a-241">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="40b8a-257">Códigos de ganhos</span><span class="sxs-lookup"><span data-stu-id="40b8a-257">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="40b8a-296">Informações de contato</span><span class="sxs-lookup"><span data-stu-id="40b8a-296">Contact information</span></span> 
...
<span data-ttu-id="40b8a-342">Um plano de remuneração fixa deve estar associado à posição principal de cada funcionário durante um período de emprego.</span><span class="sxs-lookup"><span data-stu-id="40b8a-342">A fixed compensation plan must be associated with every employee's primary position throughout an employment period.</span></span> <span data-ttu-id="40b8a-343">Esse período tem início na data em que o funcionário foi contratado (ou na data de início do emprego) e continua até a rescisão.</span><span class="sxs-lookup"><span data-stu-id="40b8a-343">This period starts on the date that the employee was hired (or the employment start date) and continues until termination.</span></span>
...
- <span data-ttu-id="40b8a-358">Principal (obrigatório)</span><span class="sxs-lookup"><span data-stu-id="40b8a-358">Primary (required)</span></span>
...
- <span data-ttu-id="40b8a-380">Principal (obrigatório)</span><span class="sxs-lookup"><span data-stu-id="40b8a-380">Primary (required)</span></span>
...
<span data-ttu-id="40b8a-421">Os seguintes códigos de motivo e descrições são obrigatórios.</span><span class="sxs-lookup"><span data-stu-id="40b8a-421">The following reason codes and descriptions are required.</span></span>
...
| <span data-ttu-id="40b8a-458">Viúvo(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-458">Widowed</span></span>                | <span data-ttu-id="40b8a-459">Viúvo(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-459">Widowed</span></span>              |
...
- <span data-ttu-id="40b8a-491">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-491">2OFMTH</span></span>
...
| <span data-ttu-id="40b8a-516">Recursos Humanos</span><span class="sxs-lookup"><span data-stu-id="40b8a-516">Human Resources</span></span>          | <span data-ttu-id="40b8a-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="40b8a-517">Dayforce</span></span>              |
|-----------------|-----------------------|
...
| <span data-ttu-id="40b8a-522">Estadual</span><span class="sxs-lookup"><span data-stu-id="40b8a-522">State</span></span>           | <span data-ttu-id="40b8a-523">Código de estado</span><span class="sxs-lookup"><span data-stu-id="40b8a-523">State Code</span></span>            |
| <span data-ttu-id="40b8a-524">Cidade</span><span class="sxs-lookup"><span data-stu-id="40b8a-524">City</span></span>            | <span data-ttu-id="40b8a-525">Cidade</span><span class="sxs-lookup"><span data-stu-id="40b8a-525">City</span></span>                  |
| <span data-ttu-id="40b8a-526">Região</span><span class="sxs-lookup"><span data-stu-id="40b8a-526">County</span></span>          | <span data-ttu-id="40b8a-527">Município (municipalidade)</span><span class="sxs-lookup"><span data-stu-id="40b8a-527">County (Municipality)</span></span> |
| <span data-ttu-id="40b8a-528">Rua</span><span class="sxs-lookup"><span data-stu-id="40b8a-528">Street</span></span>          | <span data-ttu-id="40b8a-529">Linha de endereço 1</span><span class="sxs-lookup"><span data-stu-id="40b8a-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="40b8a-530">Regiões fiscais</span><span class="sxs-lookup"><span data-stu-id="40b8a-530">Tax regions</span></span>

<span data-ttu-id="40b8a-531">Regiões fiscais são usadas para determinar os impostos apropriados a serem aplicados durante a geração da folha de pagamento.</span><span class="sxs-lookup"><span data-stu-id="40b8a-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="40b8a-532">As regiões fiscais são mapeadas para o Dayforce como endereços de localização.</span><span class="sxs-lookup"><span data-stu-id="40b8a-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="40b8a-533">A região fiscal padrão deve estar associada à posição ativa do trabalhador.</span><span class="sxs-lookup"><span data-stu-id="40b8a-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="40b8a-534">Região fiscal (obrigatória)</span><span class="sxs-lookup"><span data-stu-id="40b8a-534">Tax region (required)</span></span>
- <span data-ttu-id="40b8a-535">País/região (obrigatório)</span><span class="sxs-lookup"><span data-stu-id="40b8a-535">Country/Region (required)</span></span>
- <span data-ttu-id="40b8a-536">Estado (obrigatório)</span><span class="sxs-lookup"><span data-stu-id="40b8a-536">State (required)</span></span>
- <span data-ttu-id="40b8a-537">Região</span><span class="sxs-lookup"><span data-stu-id="40b8a-537">County</span></span> 
- <span data-ttu-id="40b8a-538">Cidade (obrigatória)</span><span class="sxs-lookup"><span data-stu-id="40b8a-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="40b8a-539">Configurar seus dados para gerar folha de pagamento no México</span><span class="sxs-lookup"><span data-stu-id="40b8a-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="40b8a-540">Se você está gerando pagamento para funcionários no México, os seguintes elementos devem ser configurados:</span><span class="sxs-lookup"><span data-stu-id="40b8a-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="40b8a-541">Departamentos são necessários em posições.</span><span class="sxs-lookup"><span data-stu-id="40b8a-541">Departments are required on positions.</span></span>
- <span data-ttu-id="40b8a-542">Os centros de custo devem ser definidos como dimensões financeiras e ser o primeiro elemento na sequência de dimensão financeira padrão.</span><span class="sxs-lookup"><span data-stu-id="40b8a-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="40b8a-543">Tipos de trabalho</span><span class="sxs-lookup"><span data-stu-id="40b8a-543">Job types</span></span>

<span data-ttu-id="40b8a-544">Os tipos de trabalho são usados para agrupar trabalhos semelhantes em categorias.</span><span class="sxs-lookup"><span data-stu-id="40b8a-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="40b8a-545">Tipos de trabalho são necessários para processar a folha de pagamento no México.</span><span class="sxs-lookup"><span data-stu-id="40b8a-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="40b8a-546">Os exemplos de tipos de trabalho incluem horário integral e meio período ou salário e pagamento por hora.</span><span class="sxs-lookup"><span data-stu-id="40b8a-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="40b8a-547">Os tipos de trabalho são mapeados para o Dayforce como tipos de pagamento que indicam se um funcionário é pago por hora ou assalariado.</span><span class="sxs-lookup"><span data-stu-id="40b8a-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="40b8a-548">Os seguintes tipos de trabalho e descrições são obrigatórios.</span><span class="sxs-lookup"><span data-stu-id="40b8a-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="40b8a-549">Tipo de trabalho</span><span class="sxs-lookup"><span data-stu-id="40b8a-549">Job type</span></span>   | <span data-ttu-id="40b8a-550">descrição</span><span class="sxs-lookup"><span data-stu-id="40b8a-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="40b8a-551">Por hora</span><span class="sxs-lookup"><span data-stu-id="40b8a-551">Hourly</span></span>     | <span data-ttu-id="40b8a-552">MX por hora</span><span class="sxs-lookup"><span data-stu-id="40b8a-552">MX Hourly</span></span>   |
| <span data-ttu-id="40b8a-553">Assalariado</span><span class="sxs-lookup"><span data-stu-id="40b8a-553">Salaried</span></span>   | <span data-ttu-id="40b8a-554">MX assalariado</span><span class="sxs-lookup"><span data-stu-id="40b8a-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="40b8a-555">Tipos de posição</span><span class="sxs-lookup"><span data-stu-id="40b8a-555">Position types</span></span> 

<span data-ttu-id="40b8a-556">Você usa os tipos de posição para descrever se a posição é de tempo integral, meio período ou de outra natureza.</span><span class="sxs-lookup"><span data-stu-id="40b8a-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="40b8a-557">Os tipos de posição são mapeados para o Dayforce como classes de pagamento que indicam se um funcionário é de tempo integral ou meio período.</span><span class="sxs-lookup"><span data-stu-id="40b8a-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="40b8a-558">Os seguintes tipos de posição e descrições são obrigatórios.</span><span class="sxs-lookup"><span data-stu-id="40b8a-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="40b8a-559">Tipo de posição</span><span class="sxs-lookup"><span data-stu-id="40b8a-559">Position type</span></span>   | <span data-ttu-id="40b8a-560">descrição</span><span class="sxs-lookup"><span data-stu-id="40b8a-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="40b8a-561">Horário integral</span><span class="sxs-lookup"><span data-stu-id="40b8a-561">Full-time</span></span>       | <span data-ttu-id="40b8a-562">Funcionário de tempo integral</span><span class="sxs-lookup"><span data-stu-id="40b8a-562">Full time employee</span></span> |
| <span data-ttu-id="40b8a-563">Meio período</span><span class="sxs-lookup"><span data-stu-id="40b8a-563">Part-time</span></span>       | <span data-ttu-id="40b8a-564">Funcionário de meio período</span><span class="sxs-lookup"><span data-stu-id="40b8a-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="40b8a-565">Códigos de motivos</span><span class="sxs-lookup"><span data-stu-id="40b8a-565">Reason codes</span></span>

<span data-ttu-id="40b8a-566">Códigos de motivo fornecem informações sobre o status de um funcionário.</span><span class="sxs-lookup"><span data-stu-id="40b8a-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="40b8a-567">Os códigos de motivo são mapeados para o Dayforce como motivos de status que indicam o motivo das alterações na posição de um funcionário ou no status de um emprego.</span><span class="sxs-lookup"><span data-stu-id="40b8a-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="40b8a-568">Os seguintes códigos de motivo e descrições são obrigatórios.</span><span class="sxs-lookup"><span data-stu-id="40b8a-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="40b8a-569">Código de motivo</span><span class="sxs-lookup"><span data-stu-id="40b8a-569">Reason code</span></span>            | <span data-ttu-id="40b8a-570">descrição</span><span class="sxs-lookup"><span data-stu-id="40b8a-570">Description</span></span>                    | <span data-ttu-id="40b8a-571">Cenários aplicáveis</span><span class="sxs-lookup"><span data-stu-id="40b8a-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="40b8a-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="40b8a-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="40b8a-573">Partida antes da primeira folha de pagamento</span><span class="sxs-lookup"><span data-stu-id="40b8a-573">Departure before first payroll</span></span> | <span data-ttu-id="40b8a-574">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-574">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-575">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="40b8a-575">RESIGNATION</span></span>            | <span data-ttu-id="40b8a-576">Demissão</span><span class="sxs-lookup"><span data-stu-id="40b8a-576">Resignation</span></span>                    | <span data-ttu-id="40b8a-577">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-577">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-578">PENSION</span><span class="sxs-lookup"><span data-stu-id="40b8a-578">PENSION</span></span>                | <span data-ttu-id="40b8a-579">Aposentadoria</span><span class="sxs-lookup"><span data-stu-id="40b8a-579">Pension</span></span>                        | <span data-ttu-id="40b8a-580">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-580">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-581">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="40b8a-581">TERMINATION</span></span>            | <span data-ttu-id="40b8a-582">Finalização</span><span class="sxs-lookup"><span data-stu-id="40b8a-582">Termination</span></span>                    | <span data-ttu-id="40b8a-583">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-583">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-584">RETIREMENT</span><span class="sxs-lookup"><span data-stu-id="40b8a-584">RETIREMENT</span></span>             | <span data-ttu-id="40b8a-585">Aposentadoria</span><span class="sxs-lookup"><span data-stu-id="40b8a-585">Retirement</span></span>                     | <span data-ttu-id="40b8a-586">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-586">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-587">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="40b8a-587">ABSENTEE</span></span>               | <span data-ttu-id="40b8a-588">Absentista</span><span class="sxs-lookup"><span data-stu-id="40b8a-588">Absentee</span></span>                       | <span data-ttu-id="40b8a-589">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-589">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-590">OTHER</span><span class="sxs-lookup"><span data-stu-id="40b8a-590">OTHER</span></span>                  | <span data-ttu-id="40b8a-591">Outros motivos</span><span class="sxs-lookup"><span data-stu-id="40b8a-591">Other Reasons</span></span>                  | <span data-ttu-id="40b8a-592">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-592">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-593">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="40b8a-593">CLOSURE</span></span>                | <span data-ttu-id="40b8a-594">Fechamento da empresa</span><span class="sxs-lookup"><span data-stu-id="40b8a-594">Business Closure</span></span>               | <span data-ttu-id="40b8a-595">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-595">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-596">DEATH</span><span class="sxs-lookup"><span data-stu-id="40b8a-596">DEATH</span></span>                  | <span data-ttu-id="40b8a-597">Morte</span><span class="sxs-lookup"><span data-stu-id="40b8a-597">Death</span></span>                          | <span data-ttu-id="40b8a-598">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-598">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="40b8a-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="40b8a-600">Licença</span><span class="sxs-lookup"><span data-stu-id="40b8a-600">Leave of Absence</span></span>               | <span data-ttu-id="40b8a-601">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-601">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="40b8a-602">CONTRACTEND</span></span>            | <span data-ttu-id="40b8a-603">Fim do contrato</span><span class="sxs-lookup"><span data-stu-id="40b8a-603">End of Contract</span></span>                | <span data-ttu-id="40b8a-604">Demitir trabalhador</span><span class="sxs-lookup"><span data-stu-id="40b8a-604">Terminate worker</span></span>     |
| <span data-ttu-id="40b8a-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="40b8a-605">SALARYCHANGE</span></span>           | <span data-ttu-id="40b8a-606">Alteração de salário</span><span class="sxs-lookup"><span data-stu-id="40b8a-606">Change of Salary</span></span>               | <span data-ttu-id="40b8a-607">Remuneração</span><span class="sxs-lookup"><span data-stu-id="40b8a-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="40b8a-608">Contrato de trabalho</span><span class="sxs-lookup"><span data-stu-id="40b8a-608">Terms of employment</span></span>

<span data-ttu-id="40b8a-609">Termos de emprego são usados para criar categorias de termos de emprego.</span><span class="sxs-lookup"><span data-stu-id="40b8a-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="40b8a-610">Os termos são mapeados para o Dayforce como valores de indicador de emprego.</span><span class="sxs-lookup"><span data-stu-id="40b8a-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="40b8a-611">Os termos de emprego e as descrições a seguir são obrigatórios.</span><span class="sxs-lookup"><span data-stu-id="40b8a-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="40b8a-612">Contrato de trabalho</span><span class="sxs-lookup"><span data-stu-id="40b8a-612">Terms of employment</span></span>   | <span data-ttu-id="40b8a-613">descrição</span><span class="sxs-lookup"><span data-stu-id="40b8a-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="40b8a-614">Normal</span><span class="sxs-lookup"><span data-stu-id="40b8a-614">Regular</span></span>               | <span data-ttu-id="40b8a-615">Normal</span><span class="sxs-lookup"><span data-stu-id="40b8a-615">Regular</span></span>     |
| <span data-ttu-id="40b8a-616">Direto</span><span class="sxs-lookup"><span data-stu-id="40b8a-616">Direct</span></span>                | <span data-ttu-id="40b8a-617">Direto</span><span class="sxs-lookup"><span data-stu-id="40b8a-617">Direct</span></span>      |
| <span data-ttu-id="40b8a-618">Estágio</span><span class="sxs-lookup"><span data-stu-id="40b8a-618">Internship</span></span>            | <span data-ttu-id="40b8a-619">Estágio</span><span class="sxs-lookup"><span data-stu-id="40b8a-619">Internship</span></span>  |
| <span data-ttu-id="40b8a-620">Permanente</span><span class="sxs-lookup"><span data-stu-id="40b8a-620">Permanent</span></span>             | <span data-ttu-id="40b8a-621">Permanente</span><span class="sxs-lookup"><span data-stu-id="40b8a-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="40b8a-622">Estado civil</span><span class="sxs-lookup"><span data-stu-id="40b8a-622">Marital status</span></span>

<span data-ttu-id="40b8a-623">Os valores do estado civil são mapeados para o Dayforce e convertidos, conforme apropriado, nos valores aceitos após a integração.</span><span class="sxs-lookup"><span data-stu-id="40b8a-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="40b8a-624">A tabela a seguir mostra como os valores do estado civil são mapeados para o Dayforce.</span><span class="sxs-lookup"><span data-stu-id="40b8a-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="40b8a-625">Recursos Humanos</span><span class="sxs-lookup"><span data-stu-id="40b8a-625">Human Resources</span></span>                 | <span data-ttu-id="40b8a-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="40b8a-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="40b8a-627">Casado(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-627">Married</span></span>                | <span data-ttu-id="40b8a-628">Casado(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-628">Married</span></span>                   |
| <span data-ttu-id="40b8a-629">Único</span><span class="sxs-lookup"><span data-stu-id="40b8a-629">Single</span></span>                 | <span data-ttu-id="40b8a-630">Único</span><span class="sxs-lookup"><span data-stu-id="40b8a-630">Single</span></span>                    |
| <span data-ttu-id="40b8a-631">Viúvo(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-631">Widowed</span></span>                | <span data-ttu-id="40b8a-632">Viúvo(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-632">Widowed</span></span>                   |
| <span data-ttu-id="40b8a-633">Divorciado(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-633">Divorced</span></span>               | <span data-ttu-id="40b8a-634">Divorciado(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-634">Divorced</span></span>                  |
| <span data-ttu-id="40b8a-635">Parceria Registrada</span><span class="sxs-lookup"><span data-stu-id="40b8a-635">Registered Partnership</span></span> | <span data-ttu-id="40b8a-636">Parceiro doméstico</span><span class="sxs-lookup"><span data-stu-id="40b8a-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="40b8a-637">Nenhum(a)</span><span class="sxs-lookup"><span data-stu-id="40b8a-637">None</span></span>                   | <span data-ttu-id="40b8a-638">*Não há suporte para o México*</span><span class="sxs-lookup"><span data-stu-id="40b8a-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="40b8a-639">Coabitando</span><span class="sxs-lookup"><span data-stu-id="40b8a-639">Cohabiting</span></span>             | <span data-ttu-id="40b8a-640">*Não há suporte para o México*</span><span class="sxs-lookup"><span data-stu-id="40b8a-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="40b8a-641">Sexo</span><span class="sxs-lookup"><span data-stu-id="40b8a-641">Gender</span></span>

<span data-ttu-id="40b8a-642">As designações de gênero são mapeadas para o Dayforce e convertidas, conforme apropriado, nos valores aceitos após a integração.</span><span class="sxs-lookup"><span data-stu-id="40b8a-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="40b8a-643">A tabela a seguir mostra como as designações de gênero são mapeadas para o Dayforce.</span><span class="sxs-lookup"><span data-stu-id="40b8a-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="40b8a-644">Recursos Humanos</span><span class="sxs-lookup"><span data-stu-id="40b8a-644">Human Resources</span></span>       | <span data-ttu-id="40b8a-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="40b8a-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="40b8a-646">Masculino</span><span class="sxs-lookup"><span data-stu-id="40b8a-646">Male</span></span>         | <span data-ttu-id="40b8a-647">Masculino</span><span class="sxs-lookup"><span data-stu-id="40b8a-647">Male</span></span>                      |
| <span data-ttu-id="40b8a-648">Feminino</span><span class="sxs-lookup"><span data-stu-id="40b8a-648">Female</span></span>       | <span data-ttu-id="40b8a-649">Feminino</span><span class="sxs-lookup"><span data-stu-id="40b8a-649">Female</span></span>                    |
| <span data-ttu-id="40b8a-650">Não específico</span><span class="sxs-lookup"><span data-stu-id="40b8a-650">Non-specific</span></span> | <span data-ttu-id="40b8a-651">*Não há suporte para o México*</span><span class="sxs-lookup"><span data-stu-id="40b8a-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="40b8a-652">Forma de pagamento</span><span class="sxs-lookup"><span data-stu-id="40b8a-652">Payment method</span></span>

<span data-ttu-id="40b8a-653">Os métodos de pagamento dão ao funcionário e à empresa uma maneira de descrever como os funcionários serão pagos.</span><span class="sxs-lookup"><span data-stu-id="40b8a-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="40b8a-654">Os métodos de pagamento são mapeados para o Dayforce e convertidos, conforme apropriado, nos valores aceitos após a integração.</span><span class="sxs-lookup"><span data-stu-id="40b8a-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="40b8a-655">A tabela a seguir mostra como os métodos de pagamento são mapeados para o Dayforce.</span><span class="sxs-lookup"><span data-stu-id="40b8a-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="40b8a-656">Recursos Humanos</span><span class="sxs-lookup"><span data-stu-id="40b8a-656">Human Resources</span></span>             | <span data-ttu-id="40b8a-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="40b8a-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="40b8a-658">Pagamento à vista</span><span class="sxs-lookup"><span data-stu-id="40b8a-658">Cash</span></span>               | <span data-ttu-id="40b8a-659">Pagamento à vista</span><span class="sxs-lookup"><span data-stu-id="40b8a-659">Cash</span></span>                      |
| <span data-ttu-id="40b8a-660">Pagamento eletrônico</span><span class="sxs-lookup"><span data-stu-id="40b8a-660">Electronic Payment</span></span> | <span data-ttu-id="40b8a-661">Transferir</span><span class="sxs-lookup"><span data-stu-id="40b8a-661">Transfer</span></span>                  |
| <span data-ttu-id="40b8a-662">Marcar</span><span class="sxs-lookup"><span data-stu-id="40b8a-662">Check</span></span>              | <span data-ttu-id="40b8a-663">Cheque</span><span class="sxs-lookup"><span data-stu-id="40b8a-663">Cheque</span></span>                    |
| <span data-ttu-id="40b8a-664">Boleto bancário</span><span class="sxs-lookup"><span data-stu-id="40b8a-664">Bank Draft</span></span>         | <span data-ttu-id="40b8a-665">*Não há suporte para o México*</span><span class="sxs-lookup"><span data-stu-id="40b8a-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="40b8a-666">Outros</span><span class="sxs-lookup"><span data-stu-id="40b8a-666">Other</span></span>              | <span data-ttu-id="40b8a-667">*Não há suporte para o México*</span><span class="sxs-lookup"><span data-stu-id="40b8a-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="40b8a-668">Tipo de conta bancária</span><span class="sxs-lookup"><span data-stu-id="40b8a-668">Bank account type</span></span>

<span data-ttu-id="40b8a-669">Os tipos de conta bancária são usados para pagamentos eletrônicos aos funcionários.</span><span class="sxs-lookup"><span data-stu-id="40b8a-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="40b8a-670">Os tipos de conta bancária são mapeados para o Dayforce como informações da conta de transferência.</span><span class="sxs-lookup"><span data-stu-id="40b8a-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="40b8a-671">Os tipos de conta bancária são convertidos, conforme apropriado, nos valores aceitos após a integração.</span><span class="sxs-lookup"><span data-stu-id="40b8a-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="40b8a-672">Recursos Humanos</span><span class="sxs-lookup"><span data-stu-id="40b8a-672">Human Resources</span></span>            | <span data-ttu-id="40b8a-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="40b8a-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="40b8a-674">Conta corrente</span><span class="sxs-lookup"><span data-stu-id="40b8a-674">Checking Account</span></span>  | <span data-ttu-id="40b8a-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="40b8a-675">CheckingAccount</span></span>           |
| <span data-ttu-id="40b8a-676">Conta-salário</span><span class="sxs-lookup"><span data-stu-id="40b8a-676">Payroll Account</span></span>   | <span data-ttu-id="40b8a-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="40b8a-677">PayrollAccount</span></span>            |
| <span data-ttu-id="40b8a-678">Conta de poupança</span><span class="sxs-lookup"><span data-stu-id="40b8a-678">Savings Account</span></span>   | <span data-ttu-id="40b8a-679">*Não há suporte para o México*</span><span class="sxs-lookup"><span data-stu-id="40b8a-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="40b8a-680">Conta BankGirot</span><span class="sxs-lookup"><span data-stu-id="40b8a-680">BankGirot account</span></span> | <span data-ttu-id="40b8a-681">*Não há suporte para o México*</span><span class="sxs-lookup"><span data-stu-id="40b8a-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="40b8a-682">Conta PlusGirot</span><span class="sxs-lookup"><span data-stu-id="40b8a-682">PlusGirot account</span></span> | <span data-ttu-id="40b8a-683">*Não há suporte para o México*</span><span class="sxs-lookup"><span data-stu-id="40b8a-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="40b8a-684">Códigos de ganhos</span><span class="sxs-lookup"><span data-stu-id="40b8a-684">Earning codes</span></span>

<span data-ttu-id="40b8a-685">Os códigos de ganhos identificam de forma exclusiva cada tipo de ganho que os trabalhadores recebem.</span><span class="sxs-lookup"><span data-stu-id="40b8a-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="40b8a-686">Os códigos abordam vários parâmetros relacionados a ganhos, como regras contábeis, leis tributárias, requisitos de relatório e capacidade de montante bruto.</span><span class="sxs-lookup"><span data-stu-id="40b8a-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="40b8a-687">Se uma frequência sem suporte for usada, a frequência **Cada pagamento** é usada por padrão para o cálculo.</span><span class="sxs-lookup"><span data-stu-id="40b8a-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="40b8a-688">Frequências com suporte</span><span class="sxs-lookup"><span data-stu-id="40b8a-688">Supported frequencies</span></span>

- <span data-ttu-id="40b8a-689">Todas</span><span class="sxs-lookup"><span data-stu-id="40b8a-689">All</span></span>
- <span data-ttu-id="40b8a-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="40b8a-690">EVERYPAY</span></span>
- <span data-ttu-id="40b8a-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="40b8a-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="40b8a-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="40b8a-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="40b8a-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="40b8a-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="40b8a-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-694">1OFMTH</span></span>
- <span data-ttu-id="40b8a-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-695">LASTOFMTH</span></span>
- <span data-ttu-id="40b8a-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-696">2OFMTH</span></span>
- <span data-ttu-id="40b8a-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-697">3OFMTH</span></span>
- <span data-ttu-id="40b8a-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-698">4OFMTH</span></span>
- <span data-ttu-id="40b8a-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-699">5OFMTH</span></span>
- <span data-ttu-id="40b8a-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-700">1N2OFMTH</span></span>
- <span data-ttu-id="40b8a-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-701">3N4OFMTH</span></span>
- <span data-ttu-id="40b8a-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-702">1N3OFMTH</span></span>
- <span data-ttu-id="40b8a-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-703">1N4OFMTH</span></span>
- <span data-ttu-id="40b8a-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-704">2N3OFMTH</span></span>
- <span data-ttu-id="40b8a-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-705">2N4OFMTH</span></span>
- <span data-ttu-id="40b8a-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="40b8a-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="40b8a-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="40b8a-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="40b8a-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="40b8a-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="40b8a-711">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="40b8a-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="40b8a-712">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="40b8a-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="40b8a-713">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="40b8a-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="40b8a-714">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="40b8a-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="40b8a-715">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="40b8a-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="40b8a-716">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="40b8a-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="40b8a-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="40b8a-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="40b8a-718">Endereços</span><span class="sxs-lookup"><span data-stu-id="40b8a-718">Addresses</span></span>

<span data-ttu-id="40b8a-719">A identificação de códigos específicos de país ou região, estado e município (municipalidade) exige formatos específicos que o Dayforce e os provedores no país/na região possam reconhecer.</span><span class="sxs-lookup"><span data-stu-id="40b8a-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="40b8a-720">Embora o formato das cidades seja flexível, todas as cidades devem estar associadas a um estado.</span><span class="sxs-lookup"><span data-stu-id="40b8a-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="40b8a-721">Recursos Humanos</span><span class="sxs-lookup"><span data-stu-id="40b8a-721">Human Resources</span></span>              | <span data-ttu-id="40b8a-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="40b8a-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="40b8a-723">País/Região</span><span class="sxs-lookup"><span data-stu-id="40b8a-723">Country/Region</span></span>      | <span data-ttu-id="40b8a-724">Código do País</span><span class="sxs-lookup"><span data-stu-id="40b8a-724">Country Code</span></span>          |
| <span data-ttu-id="40b8a-725">CEP</span><span class="sxs-lookup"><span data-stu-id="40b8a-725">Zip/Postal Code</span></span>     | <span data-ttu-id="40b8a-726">CEP</span><span class="sxs-lookup"><span data-stu-id="40b8a-726">Postal Code</span></span>           |
| <span data-ttu-id="40b8a-727">Estadual</span><span class="sxs-lookup"><span data-stu-id="40b8a-727">State</span></span>               | <span data-ttu-id="40b8a-728">Código de estado</span><span class="sxs-lookup"><span data-stu-id="40b8a-728">State Code</span></span>            |
| <span data-ttu-id="40b8a-729">Cidade</span><span class="sxs-lookup"><span data-stu-id="40b8a-729">City</span></span>                | <span data-ttu-id="40b8a-730">Cidade</span><span class="sxs-lookup"><span data-stu-id="40b8a-730">City</span></span>                  |
| <span data-ttu-id="40b8a-731">Região</span><span class="sxs-lookup"><span data-stu-id="40b8a-731">County</span></span>              | <span data-ttu-id="40b8a-732">Município (municipalidade)</span><span class="sxs-lookup"><span data-stu-id="40b8a-732">County (Municipality)</span></span> |
| <span data-ttu-id="40b8a-733">Rua</span><span class="sxs-lookup"><span data-stu-id="40b8a-733">Street</span></span>              | <span data-ttu-id="40b8a-734">Linha de endereço 1</span><span class="sxs-lookup"><span data-stu-id="40b8a-734">Address Line 1</span></span>        |
| <span data-ttu-id="40b8a-735">Número</span><span class="sxs-lookup"><span data-stu-id="40b8a-735">Street Number</span></span>       | <span data-ttu-id="40b8a-736">Linha de endereço 2</span><span class="sxs-lookup"><span data-stu-id="40b8a-736">Address Line 2</span></span>        |
| <span data-ttu-id="40b8a-737">Complemento do edifício</span><span class="sxs-lookup"><span data-stu-id="40b8a-737">Building Complement</span></span> | <span data-ttu-id="40b8a-738">Linha de endereço 5</span><span class="sxs-lookup"><span data-stu-id="40b8a-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="40b8a-739">Número do passaporte</span><span class="sxs-lookup"><span data-stu-id="40b8a-739">Passport number</span></span>

<span data-ttu-id="40b8a-740">Os funcionários podem declarar as informações do passaporte.</span><span class="sxs-lookup"><span data-stu-id="40b8a-740">Employees can declare passport information.</span></span> <span data-ttu-id="40b8a-741">Essas informações são do tipo de identificação **Passaporte** e estão integradas ao Dayforce como parte das informações específicas do México de um funcionário.</span><span class="sxs-lookup"><span data-stu-id="40b8a-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="40b8a-742">Tipo de identificação = "Passaporte"</span><span class="sxs-lookup"><span data-stu-id="40b8a-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="40b8a-743">Data da emissão</span><span class="sxs-lookup"><span data-stu-id="40b8a-743">Issued Date</span></span>
- <span data-ttu-id="40b8a-744">Data de Vencimento</span><span class="sxs-lookup"><span data-stu-id="40b8a-744">Expiration Date</span></span>

<span data-ttu-id="40b8a-745">Os funcionários podem declarar vários números de identificação do tipo de identificação **Passaporte**.</span><span class="sxs-lookup"><span data-stu-id="40b8a-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="40b8a-746">No entanto, apenas a entrada atual do passaporte ativo é integrada ao Dayforce.</span><span class="sxs-lookup"><span data-stu-id="40b8a-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="40b8a-747">Se todas as entradas do passaporte expirarem, o passaporte emitido mais recentemente será integrado ao Dayforce.</span><span class="sxs-lookup"><span data-stu-id="40b8a-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
