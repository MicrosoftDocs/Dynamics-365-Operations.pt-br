...
| --- | --- | --- |
| Opção para forçar o cancelamento e redefinir trabalhos em lotes presos (560976) | NA | [Redefinir trabalhos em lotes presos](https://docs.microsoft.com/dynamics365/human-resources/hr-admin-troubleshooting-batch-execution) |
