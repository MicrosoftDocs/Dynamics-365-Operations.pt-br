...
description: Este artigo descreve a API de integração da folha de pagamento do Dynamics 365 Human Resources.
author: twheeloc
ms.date: 02/03/2021
ms.topic: article
ms.prod: ''
...
- [Funcionalidade para marcar um funcionário como pronto para pagar.](hr-compensation-payroll.md)
