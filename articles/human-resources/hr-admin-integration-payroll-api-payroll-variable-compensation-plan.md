...
description: Este artigo fornece detalhes e um exemplo de consulta da entidade Plano de remuneração variável da folha de pagamento no Dynamics 365 Human Resources.
author: twheeloc
ms.date: 06/15/2021
ms.topic: article
ms.prod: ''
...
Este artigo descreve a entidade Plano de remuneração variável da folha de pagamento para o Dynamics 365 Human Resources.
