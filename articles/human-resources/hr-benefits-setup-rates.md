...
3. Especifique valores para os seguintes campos:
   ...
   | Cálculo da taxa de frequência de pagamento | O método do cálculo da taxa de frequência de pagamento: padrão ou anual. |
