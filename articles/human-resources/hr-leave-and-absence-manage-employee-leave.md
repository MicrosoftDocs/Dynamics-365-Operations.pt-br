...
## <a name="adjust-leave-balances"></a>Ajustar saldos de licenças

1. No registro do funcionário, selecione **Licença**.

2. Selecione **Configuração de licença e ausência**.

3. Selecione **Ajustar saldo**.

4. Selecione o **Tipo de licença**.

5. Insira um **Valor de ajuste**. 
