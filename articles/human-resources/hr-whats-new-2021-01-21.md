...
description: Este artigo descreve os recursos novos ou alterados no Microsoft Dynamics 365 Human Resources para 21 de janeiro de 2021.
author: marcelbf
ms.date: 01/21/2021
ms.topic: article
ms.prod: ''
...
| --- | --- | --- |
| Platform update 10.0.16(40) | -- | [Atualizações de plataforma para a versão 10.0.16 dos aplicativos de finanças e operações (fevereiro de 2021)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-16.md) |
