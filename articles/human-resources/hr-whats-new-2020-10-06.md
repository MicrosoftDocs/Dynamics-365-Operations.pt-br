...
- **Entidades de lista de verificação incluídas no Dataverse**: entidades de lista de verificação para Integração, Remoção, Transferências e Processos empresariais estarão disponíveis em breve no Dataverse.
