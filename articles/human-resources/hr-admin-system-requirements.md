...
description: Este artigo lista os requisitos do sistema do Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/11/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8879327"
---
# <a name="system-requirements"></a>Requisitos do sistema

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

Este artigo lista os requisitos do sistema do Microsoft Dynamics 365 Human Resources. Ele também destaca os países e regiões onde Human Resources está disponível e informações sobre idiomas e localização dos dados do Human Resources.
