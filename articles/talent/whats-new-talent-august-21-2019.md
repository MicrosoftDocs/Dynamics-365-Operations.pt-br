...
Esta versão inclui correções de bug menores para o Dynamics 365 Talent: Core HR. As alterações descritas nesta seção aplicam-se ao número da compilação 8.1.2429.
