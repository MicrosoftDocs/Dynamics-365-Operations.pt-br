---
title: Novidades ou alterações no Dynamics 365 Talent (14 de janeiro de 2020)
...
ms.locfileid: "3081809"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-january-14-2020"></a>Novidades ou alterações no Dynamics 365 Talent (14 de janeiro de 2020)
...
As alterações descritas nesta seção aplicam-se ao número da compilação 8.1.2709. Os números em parênteses em alguns cabeçalhos referem-se aos números de suporte no Microsoft Dynamics Lifecycle Services (LCS).

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>O sistema não pôde gerar dias corridos ao importar por meio do Data Management Framework (381195)

Esta alteração corrige um problema em que a importação de dias corridos gera o erro **Formato de data inválido**. Este erro impede a criação de linhas de data no calendário de trabalho.
