...
No Talent, você deve ativar a integração e inserir as informações de configuração para se conectar ao Dayforce. Para que a transação da contabilidade produzida seja importada para o Microsoft Dynamics 365 for Finance and Operations, também será preciso configurar uma conta de armazenamento do Microsoft Azure e inserir a cadeia de conexão do Armazenamento do Azure em Finance and Operations.
