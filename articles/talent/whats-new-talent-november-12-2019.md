...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Novidades ou alterações no Dynamics 365 Talent (12 de novembro de 2019)
...
As alterações descritas nesta seção aplicam-se ao número da compilação 8.1.2604. Os números em parênteses em alguns cabeçalhos referem-se aos números de suporte no Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>O local do Office não é atualizado por meio da pasta de trabalho do Excel (369727)

Com essa alteração, agora você poderá atualizar o local do Office usando o Designer de pasta trabalho do Office.
