...
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-core-hr-september-17-2018"></a>Novidades ou alterações no Dynamics 365 for Talent Core HR (17 de setembro de 2018)

[!include [banner](includes/banner.md)]

**Compilação 8.1.154.0**

Este tópico descreve os recursos novos ou alterados no Core HR.

## <a name="leave-and-absence--accrue-time-based-on-hours-worked"></a>Licença e ausências – Acúmulo de tempo com base nas horas trabalhadas
...
## <a name="platform-update-18"></a>Update 18 para plataforma

A atualização de plataforma 18 agora faz parte da versão do Talent. 
...
-   Na atualização de plataforma 18, o cliente Web do Talent agora alinha seus elementos visuais com o Design Fluente da Microsoft.
    ...
    -   As alterações na maneira que os campos são exibidos no modo de leitura.
...
Esta versão inclui várias correções de bug adicionais, incluindo que referências a ACA, ADA e I9 serão habilitadas somente em empresas dos Estados Unidos.
