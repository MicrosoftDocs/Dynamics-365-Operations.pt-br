...
---
# <a name="troubleshoot-integration-with-linkedin"></a>Solucionar problemas de integração com o LinkedIn
...
## <a name="you-cant-sign-in-to-linkedin-from-attract"></a>Não é possível entrar no LinkedIn pelo Attract

Caso esteja tendo problemas para entrar no LinkedIn pelo Attract, tente estas etapas:

1. Verifique se as credenciais do LinkedIn que você inseriu no Attract são válidas e estão corretas.
2. Se as credenciais forem válidas e estiverem corretas, entre em contato com o [suporte do LinkedIn](https://www.linkedin.com/help/linkedin).
3. Se o problema persistir, entre em contato com o [suporte da Microsoft](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Os lançamentos de trabalho pelo Attract não são exibidos no LinkedIn
