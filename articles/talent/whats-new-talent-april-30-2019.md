...
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-april-30-2019"></a>Novidades ou alterações no Dynamics 365 for Talent (30 de abril de 2019)
...
Na atualização da plataforma 26, os usuários podem criar regras de alerta que enviem automaticamente notificações por email a contatos quando notificações são disparadas por um evento.
