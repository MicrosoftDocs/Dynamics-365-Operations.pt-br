...
description: Este artigo descreve como gerenciar os arquivos robots. txt no Microsoft Dynamics 365 Commerce.
author: BrianShook
ms.date: 07/02/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9286402"
---
# <a name="manage-robotstxt-files"></a>Gerenciar arquivos robots.txt

[!include [banner](includes/banner.md)]

Este artigo descreve como gerenciar os arquivos robots. txt no Microsoft Dynamics 365 Commerce.
