...
description: Este artigo descreve como adicionar, excluir e editar usuários de parceiros comerciais em sites de comércio eletrônico entre empresas (B2B) no Microsoft Dynamics 365 Commerce e no Commerce headquarters.
author: josaw1
ms.date: 04/19/2022
ms.topic: article
ms.prod: ''
...
Este artigo descreve como adicionar, excluir e editar usuários de parceiros comerciais em sites de comércio eletrônico entre empresas (B2B) no Microsoft Dynamics 365 Commerce e no Commerce headquarters.

> [!NOTE]
> - O artigo [Gerenciar parceiros comerciais B2B usando hierarquias de cliente](partners-customer-hierarchies.md) é um pré-requisito deste documento.
...
Para aprovar uma solicitação de parceiros de negócios no Commerce headquarters, siga estas etapas.

1. Acesse **TI de Varejo e Comércio \> Agenda de Distribuição**.
1. Execute o trabalho **P-0001** para receber todas as solicitações de integração de parceiros comerciais no Commerce headquarters.
1. Após a execução com êxito do trabalho **P-0001**, acesse **TI de Varejo e Comércio \> Cliente** e execute o trabalho **Sincronizar solicitações de clientes e canais**. Depois que esse trabalho for executado com êxito, as solicitações de integração serão criadas como clientes potenciais do tipo **Cliente potencial B2B** no Commerce headquarters. 
...
Para configurar notificações por email no Commerce headquarters para eventos do tipo de notificação **Cliente potencial B2B aprovado** ou **Cliente potencial B2B rejeitado**, siga estas etapas.
...
> [!NOTE]
> Quando você remover um usuário da lista de usuários que podem acessar o site de comércio eletrônico B2B, o registro do cliente correspondente será removido do registro da hierarquia de clientes do parceiro comercial. No entanto, o próprio registro do cliente não é excluído do Commerce headquarters.
...
Os administradores podem integrar parceiros comerciais e usuários diretamente no Commerce headquarters. Esse recurso é útil para a integração de parceiros de negócios existentes no site de comércio eletrônico B2B.

Para integrar parceiros comerciais e usuários no Commerce headquarters, siga estas etapas.
...
- Todos os trabalhos mencionados neste artigo podem ser configurados para serem executados em uma agenda em um formato de lote. A expectativa é de que os parceiros comerciais configurem trabalhos em lotes conforme necessário.
- No momento, somente um registro de usuário/cliente pode ser designado como um usuário administrador, e essa função pode ser alterada somente no Commerce headquarters. Não há suporte a recursos de autoatendimento que permitam a parceiros comerciais designar vários administradores ou alterar administradores de sites de comércio eletrônico B2B.
...
- Toda a lógica comercial e a validação da experiência de um usuário em um site de comércio eletrônico B2B são baseadas na configuração do registro do cliente que é mapeado para o usuário no Commerce headquarters.
