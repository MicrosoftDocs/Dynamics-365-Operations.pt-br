...
1. Na caixa de diálogo **Novo fragmento de página**, selecione o módulo **Faixa promocional** e, em **Nome do fragmento de página**, insira um nome (por exemplo, **Faixa entre canais**). Em seguida, selecione **OK**.
