...
description: Este tópico descreve a funcionalidade para desabilitar as regras de validação de transação no Microsoft Dynamics 365 Commerce.
author: analpert
ms.date: 12/11/2021
ms.topic: index-page
ms.prod: ''
