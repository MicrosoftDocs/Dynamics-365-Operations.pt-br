...
Esta seção descreve as configurações do Commerce específicas e recomendadas para a Áustria. Para obter mais informações sobre como configurar informações, consulte [Home page do Commerce](../index.md).
