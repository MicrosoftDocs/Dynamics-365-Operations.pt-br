...
1. Siga uma destas etapas:
    ...
    - Vá para **Contas a receber \> Documentos fiscais \> Documentos fiscais eletrônicos \> Processo de exportação/importação de NF-e**.
    - Se você estiver usando o [Complemento de faturamento eletrônico para o Brasil](../../finance/localizations/e-invoicing-bra-get-started.md), vá para **Varejo e Commerce \> Varejo e IT do Commerce \> Publicação no PDV \> Exportar documentos NFC-e**.
