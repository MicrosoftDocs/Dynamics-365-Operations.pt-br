...
1. Vá para **Varejo e Comércio \> Configuração da sede \> Parâmetros \> Parâmetros de comércio**. Na FastTab **Ordens de cliente**, defina a opção **Processar ordens de devolução como ordens de venda** como **Sim**.
