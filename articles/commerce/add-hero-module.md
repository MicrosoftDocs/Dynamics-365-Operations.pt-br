...
description: Este artigo abrange os módulos de bloco de conteúdo e descreve como adicioná-los a páginas de site no Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8870601"
---
# <a name="content-block-module"></a>Módulo de bloco de conteúdo

[!include [banner](includes/banner.md)]

Este artigo abrange os módulos de bloco de conteúdo e descreve como adicioná-los a páginas de site no Microsoft Dynamics 365 Commerce.
...
1. Na caixa de diálogo **Selecionar módulos**, selecione o módulo de herói e, depois, **OK**.
