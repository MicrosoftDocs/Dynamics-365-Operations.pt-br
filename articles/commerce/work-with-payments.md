---
title: Métodos de pagamento nos call centers
description: Este artigo descreve os diversos métodos de pagamento que você pode usar em um call center no Dynamics 365 Commerce.
author: josaw1
ms.date: 03/28/2018
ms.topic: article
ms.prod: ''
