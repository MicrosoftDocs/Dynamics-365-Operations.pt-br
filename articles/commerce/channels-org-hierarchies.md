...
description: Este artigo descreve como configurar hierarquias da organização no Microsoft Dynamics 365 Commerce.
author: samjarawan
ms.date: 01/27/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9280438"
---
# <a name="set-up-organization-hierarchies"></a>Configurar hierarquias da organização

[!include [banner](includes/banner.md)]

Este artigo descreve como configurar hierarquias da organização no Microsoft Dynamics 365 Commerce.
