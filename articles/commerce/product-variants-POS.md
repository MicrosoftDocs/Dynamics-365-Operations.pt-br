...
- **Lojas** – A lista mostra as lojas configuradas usando o grupo de localizadores de lojas da loja atual na sede.
- **Centros de distribuição** – Os vários tipos de centros de distribuição (como depósitos) podem ser configurados no Commerce. Entretanto, a lista mostra informações de disponibilidade de estoque somente para centros de distribuição do tipo **Padrão** .
