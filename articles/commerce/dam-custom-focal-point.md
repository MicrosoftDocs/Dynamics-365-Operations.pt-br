...
### <a name="define-a-custom-focal-point-for-an-image"></a>Definir um ponto focal personalizado de uma imagem

Para definir um ponto focal personalizado de uma imagem, siga as etapas a seguir.
