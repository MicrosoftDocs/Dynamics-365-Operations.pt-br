...
description: Este artigo abrange os módulos de contêiner e descreve como adicioná-los a páginas de site no Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8867831"
---
# <a name="container-module"></a>Módulo de contêiner

[!include [banner](includes/banner.md)]

Este artigo abrange os módulos de contêiner e descreve como adicioná-los a páginas de site no Microsoft Dynamics 365 Commerce.
...
1. Na caixa de diálogo **Criar uma nova página**, em **Nome da página**, insira **Página Contêiner** e, depois, selecione **Avançar**.
1. Em **Escolher um modelo**, selecione o **Modelo de contêiner** que você criou e, depois, selecione **Avançar**.
