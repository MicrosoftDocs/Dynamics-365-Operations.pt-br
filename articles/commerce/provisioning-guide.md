...
Para adicionar o Conector do Azure ao projeto do LCS, siga as etapas em [Concluir o processo de integração do Azure Resource Manager (ARM)](../fin-ops-core/dev-itpro/deployment/arm-onboarding.md).
