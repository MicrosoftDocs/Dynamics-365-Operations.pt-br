...
ms.locfileid: "3021579"
---
# <a name="store-inventory-management"></a>Gerenciamento de estoque de loja

[!include [banner](includes/banner.md)]

Ao trabalhar com estoque no Dynamics 365 Commerce e usar o aplicativo POS, é importante observar que o POS fornece suporte limitado para dimensões de estoque e certos tipos de item de estoque.
