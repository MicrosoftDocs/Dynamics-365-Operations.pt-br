...
description: Este artigo explica como você pode permitir que os clientes recusem receber recomendações personalizadas no Microsoft Dynamics 365 Commerce.
author: bebeale
ms.date: 09/15/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9283659"
---
# <a name="opt-out-of-personalized-recommendations"></a>Cancelar recomendações personalizadas

[!include [banner](includes/banner.md)]

Este artigo explica como você pode permitir que os clientes recusem receber recomendações personalizadas no Microsoft Dynamics 365 Commerce.
