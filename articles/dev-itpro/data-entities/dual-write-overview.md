...
---
# <a name="near-real-time-data-integration-between-finance-and-operations-and-common-data-service"></a>Integração de dados quase em tempo real entre o Finance and Operations e o Common Data Service

[!include [banner](../includes/banner.md)]

[!include [preview](../includes/preview-banner.md)]

No mundo digital atual, os ecossistemas comerciais usam o conjunto de aplicativos do Microsoft Dynamics 365 como um todo. Como os dados de dispositivos de contatos, clientes, operações e da Internet das Coisas (IoT) fluem para uma origem, há uma oportunidade de loops de comentários digitais. Para obter essa experiência, é essencial a integração entre aplicativos do Dynamics 365 for Finance and Operations e do Dynamics 365 for Customer Engagement. Os aplicativos de Customer Engagement são criados sobre o Common Data Service. A integração entre dados do Finance and Operations com o Common Data Service permite que aplicativos do Customer Engagement comuniquem-se de maneira coerente e fluente com o Finance and Operations.

O Finance and Operations e o Common Data Service oferecem sincronização de dados quase em tempo real entre aplicativos do Finance and Operations e do Customer Engagement em uma estrutura de gravação dupla. A cobertura é ampla e abrange 28 áreas de superfície do Finance and Operations. A meta é oferecer ao usuário uma experiência "One Dynamics 365" por meio de fluxos de dados contínuos que conectem processos de negócios em aplicativos.
...
Siga estas etapas para configurar a integração entre o Finance and Operations e o Common Data Service.
