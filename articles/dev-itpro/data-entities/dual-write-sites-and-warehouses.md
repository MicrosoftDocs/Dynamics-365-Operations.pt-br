...
Este tópico descreve a integração de dados do site e do depósito entre o Finance and Operations e o Common Data Service. Sites e depósitos operacionais são conceitos comuns em um aplicativo de gerenciamento de cadeia de fornecedores. Eles são usados para modelar a cadeia de fornecedores da sua empresa.
