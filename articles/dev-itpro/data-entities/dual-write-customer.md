...
É comum que registros de cliente sejam dominados em mais de um aplicativo. Por exemplo, a atividade de vendas pode exibir registros de cliente comercial por meio de um aplicativo Microsoft Dynamics 365 for Sales. O comércio eletrônico ou as vendas de varejo podem exibir registros de cliente por meio de um aplicativo Dynamics 365 for Finance and Operations. Seja qual for a origem do registro do cliente, ele é integrado em segundo plano nos limites dos aplicativos e nas diferenças de infraestrutura. O domínio do cliente integrado ajuda a tratar vários cenários de domínio e fornece uma exibição abrangente do cliente ao pacote de aplicativos do Dynamics 365.

## <a name="customer-data-flow"></a>Fluxo de dados do cliente

*Cliente* é um conceito bem definido no Finance and Operations e no Common Data Service. Portanto, a integração de dados do cliente envolve apenas a harmonização do conceito de clientes entre os aplicativos Finance and Operations e Common Data Service. A ilustração a seguir mostra o fluxo de dados do cliente.
...
Finance and Operations    | Aplicativo do Customer Engagement
--------------------------|---------------------------------
Cliente V3               | Conta
Cliente V3               | Contato
...
Esse modelo sincroniza informações de cliente mestre para clientes comerciais e organizacionais entre o Finance and Operations e o Common Data Service.
...
Esse modelo sincroniza dados de cliente mestre para clientes e usuários finais entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza todas as informações de contato principais, secundárias e terciárias de clientes e fornecedores entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza as informações do grupo de clientes entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza as informações do método de pagamento do cliente entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza as informações do grupo de cartões-fidelidade entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza dados de referência de agendas de pagamento, para clientes e fornecedores, entre o Finance and Operations e o Customer Engagement.
...
Sincroniza dados de referência de linhas de agendas de pagamento, para clientes e fornecedores, entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza dados de referência de dias de pagamento, para clientes e fornecedores, entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza dados de referência de linhas de dias de pagamento, para clientes e fornecedores, entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza dados de referência de condições de pagamento (condições de pagamento), para clientes e fornecedores, entre o Finance and Operations e o Customer Engagement.
...
Esse modelo sincroniza dados de referência de afixos de nomes, para clientes e fornecedores, entre o Finance and Operations e o Customer Engagement.
