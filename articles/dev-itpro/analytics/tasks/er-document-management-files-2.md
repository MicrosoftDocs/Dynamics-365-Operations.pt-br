...
---
# <a name="extend-data-model-to-use-document-management-files-in-format-outputs"></a>Estender modelo de dados para usar arquivos de Gerenciamento de Documentos em saídas de formato
