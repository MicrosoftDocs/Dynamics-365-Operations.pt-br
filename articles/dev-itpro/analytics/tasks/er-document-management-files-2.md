...
---
# <a name="extend-data-models-to-use-document-management-files-in-er-output"></a>Estender modelos de dados para usar arquivos de gerenciamento de documentos em saídas de ER
