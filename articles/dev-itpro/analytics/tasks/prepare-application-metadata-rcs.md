...
A configuração de metadados de ER criada foi salva como o arquivo XML que pode ser importado para o RCS e usado como a fonte de informações sobre metadados para o domínio comercial de comércio exterior no Finance and Operations. Com base nessas informações, podemos especificar o mapeamento entre metadados de aplicativos e o modelo de dados do ER.
