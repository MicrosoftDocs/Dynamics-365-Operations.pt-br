...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing-for-electronic-reporting-er"></a>Usar cálculos para criar a saída para contagem e soma para relatório eletrônico (ER)
