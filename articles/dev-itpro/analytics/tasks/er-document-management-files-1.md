...
---
# <a name="prepare-data-model-to-use-document-management-files-in-format-outputs"></a>Preparar modelo de dados para usar arquivos de Gerenciamento de Documentos em saídas de formato
