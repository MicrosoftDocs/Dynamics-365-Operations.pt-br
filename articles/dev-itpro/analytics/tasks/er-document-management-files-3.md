...
---
# <a name="create-format-to-use-document-management-files-in-format-outputs"></a>Criar formato para usar arquivos de Gerenciamento de Documentos em saídas de formato
