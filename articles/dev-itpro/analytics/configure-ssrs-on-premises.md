...
Siga as etapas deste tópico para configurar o SSRS (SQL Server Reporting Services) para uma implantação local do Microsoft Dynamics 365 for Finance and Operations.
