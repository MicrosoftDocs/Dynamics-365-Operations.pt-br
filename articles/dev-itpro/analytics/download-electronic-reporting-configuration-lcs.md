...
9. Clique em **Importar** para baixar a versão selecionada do LCS para a instância atual do Finance and Operations.

    > [!NOTE]
    > O botão **Importar** não está disponível para as versões de configuração do ER que já estão presentes na instância do Finance and Operations.
