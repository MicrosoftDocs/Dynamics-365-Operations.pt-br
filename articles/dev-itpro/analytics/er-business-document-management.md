...
O **gerenciamento de documentos comerciais** é baseado na estrutura de ER e permite que os usuários comerciais editem modelos de documentos comerciais usando o serviço do Microsoft Office 365 ou o aplicativo de área de trabalho apropriado do Microsoft Office. As edições nos documentos podem incluir a alteração dos designs dos documentos comerciais e a adição de espaços reservados para dados adicionais no Dynamics 365 for Finance and Operations sem alterações no código-fonte e novas implantações. Não é necessário conhecimento da estrutura de ER para atualizar modelos de documentos comerciais.
...
Para usar o gerenciamento de documentos comerciais para editar modelos nos formatos Excel ou Word usando aplicativos da área de trabalho do Microsoft Office, você deve ter o Microsoft Office 2010 ou posterior instalado. Isso é permitido na nuvem e na implantação local do Finance and Operations.
...
Você deve importar configurações de ER que contêm modelos de documentos comerciais para a instância atual do Finance and Operations. Baixe e armazene localmente os seguintes arquivos para concluir este procedimento.
...
1. Entre no Finance and Operations como um usuário com acesso à página **Parâmetros do documento comercial**.
...
Por padrão, quando o acesso às permissões de gerenciamento de documentos comerciais não está habilitado, todos os usuários com acesso ao espaço de trabalho Gerenciamento de documentos comerciais verão todos os modelos de solução de ER disponíveis no Finance and Operations. O espaço de trabalho Gerenciamento de documentos comerciais mostrará apenas os modelos que residem nas configurações do formato de ER e que são marcados por uma etiqueta **Tipo de documento comercial**.
...
1. Entre no Finance and Operations como um usuário com acesso à página **Configurador de permissões de acesso**.
...
Com essa configuração, todos os usuários atribuídos a qualquer função de segurança configurada para executar a obrigação **Gerenciar modelos de documento comercial** (nome da AOT **ERBDManageTemplates**) podem abrir o espaço de trabalho Gerenciamento de documentos comerciais e podem editar qualquer modelo disponível no Finance and Operations.
...
1. Entre no Finance and Operations como um usuário com acesso ao espaço Gerenciamento de documentos comerciais.
...
A página **Editor de modelo de BDM** do Finance and Operations será aberta. O modelo selecionado estará disponível para edição online usando o Office 365.
...
1. No Finance and Operations, altere para a empresa **USMF**.
...
Trata-se de um problema conhecido com o redirecionamento do Office 365 ao Finance and Operations. Isso acontece quando você entra no Office 365 pela primeira vez. Para contornar esse problema, selecione o botão **Voltar** do seu navegador para retornar ao Finance and Operations.
...
Provavelmente, você entrou na instância atual do Finance and Operations do domínio do Azure AD, diferente do domínio do Azure AD que foi usado para implantar essa instância do Finance and Operations. Como o serviço do SharePoint, usado para armazenar modelos para disponibilizá-los para edição usando os aplicativos da área de trabalho do Office, pertence ao mesmo domínio que o Finance and Operations, não temos permissão para acessar o serviço do SharePoint. Para resolver esse problema, entre na instância atual do Finance and Operations usando as credenciais de um usuário com o domínio correto do Azure AD.
