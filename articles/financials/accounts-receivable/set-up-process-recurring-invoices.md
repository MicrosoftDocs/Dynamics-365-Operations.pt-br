...
<a name="create-a-recurring-free-text-invoice-template"></a><span data-ttu-id="24b45-107">Criar um modelo de fatura de texto livre recorrente</span><span class="sxs-lookup"><span data-stu-id="24b45-107">Create a recurring free text invoice template</span></span>
---------------------------------------------

<span data-ttu-id="24b45-108">Para cobrar clientes sobre os mesmos serviços regularmente, você deve definir um modelo de fatura de texto livre que pode ser reutilizado para criar faturas.</span><span class="sxs-lookup"><span data-stu-id="24b45-108">To invoice customers for the same services on a regular basis, you must define a free text invoice template that can be reused to create the invoices.</span></span> <span data-ttu-id="24b45-109">Este modelo contém as seguintes informações:</span><span class="sxs-lookup"><span data-stu-id="24b45-109">This template contains the following information:</span></span>

-   <span data-ttu-id="24b45-110">Informações do cabeçalho, como grupos de impostos, termos de pagamentos e métodos de pagamento</span><span class="sxs-lookup"><span data-stu-id="24b45-110">Header information, such as tax groups, terms of payment, and the method of payment</span></span>
-   <span data-ttu-id="24b45-111">Informações da linha, como descrição do serviço, contas da receita, preço unitário e valor da fatura</span><span class="sxs-lookup"><span data-stu-id="24b45-111">Line information, such as the service description, revenue accounts, unit price, and invoice amount</span></span>
-   <span data-ttu-id="24b45-112">Encargos de envio e manipulação</span><span class="sxs-lookup"><span data-stu-id="24b45-112">Charges for shipping or handling</span></span>
-   <span data-ttu-id="24b45-113">Distribuições contábeis com informações de dimensão financeira, como centros de custo e unidades de negócios</span><span class="sxs-lookup"><span data-stu-id="24b45-113">Accounting distributions together with financial dimension information, such as cost centers and business units</span></span>

<span data-ttu-id="24b45-114">Na verdade, você está criando uma fatura e inteira e salvando como modelo.</span><span class="sxs-lookup"><span data-stu-id="24b45-114">In effect, you're creating an entire invoice and saving it as a template.</span></span> <span data-ttu-id="24b45-115">Você pode configurar o modelos usando a página **Faturas recorrentes**.</span><span class="sxs-lookup"><span data-stu-id="24b45-115">You can set up the templates using the **Recurring invoices** page.</span></span>

## <a name="assign-a-free-text-invoice-template-to-a-customer-and-enter-recurrence-details"></a><span data-ttu-id="24b45-116">Atribuir um modelo de fatura de texto livre para um cliente e inserir os detalhes de recorrência</span><span class="sxs-lookup"><span data-stu-id="24b45-116">Assign a free text invoice template to a customer and enter recurrence details</span></span>
<span data-ttu-id="24b45-117">Depois que o modelo é criado, você deve atribuir o modelo aos clientes que você deseja cobrar.</span><span class="sxs-lookup"><span data-stu-id="24b45-117">After the template is created, you must assign the template to the customers that you want to invoice.</span></span> <span data-ttu-id="24b45-118">Além disso, você deve especificar quando e como a fatura será usada.</span><span class="sxs-lookup"><span data-stu-id="24b45-118">Additionally, you must specify when and how often the invoice will be used.</span></span> <span data-ttu-id="24b45-119">Você pode atribuir os modelos na guia **fatura** na página **Clientes**.</span><span class="sxs-lookup"><span data-stu-id="24b45-119">You can assign the templates on the **Invoice** tab of the **Customers** page.</span></span> <span data-ttu-id="24b45-120">Adicione o modelo à lista e atualize as seguintes informações:</span><span class="sxs-lookup"><span data-stu-id="24b45-120">Add the template to the list, and update the following information:</span></span>

-   <span data-ttu-id="24b45-121">A data de início e, opcionalmente, a data final para a cobrança recorrente</span><span class="sxs-lookup"><span data-stu-id="24b45-121">The start date and, optionally, the end date for the recurring billing</span></span>
-   <span data-ttu-id="24b45-122">A frequência de faturamento recorrente (por exemplo, cada dia ou uma vez por mês)</span><span class="sxs-lookup"><span data-stu-id="24b45-122">The frequency of the recurring billing (for example, every day or once a month)</span></span>
-   <span data-ttu-id="24b45-123">O valor máximo de cobrança (se essa informação for necessária)</span><span class="sxs-lookup"><span data-stu-id="24b45-123">The maximum billing amount (if this information is required)</span></span>

<span data-ttu-id="24b45-124">Um cliente pode ter vários modelos que têm frequências diferentes.</span><span class="sxs-lookup"><span data-stu-id="24b45-124">A customer can have multiple templates that have different frequencies.</span></span>
