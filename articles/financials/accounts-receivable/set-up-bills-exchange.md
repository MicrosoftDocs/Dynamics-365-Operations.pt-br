...
Na página **Parâmetros de contas a receber** , os perfis de lançamento predefinidos para letras de câmbio são inseridos na guia **Razão e imposto sobre vendas** . As sequências numéricas são definidas na guia **Sequências numéricas** . Configurar nomes de diário para letras de câmbio
------------------------------------------
