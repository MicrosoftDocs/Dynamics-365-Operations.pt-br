...
Você poderia devolver alguns dos itens em uma fatura e receberia uma nota de crédito. Se um desconto à vista tiver sido retirado da fatura original, você poderá subtrair o valor do desconto e receber um reembolso do valor correto. Se a **opção <strong>Calcular descontos à vista para notas de crédito estiver definida como **Sim</strong> na página <strong>Parâmetros de contas a pagar</strong>, o desconto será calculado automaticamente para a nota de crédito. 
