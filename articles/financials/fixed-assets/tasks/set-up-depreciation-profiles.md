...
1. Vá para Ativos fixos > Configuração > Perfis de depreciação.
2. Clique em Novo.
3. No campo de perfil de depreciação, insira um valor.
4. No campo Nome, digite um valor.
5. No campo Método, selecione uma opção.
    * Se você selecionar reduzir o saldo, você precisará inserir uma porcentagem no campo percentual.  
6. No campo Ano de depreciação, selecione uma opção.
