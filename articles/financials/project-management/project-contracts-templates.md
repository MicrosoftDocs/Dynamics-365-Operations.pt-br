...
# <a name="synchronize-project-contracts-and-projects-from-project-service-automation-directly-to-project-contracts-and-projects-in-finance-and-operations"></a>Sincronizar contratos de projeto e projetos do Project Service Automation diretamente para contratos de projeto e projetos do Finance and Operations
...
> [!NOTE]
> Antes de usar a solução de integração do Project Service Automation para o Finance and Operations, você deve estar familiarizado com o recurso de integração de dados do Dynamics 365.
...
|----------------------------------|--------------------------------------------------------|
| Ordens                           | Entidade de integração para o contrato do projeto.                |
| Projetos                         | Entidade de integração para o projeto.                         |
| Linhas da ordem                      | Entidade de integração para a linha de contrato do projeto.          |
| Marcos de linha de contrato do projeto | Entidade de integração para marco de linha de contrato do projeto. |
...
As linhas de contrato do projeto são gerenciadas no Project Service Automation e são sincronizadas para o Finance and Operations como regras de cobrança de contrato do projeto. A sincronização atualizará o tipo de projeto para o projeto da linha de contrato e grupo de projetos se o método de cobrança for diferente do tipo de projeto padrão.
...
Você deverá usar o Microsoft Power Query para filtrar dados se as seguintes condições forem atendidas:
