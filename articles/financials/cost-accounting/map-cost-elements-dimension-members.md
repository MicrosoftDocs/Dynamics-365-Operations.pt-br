...
<span data-ttu-id="c4453-105">Se for uma empresa e global obedecer os requisitos legais de contabilidade, você pode usar vários gráficos de contas.</span><span class="sxs-lookup"><span data-stu-id="c4453-105">If you're a global company and comply with statutory accounting requirements, you might use multiple charts of accounts.</span></span> <span data-ttu-id="c4453-106">Quando você importa membros da dimensão do elemento de custo previsto de gráfico de contas diferentes, você pode encerrar acima com uma mistura de contas.</span><span class="sxs-lookup"><span data-stu-id="c4453-106">When you import cost element dimension members from different charts of accounts, you can end up with a mix of accounts.</span></span> <span data-ttu-id="c4453-107">Porém, essas contas podem ter a mesma realmente natureza, e você pode querer analisar e alocar custos para eles usando um formato comum.</span><span class="sxs-lookup"><span data-stu-id="c4453-107">However, these accounts might actually have the same nature, and you might want to analyze and allocate costs for them by using a common format.</span></span>

## <a name="map-cost-element-dimension-members-to-a-common-format"></a><span data-ttu-id="c4453-108">Mapear membros da dimensão do elemento de custo estimado em um formato comum</span><span class="sxs-lookup"><span data-stu-id="c4453-108">Map cost element dimension members to a common format</span></span>
<span data-ttu-id="c4453-109">O exemplo a seguir mostra como é, como controlador de custo previsto, pode criar uma nova dimensão de elemento de custo estimado na contabilização de custo previsto que os membros da dimensão do elemento de custo previsto de mapas de gráfico. de E contracheques. estrutura de contas e de plano francês estrutura de contas na comum conjunto de elementos de custo previsto de membros.</span><span class="sxs-lookup"><span data-stu-id="c4453-109">The following example shows how you, as a cost controller, can create a new cost element dimension in Cost accounting that maps cost element dimension members from the US chart of accounts structure and the French chart of accounts structure to a common set of cost element dimension members.</span></span> <span data-ttu-id="c4453-110">Você pode usar a comum definida de membros da dimensão do elemento de custo estimado para analisar dados de custo previsto de duas entidades legais em um motivo de contabilização de custo previsto.</span><span class="sxs-lookup"><span data-stu-id="c4453-110">You can then use the common set of cost element dimension members to analyze cost data from the two legal entities in a cost accounting ledger.</span></span>

| <span data-ttu-id="c4453-111">Fonte: plano de contas dos EUA</span><span class="sxs-lookup"><span data-stu-id="c4453-111">Source: US chart of accounts</span></span>                                          | <span data-ttu-id="c4453-112">Fonte: plano de contas Francês</span><span class="sxs-lookup"><span data-stu-id="c4453-112">Source: French chart of accounts</span></span>                                          | <span data-ttu-id="c4453-113">Novo comum definido de membros da dimensão do elemento de custo previsto</span><span class="sxs-lookup"><span data-stu-id="c4453-113">New common set of cost element dimension members</span></span>                        |
|-----------------------------------------------------------------------|---------------------------------------------------------------------------|-------------------------------------------------------------------------|
| <span data-ttu-id="c4453-114">Membros importados dimensão de elemento de custo previsto plano de contas dos EUA</span><span class="sxs-lookup"><span data-stu-id="c4453-114">Imported cost element dimension members from the US chart of accounts</span></span> | <span data-ttu-id="c4453-115">Membros importados dimensão de elemento de custo previsto do gráfico de contas Francês.</span><span class="sxs-lookup"><span data-stu-id="c4453-115">Imported cost element dimension members from the French chart of accounts</span></span> | <span data-ttu-id="c4453-116">Mapeamento de membros franceses e dos EUA e dimensão de elemento de custo previsto a um conjunto comuns</span><span class="sxs-lookup"><span data-stu-id="c4453-116">Mapping of US and French cost element dimension members to a common set</span></span> |
| <span data-ttu-id="c4453-117">5001: vendas</span><span class="sxs-lookup"><span data-stu-id="c4453-117">5001: Sales</span></span>                                                           | <span data-ttu-id="c4453-118">5001: Vendas e propaganda</span><span class="sxs-lookup"><span data-stu-id="c4453-118">5001: Sales and advertising</span></span>                                               | <span data-ttu-id="c4453-119">5000: Vendas e propaganda</span><span class="sxs-lookup"><span data-stu-id="c4453-119">5000: Sales and advertising</span></span>                                             |
...
## <a name="update-mappings-at-any-time"></a><span data-ttu-id="c4453-131">Mapeamentos de atualização a qualquer momento</span><span class="sxs-lookup"><span data-stu-id="c4453-131">Update mappings at any time</span></span>
<span data-ttu-id="c4453-132">Você pode atualizar as definições de mapeamento para uma dimensão de elemento de custo previsto a qualquer momento.</span><span class="sxs-lookup"><span data-stu-id="c4453-132">You can update the mapping definitions for a cost element dimension at any time.</span></span> <span data-ttu-id="c4453-133">Como os mapeamentos não são efetivos data, as alterações são aplicadas na próxima vez que você processa transações de custo estimado ou cálculos de custo estimados executado.</span><span class="sxs-lookup"><span data-stu-id="c4453-133">Because mappings aren't date-effective, changes are applied the next time that you process cost transactions or run cost calculations.</span></span>
