...
- [Livros fiscais](latam-bra-fiscal-books.md)
 ...
 - [​Processo de NF-e​](latam-bra-nf-e-process.md)
   - [Transmissão automática de notas fiscais de NF-e](tasks/br-00058-automatic-transmission-nf-e-fiscal-documents.md)
   - [Gerar emails para NF-e aprovada e anexar arquivos PDF da DANFE e arquivos XML da NF-e aos emails](tasks/br-00053-3-generate-emails-approved-nf-e-attach-danfe-pdf-files-nf-e-xml-files-emails.md)
...
- [Impostos](latam-bra-calculate-taxes.md)
  ...
  - [Emitir notas fiscais de crédito de imposto ICMS](tasks/br-00072-issuing-icms-tax-credit-fiscal-document.md)
  - [Emitir notas fiscais de transferência de crédito de imposto ICMS](tasks/br-00071-issuing-icms-tax-credit-transfer-fiscal-document.md)
  - [Configurar códigos de ajuste para imposto ICMS](tasks/br-10001-1-set-up-adjustment-codes-icms-tax.md)
  - [Configurar códigos de ajuste para impostos ICMS em notas fiscais](tasks/br-10001-2-set-up-adjustment-codes-icms-taxes-fiscal-documents.md)
  - [Configurar códigos de ajuste para impostos IPI](tasks/br-10004-1-set-up-adjustment-codes-ipi-taxes.md)
...
- Tarefas para o Brasil
  ...
  - [Cancelar uma nota fiscal complementar de compra](tasks/br-00026-2-cancel-purchase-complementary-fiscal-document.md)
  - [Emitir notas fiscais para fornecedores](tasks/br-00033-issuing-fiscal-document-non-taxable-vendors.md)
  - [Emitir notas fiscais para clientes](tasks/br-00038-issuing-customer-fiscal-document.md)
  - [Guias de entrega](tasks/br-00041-delivery-slip.md)
  - [Encargos diversos sobre faturas de texto livre](tasks/br-00050-miscellaneous-charge-free-text-invoice.md)
  ...
  - [Nota fiscal de serviços eletrônica usando arquivos de texto](tasks/br00059-service-electronic-fiscal-document-text-files.md)
  ...
  - [Gerenciamento de pagamento eletrônico para pagamentos de fornecedores](tasks/br-00067-electronic-payment-management-vendor-payments.md)
  - [Notas de débito do projeto](tasks/br-00076-project-debit-notes.md)
  - [Gerenciar texto da nota fiscal em notas de compras](tasks/br-00080-manage-fiscal-document-texts-procurement-documents.md)
  - [Receber notas fiscais de fornecedor (ativos fixos - ICMS recuperável de longo prazo)](tasks/br-00082-receiving-vendor-fiscal-document-fixed-assets-icms-long-term-recoverable.md)
  ...
  - [Operações não fiscais](tasks/br-10016-non-fiscal-operations.md)
  - [Inserir uma transação do CIAP](tasks/br-10020-1-enter-ciap-transaction.md)
  - [Calcular o valor de crédito CIAP](tasks/br-10020-2-calculate-ciap-credit-amount.md)
  - [Incluir o crédito CIAP de um período anterior](tasks/br-10020-3-include-ciap-credit-from-previous-period.md)
  - [Ativos fixos com PIS e COFINS](tasks/br-10020-4-pis-cofins-fixed-assets.md)
