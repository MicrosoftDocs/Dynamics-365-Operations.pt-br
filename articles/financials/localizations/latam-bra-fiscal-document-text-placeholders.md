...
<span data-ttu-id="c668f-107">Você também pode incluir espaços reservados no campo **Observação** na página **Textos da nota fiscal** quando anexar um texto de nota fiscal a uma ordem de venda, ordem de compra ou fatura de texto livre.</span><span class="sxs-lookup"><span data-stu-id="c668f-107">You can also include placeholders in the **Note** field on the **Fiscal document texts** page when you attach a fiscal document text to a sales order, purchase order, or free text invoice.</span></span> <span data-ttu-id="c668f-108">Quando você lança uma ordem de venda, ordem de compra ou fatura de texto livre que tem um texto de nota fiscal que inclui espaços reservados, os espaços reservados são substituídos pelos valores nas marcas predefinidas.</span><span class="sxs-lookup"><span data-stu-id="c668f-108">When you post a sales order, purchase order, or free text invoice that has a fiscal document text that includes placeholders, the placeholders are replaced by the values in the predefined tags.</span></span>

<span data-ttu-id="c668f-109">As tabelas a seguir contêm as marcas predefinidas que têm suporte para texto da nota fiscal e seu valor.</span><span class="sxs-lookup"><span data-stu-id="c668f-109">The following tables contain the predefined tags that support fiscal document text and its value.</span></span>
<span data-ttu-id="c668f-110">As marcas que têm suporte para texto da nota fiscal para processos mencionados</span><span class="sxs-lookup"><span data-stu-id="c668f-110">Tags that support fiscal document text for referenced processes</span></span>
---------------------------------------------------------------

| <span data-ttu-id="c668f-111">Marca predefinida</span><span class="sxs-lookup"><span data-stu-id="c668f-111">Predefined tag</span></span>                  | <span data-ttu-id="c668f-112">Alíquota</span><span class="sxs-lookup"><span data-stu-id="c668f-112">Value</span></span>                                 |
|---------------------------------|---------------------------------------|
| <span data-ttu-id="c668f-113">%RefProcess\_TaxAuthorityName</span><span class="sxs-lookup"><span data-stu-id="c668f-113">%RefProcess\_TaxAuthorityName</span></span>   | <span data-ttu-id="c668f-114">O nome da autoridade do imposto.</span><span class="sxs-lookup"><span data-stu-id="c668f-114">The name of the tax authority.</span></span>        |
| <span data-ttu-id="c668f-115">%RefProcess\_TaxAuthorityAgency</span><span class="sxs-lookup"><span data-stu-id="c668f-115">%RefProcess\_TaxAuthorityAgency</span></span> | <span data-ttu-id="c668f-116">A agência da autoridade do imposto.</span><span class="sxs-lookup"><span data-stu-id="c668f-116">The agency of the tax authority.</span></span>      |
...
| <span data-ttu-id="c668f-129">%PIS</span><span class="sxs-lookup"><span data-stu-id="c668f-129">%PIS</span></span>           | <span data-ttu-id="c668f-130">O valor da contribuição do PIS (Programa de Integração Social).</span><span class="sxs-lookup"><span data-stu-id="c668f-130">The Programa de Integração Social (PIS) contribution amount.</span></span>                             |
...
| <span data-ttu-id="c668f-138">%FiscalRef\_InvSeriesRef</span><span class="sxs-lookup"><span data-stu-id="c668f-138">%FiscalRef\_InvSeriesRef</span></span>        | <span data-ttu-id="c668f-139">A série da fatura de referência.</span><span class="sxs-lookup"><span data-stu-id="c668f-139">The series of the reference invoice.</span></span>                                                                                |
| <span data-ttu-id="c668f-140">%FiscalRef\_InvDateRef</span><span class="sxs-lookup"><span data-stu-id="c668f-140">%FiscalRef\_InvDateRef</span></span>          | <span data-ttu-id="c668f-141">A data da fatura de referência.</span><span class="sxs-lookup"><span data-stu-id="c668f-141">The date of the reference invoice.</span></span>                                                                                  |
| <span data-ttu-id="c668f-142">%FiscalRef\_InvAccNameRef</span><span class="sxs-lookup"><span data-stu-id="c668f-142">%FiscalRef\_InvAccNameRef</span></span>       | <span data-ttu-id="c668f-143">O nome da conta da fatura de referência.</span><span class="sxs-lookup"><span data-stu-id="c668f-143">The account name of the reference invoice.</span></span>                                                                          |
| <span data-ttu-id="c668f-144">%FiscalRef\_InvAccAddressRef</span><span class="sxs-lookup"><span data-stu-id="c668f-144">%FiscalRef\_InvAccAddressRef</span></span>    | <span data-ttu-id="c668f-145">O endereço da fatura de referência.</span><span class="sxs-lookup"><span data-stu-id="c668f-145">The address of the reference invoice.</span></span>                                                                               |
| <span data-ttu-id="c668f-146">%FiscalRef\_InvAccIENumberRef</span><span class="sxs-lookup"><span data-stu-id="c668f-146">%FiscalRef\_InvAccIENumberRef</span></span>   | <span data-ttu-id="c668f-147">A IE (Inscrição Estadual), ou número de inscrição do estado, da conta de fatura de referência.</span><span class="sxs-lookup"><span data-stu-id="c668f-147">The Inscrição Estadual (IE), or state registration number, of the reference invoice account.</span></span>                        |
...
| <span data-ttu-id="c668f-155">%Vendor\_CNPJ\_CPF</span><span class="sxs-lookup"><span data-stu-id="c668f-155">%Vendor\_CNPJ\_CPF</span></span> | <span data-ttu-id="c668f-156">O CNPJ (Cadastro Nacional da Pessoa Jurídica)/CPF (Cadastro de Pessoas Físicas), ou número de inscrição do contribuinte, do fornecedor.</span><span class="sxs-lookup"><span data-stu-id="c668f-156">The Cadastro Nacional da Pessoa Jurídica (CNPJ)/Cadastro de Pessoas Físicas (CPF), or taxpayer registration number, of the vendor.</span></span> |
| <span data-ttu-id="c668f-157">%Vendor\_IE</span><span class="sxs-lookup"><span data-stu-id="c668f-157">%Vendor\_IE</span></span>        | <span data-ttu-id="c668f-158">A IE do fornecedor.</span><span class="sxs-lookup"><span data-stu-id="c668f-158">The IE of the vendor.</span></span>                                                                                                              |
...
| <span data-ttu-id="c668f-166">%Customer\_CNPJ\_CPF</span><span class="sxs-lookup"><span data-stu-id="c668f-166">%Customer\_CNPJ\_CPF</span></span> | <span data-ttu-id="c668f-167">O CNPJ/CPF do cliente.</span><span class="sxs-lookup"><span data-stu-id="c668f-167">The CNPJ/CPF of the customer.</span></span> |
| <span data-ttu-id="c668f-168">%Vendor\_IE</span><span class="sxs-lookup"><span data-stu-id="c668f-168">%Vendor\_IE</span></span>          | <span data-ttu-id="c668f-169">A IE do cliente.</span><span class="sxs-lookup"><span data-stu-id="c668f-169">The IE of the customer.</span></span>       |
...
| <span data-ttu-id="c668f-177">%TaxWithhold\_Value</span><span class="sxs-lookup"><span data-stu-id="c668f-177">%TaxWithhold\_Value</span></span>  | <span data-ttu-id="c668f-178">A taxa de imposto retido na fonte.</span><span class="sxs-lookup"><span data-stu-id="c668f-178">The rate of withholding tax.</span></span>   |
...
| <span data-ttu-id="c668f-186">%DI\_Date</span><span class="sxs-lookup"><span data-stu-id="c668f-186">%DI\_Date</span></span>      | <span data-ttu-id="c668f-187">A data que o documento da declaração de importação foi emitido.</span><span class="sxs-lookup"><span data-stu-id="c668f-187">The date that the import declaration document was issued.</span></span>                |
| <span data-ttu-id="c668f-188">%ImportTax</span><span class="sxs-lookup"><span data-stu-id="c668f-188">%ImportTax</span></span>     | <span data-ttu-id="c668f-189">O valor do imposto sobre importação.</span><span class="sxs-lookup"><span data-stu-id="c668f-189">The import tax amount.</span></span>                                                   |
| <span data-ttu-id="c668f-190">%Freight</span><span class="sxs-lookup"><span data-stu-id="c668f-190">%Freight</span></span>       | <span data-ttu-id="c668f-191">O valor de frete para a importação.</span><span class="sxs-lookup"><span data-stu-id="c668f-191">The freight amount for the import.</span></span>                                       |
| <span data-ttu-id="c668f-192">%Insurance</span><span class="sxs-lookup"><span data-stu-id="c668f-192">%Insurance</span></span>     | <span data-ttu-id="c668f-193">O valor de seguro para a importação.</span><span class="sxs-lookup"><span data-stu-id="c668f-193">The insurance amount for the import.</span></span>                                     |
| <span data-ttu-id="c668f-194">%Siscomex</span><span class="sxs-lookup"><span data-stu-id="c668f-194">%Siscomex</span></span>      | <span data-ttu-id="c668f-195">O valor de encargo para Siscomex (Sistema Integrado de Comércio Exterior).</span><span class="sxs-lookup"><span data-stu-id="c668f-195">The charge amount for Sistema Integrado de Comércio Exterior (Siscomex).</span></span> |
...
| <span data-ttu-id="c668f-203">%DifICMS\_pICMSUFDest</span><span class="sxs-lookup"><span data-stu-id="c668f-203">%DifICMS\_pICMSUFDest</span></span>    | <span data-ttu-id="c668f-204">Valor do imposto do estado federal do destinatário.</span><span class="sxs-lookup"><span data-stu-id="c668f-204">Tax value for recipient federal state.</span></span>                                         |
| <span data-ttu-id="c668f-205">%DifICMS\_pICMSInter</span><span class="sxs-lookup"><span data-stu-id="c668f-205">%DifICMS\_pICMSInter</span></span>     | <span data-ttu-id="c668f-206">Valor do imposto para a transação interestadual.</span><span class="sxs-lookup"><span data-stu-id="c668f-206">Tax value for interstate transaction.</span></span>                                          |
| <span data-ttu-id="c668f-207">%DifICMS\_pICMSInterPart</span><span class="sxs-lookup"><span data-stu-id="c668f-207">%DifICMS\_pICMSInterPart</span></span> | <span data-ttu-id="c668f-208">Porcentagem definida para estado federal do destinatário (baseado no ano fiscal do documento).</span><span class="sxs-lookup"><span data-stu-id="c668f-208">Percentage defined to recipient federal state (based on fiscal document year).</span></span> |
| <span data-ttu-id="c668f-209">%DifICMS\_vICMSUFDest</span><span class="sxs-lookup"><span data-stu-id="c668f-209">%DifICMS\_vICMSUFDest</span></span>    | <span data-ttu-id="c668f-210">Valor do imposto do estado do destinatário.</span><span class="sxs-lookup"><span data-stu-id="c668f-210">Tax amount for recipient state.</span></span>                                                |
| <span data-ttu-id="c668f-211">%DifICMS\_vICMSUFRemet</span><span class="sxs-lookup"><span data-stu-id="c668f-211">%DifICMS\_vICMSUFRemet</span></span>   | <span data-ttu-id="c668f-212">Valor do imposto no estado de emissor.</span><span class="sxs-lookup"><span data-stu-id="c668f-212">Tax amount for issuer state.</span></span>                                                   |
