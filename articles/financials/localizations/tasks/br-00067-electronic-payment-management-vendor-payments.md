...
1. <span data-ttu-id="36f05-110">Vá para Razão de compra > Pagamentos > Transferências de pagamento.</span><span class="sxs-lookup"><span data-stu-id="36f05-110">Go to Purchase ledger > Payments > Payment transfers.</span></span>
2. <span data-ttu-id="36f05-111">Na lista, marque a linha selecionada.</span><span class="sxs-lookup"><span data-stu-id="36f05-111">In the list, mark the selected row.</span></span>
3. <span data-ttu-id="36f05-112">Clique em Arquivo retorno - Fornecedor.</span><span class="sxs-lookup"><span data-stu-id="36f05-112">Click Return file - vendor.</span></span>
4. <span data-ttu-id="36f05-113">No campo Condições de pagamento, insira ou selecione um valor.</span><span class="sxs-lookup"><span data-stu-id="36f05-113">In the Method of payment field, enter or select a value.</span></span>
5. <span data-ttu-id="36f05-114">Clique em OK.</span><span class="sxs-lookup"><span data-stu-id="36f05-114">Click OK.</span></span>
6. <span data-ttu-id="36f05-115">Clique em OK.</span><span class="sxs-lookup"><span data-stu-id="36f05-115">Click OK.</span></span>
    * <span data-ttu-id="36f05-116">O status dos pagamentos é atualizado no campo Status de pagamento na página Transferências de pagamento.</span><span class="sxs-lookup"><span data-stu-id="36f05-116">The status of the payments is updated in the Payments status field on the Payment transfers page.</span></span> <span data-ttu-id="36f05-117">O novo status se baseia no status do pagamento no arquivo de devolução.</span><span class="sxs-lookup"><span data-stu-id="36f05-117">The new status is based on the status of the payment in the return file.</span></span>  
7. <span data-ttu-id="36f05-118">Clique em Lançar.</span><span class="sxs-lookup"><span data-stu-id="36f05-118">Click Post.</span></span>
8. <span data-ttu-id="36f05-119">No campo Nome do novo diário, digite um valor.</span><span class="sxs-lookup"><span data-stu-id="36f05-119">In the New journal name field, type a value.</span></span>
9. <span data-ttu-id="36f05-120">Clique em OK.</span><span class="sxs-lookup"><span data-stu-id="36f05-120">Click OK.</span></span>
10. <span data-ttu-id="36f05-121">Feche a página.</span><span class="sxs-lookup"><span data-stu-id="36f05-121">Close the page.</span></span>
