...
5. Clique em Preço.
6. Expanda a seção Cabeçalho de fatura complementar.
7. No campo Modelo do documento, insira ou selecione um valor.
8. No campo Chave de acesso, digite um valor.
    * Insira a chave de acesso da nota fiscal eletrônica (NF-e).     
9. Na lista, marque a linha selecionada.
10. No campo Valor de linha corrigido, insira um número.
    * Insira o valor de linha corrigido na moeda da transação. A diferença entre o valor no campo Valor de linha corrigido e o valor no campo Valor de linha original é atualizado no campo Valor líquido.  
11. Clique em Salvar.
12. Clique em Lançar.
13. Feche a página.
14. Feche a página.
