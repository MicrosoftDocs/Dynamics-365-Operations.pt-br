...
1. <span data-ttu-id="f335c-110">Vá para Contas a pagar > Notas fiscais > Todas as notas fiscais de compra complementares.</span><span class="sxs-lookup"><span data-stu-id="f335c-110">Go to Accounts payable > Fiscal documents > All purchase complementary fiscal documents.</span></span>
2. <span data-ttu-id="f335c-111">Na lista, localize e selecione o PDV desejado.</span><span class="sxs-lookup"><span data-stu-id="f335c-111">In the list, find and select the desired record.</span></span>
3. <span data-ttu-id="f335c-112">Na lista, clique no link na linha selecionada.</span><span class="sxs-lookup"><span data-stu-id="f335c-112">In the list, click the link in the selected row.</span></span>
4. <span data-ttu-id="f335c-113">Clique em Cancelar nota fiscal para abrir a caixa de diálogo suspensa.</span><span class="sxs-lookup"><span data-stu-id="f335c-113">Click Cancel fiscal document to open the drop dialog.</span></span>
5. <span data-ttu-id="f335c-114">No campo Código de motivo, insira ou selecione um valor.</span><span class="sxs-lookup"><span data-stu-id="f335c-114">In the Reason code field, enter or select a value.</span></span>
6. <span data-ttu-id="f335c-115">Clique em Criar fatura corrigida.</span><span class="sxs-lookup"><span data-stu-id="f335c-115">Click Create corrected invoice.</span></span>
    * <span data-ttu-id="f335c-116">Uma nota fiscal complementar de compra negativa é criada.</span><span class="sxs-lookup"><span data-stu-id="f335c-116">A negative purchase complementary fiscal document is created.</span></span>  
7. <span data-ttu-id="f335c-117">Clique em Lançar.</span><span class="sxs-lookup"><span data-stu-id="f335c-117">Click Post.</span></span>
8. <span data-ttu-id="f335c-118">Feche a página.</span><span class="sxs-lookup"><span data-stu-id="f335c-118">Close the page.</span></span>
9. <span data-ttu-id="f335c-119">Feche a página.</span><span class="sxs-lookup"><span data-stu-id="f335c-119">Close the page.</span></span>
