...
A tabela a seguir lista os tipos de registros suportados no Finance and Operations. Se estiver familiarizado com os campos de IDs de registro do Microsoft Dynamics AX 2012, esta tabela também mapeia esses campos para as categorias de registro do Finance and Operations.

| Categoria de registro do Finance and Operations         |País/Região  | Termo/campo do Dynamics AX 2012|
|---------------------------------------------------------------|---------------------|---------------------------------|
