...
-   Lucros e perdas, Receita e Despesa – essas contas principais são usadas como contas de lançamento. As contas de Lucros e perdas são usadas para registrar receitas e despesas. A soma de todas as contas de lucros e perdas, de receita e de despesa determina os resultados de fim de ano. As contas principais de Receita e de Despesa têm a mesma função das contas principais de Lucros e perdas.
...
Para saber mais, consulte [Configurar categorias da conta principal](tasks/set-up-main-account-categories.md).
