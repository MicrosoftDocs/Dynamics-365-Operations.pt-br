...
---
# <a name="manage-retail-product-categories-and-products"></a>Gerenciar produtos e categorias de produtos do varejo

[!include [banner](./includes/banner.md)]

Este tópico descreve um modo avançado de gerenciar categorias de produtos e produtos no Dynamics 365 Retail. Os aprimoramentos permitem que os gerentes de mercadoria visualizem uma estrutura de propriedades de produtos que é compartilhada entre a hierarquia de produtos e os detalhes de produtos liberados.

Para saber mais sobre como gerenciar categorias de produtos, no espaço de trabalho **Gerenciamento de categorias e produtos**, selecione o bloco **Hierarquia de produtos de varejo** .
