...
<span data-ttu-id="e223d-105">A análise RFM (recency, frequência e monetária) é uma ferramenta de marketing que a organização pode usar para avaliar os dados gerados pelas compras dos clientes.</span><span class="sxs-lookup"><span data-stu-id="e223d-105">Recency, frequency, and monetary (RFM) analysis is a marketing tool that your organization can use to evaluate the data that is generated by customer purchases.</span></span> <span data-ttu-id="e223d-106">Depois de configurar a análise RFM, os clientes são atribuídos a uma contagem de RFM calculada quando eles fazem compras.</span><span class="sxs-lookup"><span data-stu-id="e223d-106">After you set up RFM analysis, customers are assigned a calculated RFM score as they make purchases.</span></span> <span data-ttu-id="e223d-107">A contagem de RFM pode ser uma previsão de três dígitos ou um número agregado, dependendo de como sua organização configurou a análise RFM.</span><span class="sxs-lookup"><span data-stu-id="e223d-107">The RFM score can be a three-digit rating or an aggregate number, depending on how your organization has configured RFM analysis.</span></span> <span data-ttu-id="e223d-108">Veja como a classificação funciona, se a organização usar uma classificação de três dígitos para contagem:</span><span class="sxs-lookup"><span data-stu-id="e223d-108">Here’s how the rating works if your organization uses a three-digit rating for the score:</span></span>

- <span data-ttu-id="e223d-109">O primeiro dígito é a classificação de recency do cliente, que é como o cliente fez uma compra recentemente na sua organização.</span><span class="sxs-lookup"><span data-stu-id="e223d-109">The first digit is the customer's recency rating, which is how recently the customer made a purchase from your organization.</span></span> 
- <span data-ttu-id="e223d-110">O segundo dígito é a classificação de frequência do cliente, que é a frequência em que o cliente faz compras na sua organização.</span><span class="sxs-lookup"><span data-stu-id="e223d-110">The second digit is the customer's frequency rating, which is how often the customer makes purchases from your organization.</span></span> 
- <span data-ttu-id="e223d-111">O terceiro dígito é uma classificação monetária do cliente, que é quanto o cliente gasta quando faz compras na sua organização.</span><span class="sxs-lookup"><span data-stu-id="e223d-111">The third digit is the customer's monetary rating, which is how much the customer spends when he makes purchases from your organization.</span></span> 

<span data-ttu-id="e223d-112">Por exemplo, a organização definiu as classificações em uma escala de 1 a 5, em que 5 representa a classificação mais alta.</span><span class="sxs-lookup"><span data-stu-id="e223d-112">For example, your organization has set the ratings on a scale of 1 through 5, where 5 is the highest rating.</span></span> <span data-ttu-id="e223d-113">Nesse caso, a classificação 535 fornece a você as seguintes informações sobre o cliente:</span><span class="sxs-lookup"><span data-stu-id="e223d-113">In this case, a customer rating of 535 tells you the following information about the customer:</span></span>

-   <span data-ttu-id="e223d-114">**Classificação de recency 5** – O cliente fez uma compra recentemente.</span><span class="sxs-lookup"><span data-stu-id="e223d-114">**Recency rating of 5** – The customer recently made a purchase.</span></span>
-   <span data-ttu-id="e223d-115">**Classificação de frequência 3** – O cliente compra produtos da sua organização com frequência moderada.</span><span class="sxs-lookup"><span data-stu-id="e223d-115">**Frequency rating of 3** – The customer purchases products from your organization moderately often.</span></span>
-   <span data-ttu-id="e223d-116">**Classificação monetária 5** – Quando o cliente faz uma compra, ele gasta um montante significativo.</span><span class="sxs-lookup"><span data-stu-id="e223d-116">**Monetary rating of 5** – When the customer makes a purchase, he spends a significant amount of money.</span></span>

<span data-ttu-id="e223d-117">Se sua organização usar um número agregado para a pontuação, as classificações individuais serão adicionadas juntas.</span><span class="sxs-lookup"><span data-stu-id="e223d-117">If your organization uses an aggregate number for the score, the individual ratings are added together.</span></span> <span data-ttu-id="e223d-118">No mesmo exemplo, o cliente obtém a classificação 13 (5 + 3 + 5).</span><span class="sxs-lookup"><span data-stu-id="e223d-118">For the same example, the customer has a rating of 13 (5 + 3 + 5).</span></span>

## <a name="to-set-up-rfm-analysis-for-the-customers-in-your-organization"></a><span data-ttu-id="e223d-119">Para configurar a análise de RFM para clientes de sua organização.</span><span class="sxs-lookup"><span data-stu-id="e223d-119">To set up RFM analysis for the customers in your organization.</span></span>

1.  <span data-ttu-id="e223d-120">Vá para **Call center** > **Periódico** > **Análise de RFM**.</span><span class="sxs-lookup"><span data-stu-id="e223d-120">Go to **Call center** > **Periodic** > **RFM analysis**.</span></span>

2.  <span data-ttu-id="e223d-121">Na página **Análise de RFM**, selecione **Novo**.</span><span class="sxs-lookup"><span data-stu-id="e223d-121">On **RFM analysis** page, select **New**.</span></span> <span data-ttu-id="e223d-122">No campo **Definição de RFM**, insira um nome para a definição de RFM.</span><span class="sxs-lookup"><span data-stu-id="e223d-122">In the **RFM definition** field, enter a name for the RFM definition.</span></span> <span data-ttu-id="e223d-123">Por exemplo, seria possível chamar a definição de RFM-A.</span><span class="sxs-lookup"><span data-stu-id="e223d-123">For example, you could call the definition RFM-A.</span></span>

3.  <span data-ttu-id="e223d-124">Insira uma data inicial e uma data final para a definição de RFM.</span><span class="sxs-lookup"><span data-stu-id="e223d-124">Enter a start date and end date for this RFM definition.</span></span>

4.  <span data-ttu-id="e223d-125">Na Guia Rápida **Geral**, faça o seguinte:</span><span class="sxs-lookup"><span data-stu-id="e223d-125">On the **General** FastTab, do the following:</span></span> 
...
1.  <span data-ttu-id="e223d-156">Vá para **Call center** > **Diários** > **Atendimento ao cliente**.</span><span class="sxs-lookup"><span data-stu-id="e223d-156">Go to **Call center** > **Journals** > **Customer service**.</span></span> 

2.  <span data-ttu-id="e223d-157">Na página **Atendimento ao cliente**, no painel **Atendimento ao cliente**, nos campos de pesquisa, selecione o tipo de palavra-chave a ser pesquisado e digite o texto da pesquisa.</span><span class="sxs-lookup"><span data-stu-id="e223d-157">On the **Customer service** page, in the **Customer service** pane, in the search fields, select the keyword type to search on and enter the search text.</span></span>

3.  <span data-ttu-id="e223d-158">Selecione **Pesquisar**.</span><span class="sxs-lookup"><span data-stu-id="e223d-158">Select **Search**.</span></span>

4.  <span data-ttu-id="e223d-159">Na **Pesquisa de cliente**, selecione o registro do cliente que você deseja, e clique em **Selecionar cliente**.</span><span class="sxs-lookup"><span data-stu-id="e223d-159">On the **Customer search** page, select the customer record that you want, and then click **Select customer**.</span></span> 

<span data-ttu-id="e223d-160">A contagem de RFM é exibida no grupo **Histórico da ordem** no lado direito da página **Atendimento ao cliente**.</span><span class="sxs-lookup"><span data-stu-id="e223d-160">The RFM score is displayed in the **Order history** group on the right side of the **Customer service** page.</span></span> 

## <a name="view-or-clear-the-history-of-an-rfm-analysis-record"></a><span data-ttu-id="e223d-161">Exibir ou limpar o histórico de um registro de análise de RFM</span><span class="sxs-lookup"><span data-stu-id="e223d-161">View or clear the history of an RFM analysis record</span></span>
<span data-ttu-id="e223d-162">Use este procedimento para exibir ou apagar o histórico de um registro de análise de RFM.</span><span class="sxs-lookup"><span data-stu-id="e223d-162">Use this procedure to view or clear the history of an RFM analysis record.</span></span> 

1.  <span data-ttu-id="e223d-163">Vá para **Call center** > **Periódico** > **Análise de RFM**.</span><span class="sxs-lookup"><span data-stu-id="e223d-163">Go to **Call center** > **Periodic** > **RFM analysis**.</span></span>

2.  <span data-ttu-id="e223d-164">Na página **Análise de RFM**, selecione o registro que deseja exibir.</span><span class="sxs-lookup"><span data-stu-id="e223d-164">On the **RFM analysis** page, select the record that you want to view.</span></span>

3.  <span data-ttu-id="e223d-165">Para exibir o histórico de registro, selecione a Guia Rápida **Histórico**.</span><span class="sxs-lookup"><span data-stu-id="e223d-165">To view the record history, select the **History** FastTab.</span></span>

4.  <span data-ttu-id="e223d-166">Para limpar o histórico do registro, selecione **Limpar histórico**.</span><span class="sxs-lookup"><span data-stu-id="e223d-166">To clear the history of the record, select **Clear history**.</span></span>
