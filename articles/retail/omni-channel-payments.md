...
Este tópico fornece uma visão geral de pagamentos de omni-channel no Microsoft Dynamics 365 for Retail. Ele inclui uma lista abrangente de cenários com suporte, informações sobre funcionalidade, configuração e solução de problemas e descrições de alguns problemas típicos.
...
- **Configuração de pagamentos de omni-channel:** no back office, vá para **Varejo \> Configuração da sede \> Parâmetros \> Parâmetros compartilhados de varejo**. Depois, na guia **Pagamentos de omni-channel**, define a opção **Usar pagamentos de omni-channel** como **Sim**.
...
- A opção **Pagamentos de omni-channel** na página **Parâmetros compartilhados de varejo** é definida como **Verdadeiro**.
...
3. No Retail, use o trabalho em lotes **Sincronizar ordens** e a agenda de distribuição **P-001** para criar as ordens no back office.
...
1. No Retail, na página **Serviço de atendimento ao consumidor**, insira **Karen Berg** na barra de pesquisa e depois selecione **Pesquisar**. 
