...
Este artigo fornece exemplos de contratos de projeto que você pode criar para vários tipos de projetos e de fontes de financiamento, e como você pode gerenciar contratos e clientes do projeto de fatura.
...
No Dynamics 365 Finance, você pode dividir a cobrança de uma única transação ou um projeto inteiro entre vários clientes, concessões, ou organizações. 
