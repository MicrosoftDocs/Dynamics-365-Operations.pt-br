---
title: Configurar preços baseados em função
...
ms.locfileid: "3760477"
---
# <a name="set-up-role-based-pricing"></a>Configurar preços baseados em função

[!include [banner](../includes/banner.md)]

Todos os preços de custo, de venda e de transferência podem ser configurados para funções. Conclua as seguintes etapas para associar os preços a uma função específica.
