...
---
# <a name="project-forecasts-and-budgets"></a>Previsões e orçamentos do projeto

[!include [banner](../includes/banner.md)]

Há duas maneiras de gerenciar e controlar seus projetos: previsões e orçamentos de projeto. 
