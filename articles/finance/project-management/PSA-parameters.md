...
Para abrir a página **Parâmetros de integração do Project Service Automation**, acesse os parâmetros de integração **Gerenciamento e contabilidade do projeto** \> **Configurações** \> **Dynamics 365 for Project Service Automation**. 
