---
title: Catálogo de aprendizagem do Dynamics 365 Finance
description: Encontre todas as opções de treinamento do Dynamics 365 Finance.
author: margoc
ms.topic: article
ms.date: 07/23/2020
ms.author: margoc
...
ms.locfileid: "8903060"
---
# <a name="dynamics-365-finance-learning-catalog"></a>Catálogo de aprendizagem do Dynamics 365 Finance

Encontre o treinamento online correto, nos workshops de pessoas e eventos para sua função como um usuário do aplicativo do Dynamics 365 Finance.
...
<!-- ![Universal Windows Platform (UWP).](images/platform-uwp.png)  -->  
    ...
    [Iniciado](learning-catalog-bdm.md#get-started)

    [Exame](learning-catalog-bdm.md#exam)
    ...
    [Exame](learning-catalog-business-user.md#exam)
...
:::row:::
    ...
    [Iniciado](learning-catalog-project-manager.md#get-started)
    ...
    [Exames](learning-catalog-project-manager.md#exams)
...
:::row:::
    ...
    [Manutenção](learning-catalog-developer.md#servicing)

    [Migração e upgrade](learning-catalog-developer.md#migration-and-upgrade)

    [Testando](learning-catalog-developer.md#testing)

    [Exame](learning-catalog-developer.md#exam)
    ...
    [Iniciado](learning-catalog-functional-consultant.md#get-started)
    ...
    [Exame](learning-catalog-functional-consultant.md#exam)
...
:::row:::
    ...
    [Iniciado](learning-catalog-partner-sales.md#get-started)

    [Exame](learning-catalog-partner-sales.md#exam)
    ...
    [Exame](learning-catalog-solution-architect.md#exam)
