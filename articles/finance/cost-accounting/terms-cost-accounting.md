---
title: Terminologia de Contabilização de custos
description: Este artigo define os principais termos usados na Contabilização de custos.
author: aprilolson
ms.date: 08/31/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8881923"
---
# <a name="cost-accounting-terminology"></a>Terminologia de Contabilização de custos

[!include [banner](../includes/banner.md)]

Este artigo define os principais termos usados na Contabilização de custos.
