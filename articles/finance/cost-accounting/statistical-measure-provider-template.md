...
description: Este artigo fornece informações sobre membros da dimensão estatística e modelos de provedores de medidas estatísticas.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
As medidas estatísticas podem ser originárias de vários tipos de fontes. O Dynamics 365 Finance é uma grande fonte de extração de estatísticas de medição. Você pode usar um modelo de provador de medidas estatísticas para configurar facilmente as medidas estatísticas que deseja extrair.
...
|-------------|------------------------------------------------------------------------------------|------------------------------|
| FTEs D365FO | Dynamics 365 Finance - Medidas estatísticas | FTEs                         |
...
| Nome           | Conector de dados                                                                     | Membro de dimensão estatística |
|----------------|------------------------------------------------------------------------------------|------------------------------|
| Pacote CC D365FO | Dynamics 365 Finance - Medidas estatísticas | Pacote CC                      |
