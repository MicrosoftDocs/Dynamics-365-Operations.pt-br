...
-   <span data-ttu-id="9d9a2-109">Aluguel</span><span class="sxs-lookup"><span data-stu-id="9d9a2-109">Rent</span></span>
...
<span data-ttu-id="9d9a2-131">[![Cálculo de custos gerais indiretos](./media/period-cost-calculation.png)](./media/period-cost-calculation.png)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-131">[![Overhead calculation](./media/period-cost-calculation.png)](./media/period-cost-calculation.png)</span></span>
...
### <a name="step-1-process-the-cost-behavior-calculation"></a><span data-ttu-id="9d9a2-148">Etapa 1: Processar o cálculo do comportamento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-148">Step 1: Process the cost behavior calculation</span></span>
...
<td><span data-ttu-id="9d9a2-166">fiscal</span><span class="sxs-lookup"><span data-stu-id="9d9a2-166">Fiscal</span></span></td>
...
##### <a name="cost-entries"></a><span data-ttu-id="9d9a2-183">Entradas de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-183">Cost entries</span></span>
...
<td><span data-ttu-id="9d9a2-208">1.000,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-208">1,000.00</span></span></td>
...
<span data-ttu-id="9d9a2-239">A tabela a seguir mostra o resultado quando o consumo de eletricidade é aplicado como uma base de alocação para custos variáveis.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-239">The following table shows the result when electricity consumption is applied as an allocation base for variable costs.</span></span>
...
<td><span data-ttu-id="9d9a2-282">(0 ÷ 2) × 1.000,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-282">(0 ÷ 2) × 1,000.00</span></span></td>
...
<td><span data-ttu-id="9d9a2-324">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-324">Electricity</span></span></td>
...
<td><span data-ttu-id="9d9a2-352">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-352">Electricity</span></span></td>
...
<td><span data-ttu-id="9d9a2-388">1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-388">1</span></span></td>
...
##### <a name="journal"></a><span data-ttu-id="9d9a2-408">Diário</span><span class="sxs-lookup"><span data-stu-id="9d9a2-408">Journal</span></span>
...
<td><span data-ttu-id="9d9a2-450">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-450">January 31, 2017</span></span></td>
</tr>
<tr>
...
<th><span data-ttu-id="9d9a2-527">Comportamento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-527">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="9d9a2-528">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-528">CC002</span></span></td>
<td><span data-ttu-id="9d9a2-529">Finanças</span><span class="sxs-lookup"><span data-stu-id="9d9a2-529">Finance</span></span></td>
<td><span data-ttu-id="9d9a2-530">35</span><span class="sxs-lookup"><span data-stu-id="9d9a2-530">35</span></span></td>
<td><span data-ttu-id="9d9a2-531">(35 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-531">(35 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="9d9a2-532">175.00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-532">175.00</span></span></td>
<td><span data-ttu-id="9d9a2-533">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-533">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-534">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-534">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-535">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-535">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-536">55</span><span class="sxs-lookup"><span data-stu-id="9d9a2-536">55</span></span></td>
<td><span data-ttu-id="9d9a2-537">(55 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-537">(55 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="9d9a2-538">275.00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-538">275.00</span></span></td>
<td><span data-ttu-id="9d9a2-539">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-539">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-540">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-540">CC004</span></span></td>
<td><span data-ttu-id="9d9a2-541">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-541">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-542">10</span><span class="sxs-lookup"><span data-stu-id="9d9a2-542">10</span></span></td>
<td><span data-ttu-id="9d9a2-543">(10 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-543">(10 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="9d9a2-544">50,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-544">50.00</span></span></td>
<td><span data-ttu-id="9d9a2-545">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-545">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-546">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-546">CC002</span></span></td>
<td><span data-ttu-id="9d9a2-547">Finanças</span><span class="sxs-lookup"><span data-stu-id="9d9a2-547">Finance</span></span></td>
<td><span data-ttu-id="9d9a2-548">35</span><span class="sxs-lookup"><span data-stu-id="9d9a2-548">35</span></span></td>
<td><span data-ttu-id="9d9a2-549">(35 ÷ 100) × 1.245,71</span><span class="sxs-lookup"><span data-stu-id="9d9a2-549">(35 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="9d9a2-550">436.00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-550">436.00</span></span></td>
<td><span data-ttu-id="9d9a2-551">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-551">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-552">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-552">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-553">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-553">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-554">55</span><span class="sxs-lookup"><span data-stu-id="9d9a2-554">55</span></span></td>
<td><span data-ttu-id="9d9a2-555">(55 ÷ 100) × 1.245,71</span><span class="sxs-lookup"><span data-stu-id="9d9a2-555">(55 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="9d9a2-556">685.14</span><span class="sxs-lookup"><span data-stu-id="9d9a2-556">685.14</span></span></td>
<td><span data-ttu-id="9d9a2-557">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-557">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-558">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-558">CC004</span></span></td>
<td><span data-ttu-id="9d9a2-559">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-559">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-560">10</span><span class="sxs-lookup"><span data-stu-id="9d9a2-560">10</span></span></td>
<td><span data-ttu-id="9d9a2-561">(10 ÷ 100) × 1.245,71</span><span class="sxs-lookup"><span data-stu-id="9d9a2-561">(10 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="9d9a2-562">124.57</span><span class="sxs-lookup"><span data-stu-id="9d9a2-562">124.57</span></span></td>
<td><span data-ttu-id="9d9a2-563">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-563">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="9d9a2-564">A tabela a seguir mostra o resultado quando os serviços financeiros são aplicados como base de alocação de custos total (custos fixos e custos variáveis.)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-564">The following table shows the result when the Finance services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="9d9a2-565">Objeto de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-565">Cost object</span></span></th>
<th><span data-ttu-id="9d9a2-566">Magnitude</span><span class="sxs-lookup"><span data-stu-id="9d9a2-566">Magnitude</span></span></th>
<th><span data-ttu-id="9d9a2-567">Fator de alocação</span><span class="sxs-lookup"><span data-stu-id="9d9a2-567">Allocation factor</span></span></th>
<th><span data-ttu-id="9d9a2-568">Valor</span><span class="sxs-lookup"><span data-stu-id="9d9a2-568">Amount</span></span></th>
<th><span data-ttu-id="9d9a2-569">Comportamento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-569">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="9d9a2-570">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-570">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-571">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-571">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-572">65</span><span class="sxs-lookup"><span data-stu-id="9d9a2-572">65</span></span></td>
<td><span data-ttu-id="9d9a2-573">(65 ÷ 100) × (500,00 + 175,00)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-573">(65 ÷ 100) × (500.00 + 175.00)</span></span></td>
<td><span data-ttu-id="9d9a2-574">438.75</span><span class="sxs-lookup"><span data-stu-id="9d9a2-574">438.75</span></span></td>
<td><span data-ttu-id="9d9a2-575">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-575">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-576">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-576">CC004</span></span></td>
<td><span data-ttu-id="9d9a2-577">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-577">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-578">35</span><span class="sxs-lookup"><span data-stu-id="9d9a2-578">35</span></span></td>
<td><span data-ttu-id="9d9a2-579">(35 ÷ 100) × (500,00 + 175,00)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-579">(35 ÷ 100) × (500.00 + 175.00)</span></span></td>
<td><span data-ttu-id="9d9a2-580">236.25</span><span class="sxs-lookup"><span data-stu-id="9d9a2-580">236.25</span></span></td>
<td><span data-ttu-id="9d9a2-581">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-581">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-582">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-582">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-583">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-583">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-584">65</span><span class="sxs-lookup"><span data-stu-id="9d9a2-584">65</span></span></td>
<td><span data-ttu-id="9d9a2-585">(65 ÷ 100) × (7.714,29 + 436,00)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-585">(65 ÷ 100) × (7,714.29 + 436.00)</span></span></td>
<td><span data-ttu-id="9d9a2-586">5,297.69</span><span class="sxs-lookup"><span data-stu-id="9d9a2-586">5,297.69</span></span></td>
<td><span data-ttu-id="9d9a2-587">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-587">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-588">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-588">CC004</span></span></td>
<td><span data-ttu-id="9d9a2-589">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-589">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-590">35</span><span class="sxs-lookup"><span data-stu-id="9d9a2-590">35</span></span></td>
<td><span data-ttu-id="9d9a2-591">(35 ÷ 100) × (7.714,29 + 436,00)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-591">(35 ÷ 100) × (7,714.29 + 436.00)</span></span></td>
<td><span data-ttu-id="9d9a2-592">2,852.60</span><span class="sxs-lookup"><span data-stu-id="9d9a2-592">2,852.60</span></span></td>
<td><span data-ttu-id="9d9a2-593">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-593">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="9d9a2-594">A tabela a seguir mostra o resultado quando os serviços de Montagem são aplicados como uma base de alocação de custos total (custos fixos e custos variáveis.)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-594">The following table shows the result when the Assembly services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="9d9a2-595">Objeto de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-595">Cost object</span></span></th>
<th><span data-ttu-id="9d9a2-596">Magnitude</span><span class="sxs-lookup"><span data-stu-id="9d9a2-596">Magnitude</span></span></th>
<th><span data-ttu-id="9d9a2-597">Fator de alocação</span><span class="sxs-lookup"><span data-stu-id="9d9a2-597">Allocation factor</span></span></th>
<th><span data-ttu-id="9d9a2-598">Valor</span><span class="sxs-lookup"><span data-stu-id="9d9a2-598">Amount</span></span></th>
<th><span data-ttu-id="9d9a2-599">Comportamento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-599">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="9d9a2-600">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-600">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-601">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-601">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-602">60</span><span class="sxs-lookup"><span data-stu-id="9d9a2-602">60</span></span></td>
<td><span data-ttu-id="9d9a2-603">(60 ÷ 80) × (275,00 + 438,75)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-603">(60 ÷ 80) × (275.00 + 438.75)</span></span></td>
<td><span data-ttu-id="9d9a2-604">535.31</span><span class="sxs-lookup"><span data-stu-id="9d9a2-604">535.31</span></span></td>
<td><span data-ttu-id="9d9a2-605">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-605">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-606">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-606">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-607">Produto 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-607">Product 2</span></span></td>
<td><span data-ttu-id="9d9a2-608">20</span><span class="sxs-lookup"><span data-stu-id="9d9a2-608">20</span></span></td>
<td><span data-ttu-id="9d9a2-609">(20 ÷ 80) × (275,00 + 438,75)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-609">(20 ÷ 80) × (275.00 + 438.75)</span></span></td>
<td><span data-ttu-id="9d9a2-610">178.44</span><span class="sxs-lookup"><span data-stu-id="9d9a2-610">178.44</span></span></td>
<td><span data-ttu-id="9d9a2-611">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-611">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-612">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-612">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-613">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-613">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-614">60</span><span class="sxs-lookup"><span data-stu-id="9d9a2-614">60</span></span></td>
<td><span data-ttu-id="9d9a2-615">(60 ÷ 80) × (5.297,69 + 685,14)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-615">(60 ÷ 80) × (5,297.69 + 685.14)</span></span></td>
<td><span data-ttu-id="9d9a2-616">4,487.12</span><span class="sxs-lookup"><span data-stu-id="9d9a2-616">4,487.12</span></span></td>
<td><span data-ttu-id="9d9a2-617">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-617">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-618">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-618">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-619">Produto 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-619">Product 2</span></span></td>
<td><span data-ttu-id="9d9a2-620">20</span><span class="sxs-lookup"><span data-stu-id="9d9a2-620">20</span></span></td>
<td><span data-ttu-id="9d9a2-621">(20 ÷ 80) × (5.297,69 + 685,14)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-621">(20 ÷ 80) × (5,297.69 + 685.14)</span></span></td>
<td><span data-ttu-id="9d9a2-622">1,495.71</span><span class="sxs-lookup"><span data-stu-id="9d9a2-622">1,495.71</span></span></td>
<td><span data-ttu-id="9d9a2-623">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-623">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="9d9a2-624">A tabela a seguir mostra o resultado quando os serviços de Embalagem são aplicados como uma base de alocação de custos total (custos fixos e custos variáveis.)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-624">The following table shows the result when the Packaging services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="9d9a2-625">Objeto de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-625">Cost object</span></span></th>
<th><span data-ttu-id="9d9a2-626">Magnitude</span><span class="sxs-lookup"><span data-stu-id="9d9a2-626">Magnitude</span></span></th>
<th><span data-ttu-id="9d9a2-627">Fator de alocação</span><span class="sxs-lookup"><span data-stu-id="9d9a2-627">Allocation factor</span></span></th>
<th><span data-ttu-id="9d9a2-628">Valor</span><span class="sxs-lookup"><span data-stu-id="9d9a2-628">Amount</span></span></th>
<th><span data-ttu-id="9d9a2-629">Comportamento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-629">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="9d9a2-630">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-630">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-631">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-631">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-632">80</span><span class="sxs-lookup"><span data-stu-id="9d9a2-632">80</span></span></td>
<td><span data-ttu-id="9d9a2-633">(80 ÷ 95) × (50,00 + 236,25)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-633">(80 ÷ 95) × (50.00 + 236.25)</span></span></td>
<td><span data-ttu-id="9d9a2-634">241.05</span><span class="sxs-lookup"><span data-stu-id="9d9a2-634">241.05</span></span></td>
<td><span data-ttu-id="9d9a2-635">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-635">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-636">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-636">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-637">Produto 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-637">Product 2</span></span></td>
<td><span data-ttu-id="9d9a2-638">15</span><span class="sxs-lookup"><span data-stu-id="9d9a2-638">15</span></span></td>
<td><span data-ttu-id="9d9a2-639">(15 ÷ 95) × (50,00 + 236,25)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-639">(15 ÷ 95) × (50.00 + 236.25)</span></span></td>
<td><span data-ttu-id="9d9a2-640">45.20</span><span class="sxs-lookup"><span data-stu-id="9d9a2-640">45.20</span></span></td>
<td><span data-ttu-id="9d9a2-641">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-641">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-642">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-642">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-643">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-643">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-644">80</span><span class="sxs-lookup"><span data-stu-id="9d9a2-644">80</span></span></td>
<td><span data-ttu-id="9d9a2-645">(80 ÷ 95) × (2.852,60 + 124,57)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-645">(80 ÷ 95) × (2,852.60 + 124.57)</span></span></td>
<td><span data-ttu-id="9d9a2-646">2,507.09</span><span class="sxs-lookup"><span data-stu-id="9d9a2-646">2,507.09</span></span></td>
<td><span data-ttu-id="9d9a2-647">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-647">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-648">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-648">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-649">Produto 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-649">Product 2</span></span></td>
<td><span data-ttu-id="9d9a2-650">15</span><span class="sxs-lookup"><span data-stu-id="9d9a2-650">15</span></span></td>
<td><span data-ttu-id="9d9a2-651">(15 ÷ 95) × (2.852,60 + 124,57)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-651">(15 ÷ 95) × (2,852.60 + 124.57)</span></span></td>
<td><span data-ttu-id="9d9a2-652">470.08</span><span class="sxs-lookup"><span data-stu-id="9d9a2-652">470.08</span></span></td>
<td><span data-ttu-id="9d9a2-653">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-653">Variable cost</span></span></td>
</tr>
</tbody>
</table>

##### <a name="journal-entries-cost-object-balance-journal-entries"></a><span data-ttu-id="9d9a2-654">Entradas de diário (entradas de diário do saldo de objeto de custo)</span><span class="sxs-lookup"><span data-stu-id="9d9a2-654">Journal entries (cost object balance journal entries)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="9d9a2-655">Diário</span><span class="sxs-lookup"><span data-stu-id="9d9a2-655">Journal</span></span></th>
<th><span data-ttu-id="9d9a2-656">Tipo de diário</span><span class="sxs-lookup"><span data-stu-id="9d9a2-656">Journal type</span></span></th>
<th colspan="3"><span data-ttu-id="9d9a2-657">Período do calendário fiscal</span><span class="sxs-lookup"><span data-stu-id="9d9a2-657">Fiscal calendar period</span></span></th>
<th><span data-ttu-id="9d9a2-658">Versão</span><span class="sxs-lookup"><span data-stu-id="9d9a2-658">Version</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="9d9a2-659">00004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-659">00004</span></span></td>
<td><span data-ttu-id="9d9a2-660">Diário de alocação de custos</span><span class="sxs-lookup"><span data-stu-id="9d9a2-660">Cost allocation journal</span></span></td>
<td><span data-ttu-id="9d9a2-661">fiscal</span><span class="sxs-lookup"><span data-stu-id="9d9a2-661">Fiscal</span></span></td>
<td><span data-ttu-id="9d9a2-662">2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-662">2017</span></span></td>
<td><span data-ttu-id="9d9a2-663">Período 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-663">Period 1</span></span></td>
<td><span data-ttu-id="9d9a2-664">Cálculo de custos gerais indiretos / 01-02-2017 11:51:00 PM / Razão/2017 / Período 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-664">Overhead calculation / 01-02-2017 11:51:00 PM / Ledger /2017 / Period 1</span></span></td>
</tr>
</tbody>
</table>

##### <a name="journal-lines"></a><span data-ttu-id="9d9a2-665">Linhas do diário</span><span class="sxs-lookup"><span data-stu-id="9d9a2-665">Journal lines</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="9d9a2-666">Data contábil</span><span class="sxs-lookup"><span data-stu-id="9d9a2-666">Accounting date</span></span></th>
<th colspan="2"><span data-ttu-id="9d9a2-667">Objeto de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-667">Cost object</span></span></th>
<th colspan="2"><span data-ttu-id="9d9a2-668">Elemento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-668">Cost element</span></span></th>
<th><span data-ttu-id="9d9a2-669">Comportamento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-669">Cost behavior</span></span></th>
<th><span data-ttu-id="9d9a2-670">Valor</span><span class="sxs-lookup"><span data-stu-id="9d9a2-670">Amount</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="9d9a2-671">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-671">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-672">CC001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-672">CC001</span></span></td>
<td><span data-ttu-id="9d9a2-673">RH</span><span class="sxs-lookup"><span data-stu-id="9d9a2-673">HR</span></span></td>
<td><span data-ttu-id="9d9a2-674">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-674">10001</span></span></td>
<td><span data-ttu-id="9d9a2-675">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-675">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-676">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-676">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-677">500,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-677">500.00</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-678">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-678">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-679">CC001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-679">CC001</span></span></td>
<td><span data-ttu-id="9d9a2-680">RH</span><span class="sxs-lookup"><span data-stu-id="9d9a2-680">HR</span></span></td>
<td><span data-ttu-id="9d9a2-681">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-681">10001</span></span></td>
<td><span data-ttu-id="9d9a2-682">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-682">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-683">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-683">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-684">1,245.71</span><span class="sxs-lookup"><span data-stu-id="9d9a2-684">1,245.71</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-685">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-685">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-686">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-686">CC002</span></span></td>
<td><span data-ttu-id="9d9a2-687">Finanças</span><span class="sxs-lookup"><span data-stu-id="9d9a2-687">Finance</span></span></td>
<td><span data-ttu-id="9d9a2-688">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-688">10001</span></span></td>
<td><span data-ttu-id="9d9a2-689">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-689">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-690">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-690">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-691">675.00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-691">675.00</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-692">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-692">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-693">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-693">CC002</span></span></td>
<td><span data-ttu-id="9d9a2-694">Finanças</span><span class="sxs-lookup"><span data-stu-id="9d9a2-694">Finance</span></span></td>
<td><span data-ttu-id="9d9a2-695">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-695">10001</span></span></td>
<td><span data-ttu-id="9d9a2-696">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-696">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-697">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-697">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-698">8,150.29</span><span class="sxs-lookup"><span data-stu-id="9d9a2-698">8,150.29</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-699">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-699">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-700">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-700">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-701">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-701">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-702">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-702">10001</span></span></td>
<td><span data-ttu-id="9d9a2-703">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-703">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-704">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-704">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-705">713.75</span><span class="sxs-lookup"><span data-stu-id="9d9a2-705">713.75</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-706">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-706">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-707">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-707">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-708">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-708">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-709">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-709">10001</span></span></td>
<td><span data-ttu-id="9d9a2-710">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-710">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-711">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-711">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-712">5,982.83</span><span class="sxs-lookup"><span data-stu-id="9d9a2-712">5,982.83</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-713">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-713">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-714">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-714">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-715">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-715">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-716">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-716">10001</span></span></td>
<td><span data-ttu-id="9d9a2-717">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-717">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-718">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-718">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-719">286.25</span><span class="sxs-lookup"><span data-stu-id="9d9a2-719">286.25</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-720">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-720">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-721">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-721">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-722">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-722">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-723">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-723">10001</span></span></td>
<td><span data-ttu-id="9d9a2-724">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-724">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-725">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-725">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-726">2,977.17</span><span class="sxs-lookup"><span data-stu-id="9d9a2-726">2,977.17</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-727">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-727">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-728">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-728">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-729">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-729">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-730">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-730">10001</span></span></td>
<td><span data-ttu-id="9d9a2-731">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-731">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-732">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-732">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-733">776.36</span><span class="sxs-lookup"><span data-stu-id="9d9a2-733">776.36</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-734">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-734">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-735">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-735">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-736">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-736">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-737">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-737">10001</span></span></td>
<td><span data-ttu-id="9d9a2-738">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-738">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-739">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-739">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-740">6,994.21</span><span class="sxs-lookup"><span data-stu-id="9d9a2-740">6,994.21</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-741">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-741">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-742">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-742">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-743">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-743">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-744">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-744">10001</span></span></td>
<td><span data-ttu-id="9d9a2-745">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-745">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-746">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-746">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-747">223.64</span><span class="sxs-lookup"><span data-stu-id="9d9a2-747">223.64</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-748">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-748">January 31, 2017</span></span></td>
<td><span data-ttu-id="9d9a2-749">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-749">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-750">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-750">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-751">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-751">10001</span></span></td>
<td><span data-ttu-id="9d9a2-752">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-752">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-753">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-753">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-754">1,965.79</span><span class="sxs-lookup"><span data-stu-id="9d9a2-754">1,965.79</span></span></td>
</tr>
</tbody>
</table>

##### <a name="cost-entries"></a><span data-ttu-id="9d9a2-755">Entradas de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-755">Cost entries</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="9d9a2-756">Objeto de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-756">Cost object</span></span></th>
<th colspan="2"><span data-ttu-id="9d9a2-757">Elemento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-757">Cost element</span></span></th>
<th><span data-ttu-id="9d9a2-758">Comportamento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-758">Cost behavior</span></span></th>
<th><span data-ttu-id="9d9a2-759">Valor</span><span class="sxs-lookup"><span data-stu-id="9d9a2-759">Amount</span></span></th>
<th><span data-ttu-id="9d9a2-760">Data contábil</span><span class="sxs-lookup"><span data-stu-id="9d9a2-760">Accounting date</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="9d9a2-761">CC001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-761">CC001</span></span></td>
<td><span data-ttu-id="9d9a2-762">RH</span><span class="sxs-lookup"><span data-stu-id="9d9a2-762">HR</span></span></td>
<td><span data-ttu-id="9d9a2-763">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-763">10001</span></span></td>
<td><span data-ttu-id="9d9a2-764">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-764">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-765">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-765">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-766">-500,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-766">-500.00</span></span></td>
<td><span data-ttu-id="9d9a2-767">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-767">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-768">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-768">CC002</span></span></td>
<td><span data-ttu-id="9d9a2-769">Finanças</span><span class="sxs-lookup"><span data-stu-id="9d9a2-769">Finance</span></span></td>
<td><span data-ttu-id="9d9a2-770">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-770">10001</span></span></td>
<td><span data-ttu-id="9d9a2-771">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-771">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-772">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-772">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-773">175.00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-773">175.00</span></span></td>
<td><span data-ttu-id="9d9a2-774">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-774">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-775">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-775">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-776">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-776">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-777">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-777">10001</span></span></td>
<td><span data-ttu-id="9d9a2-778">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-778">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-779">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-779">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-780">275.00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-780">275.00</span></span></td>
<td><span data-ttu-id="9d9a2-781">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-781">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-782">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-782">CC004</span></span></td>
<td><span data-ttu-id="9d9a2-783">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-783">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-784">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-784">10001</span></span></td>
<td><span data-ttu-id="9d9a2-785">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-785">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-786">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-786">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-787">50,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-787">50,00</span></span></td>
<td><span data-ttu-id="9d9a2-788">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-788">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-789">CC001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-789">CC001</span></span></td>
<td><span data-ttu-id="9d9a2-790">RH</span><span class="sxs-lookup"><span data-stu-id="9d9a2-790">HR</span></span></td>
<td><span data-ttu-id="9d9a2-791">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-791">10001</span></span></td>
<td><span data-ttu-id="9d9a2-792">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-792">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-793">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-793">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-794">-1.245,71</span><span class="sxs-lookup"><span data-stu-id="9d9a2-794">-1,245.71</span></span></td>
<td><span data-ttu-id="9d9a2-795">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-795">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-796">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-796">CC002</span></span></td>
<td><span data-ttu-id="9d9a2-797">Finanças</span><span class="sxs-lookup"><span data-stu-id="9d9a2-797">Finance</span></span></td>
<td><span data-ttu-id="9d9a2-798">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-798">10001</span></span></td>
<td><span data-ttu-id="9d9a2-799">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-799">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-800">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-800">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-801">436.00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-801">436.00</span></span></td>
<td><span data-ttu-id="9d9a2-802">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-802">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-803">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-803">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-804">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-804">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-805">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-805">10001</span></span></td>
<td><span data-ttu-id="9d9a2-806">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-806">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-807">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-807">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-808">685.14</span><span class="sxs-lookup"><span data-stu-id="9d9a2-808">685.14</span></span></td>
<td><span data-ttu-id="9d9a2-809">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-809">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-810">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-810">CC004</span></span></td>
<td><span data-ttu-id="9d9a2-811">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-811">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-812">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-812">10001</span></span></td>
<td><span data-ttu-id="9d9a2-813">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-813">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-814">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-814">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-815">124.57</span><span class="sxs-lookup"><span data-stu-id="9d9a2-815">124.57</span></span></td>
<td><span data-ttu-id="9d9a2-816">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-816">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-817">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-817">CC002</span></span></td>
<td><span data-ttu-id="9d9a2-818">Finanças</span><span class="sxs-lookup"><span data-stu-id="9d9a2-818">Finance</span></span></td>
<td><span data-ttu-id="9d9a2-819">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-819">10001</span></span></td>
<td><span data-ttu-id="9d9a2-820">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-820">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-821">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-821">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-822">-675,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-822">-675.00</span></span></td>
<td><span data-ttu-id="9d9a2-823">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-823">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-824">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-824">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-825">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-825">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-826">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-826">10001</span></span></td>
<td><span data-ttu-id="9d9a2-827">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-827">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-828">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-828">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-829">438.75</span><span class="sxs-lookup"><span data-stu-id="9d9a2-829">438.75</span></span></td>
<td><span data-ttu-id="9d9a2-830">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-830">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-831">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-831">CC004</span></span></td>
<td><span data-ttu-id="9d9a2-832">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-832">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-833">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-833">10001</span></span></td>
<td><span data-ttu-id="9d9a2-834">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-834">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-835">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-835">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-836">236.25</span><span class="sxs-lookup"><span data-stu-id="9d9a2-836">236.25</span></span></td>
<td><span data-ttu-id="9d9a2-837">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-837">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-838">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-838">CC002</span></span></td>
<td><span data-ttu-id="9d9a2-839">Finanças</span><span class="sxs-lookup"><span data-stu-id="9d9a2-839">Finance</span></span></td>
<td><span data-ttu-id="9d9a2-840">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-840">10001</span></span></td>
<td><span data-ttu-id="9d9a2-841">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-841">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-842">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-842">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-843">-8.150,29</span><span class="sxs-lookup"><span data-stu-id="9d9a2-843">-8,150.29</span></span></td>
<td><span data-ttu-id="9d9a2-844">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-844">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-845">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-845">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-846">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-846">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-847">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-847">10001</span></span></td>
<td><span data-ttu-id="9d9a2-848">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-848">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-849">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-849">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-850">5,297.69</span><span class="sxs-lookup"><span data-stu-id="9d9a2-850">5,297.69</span></span></td>
<td><span data-ttu-id="9d9a2-851">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-851">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-852">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-852">CC004</span></span></td>
<td><span data-ttu-id="9d9a2-853">Embalagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-853">Packaging</span></span></td>
<td><span data-ttu-id="9d9a2-854">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-854">10001</span></span></td>
<td><span data-ttu-id="9d9a2-855">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-855">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-856">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-856">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-857">2,852.60</span><span class="sxs-lookup"><span data-stu-id="9d9a2-857">2,852.60</span></span></td>
<td><span data-ttu-id="9d9a2-858">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-858">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-859">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-859">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-860">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-860">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-861">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-861">10001</span></span></td>
<td><span data-ttu-id="9d9a2-862">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-862">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-863">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-863">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-864">-713,75</span><span class="sxs-lookup"><span data-stu-id="9d9a2-864">-713.75</span></span></td>
<td><span data-ttu-id="9d9a2-865">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-865">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-866">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-866">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-867">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-867">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-868">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-868">10001</span></span></td>
<td><span data-ttu-id="9d9a2-869">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-869">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-870">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-870">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-871">535.31</span><span class="sxs-lookup"><span data-stu-id="9d9a2-871">535.31</span></span></td>
<td><span data-ttu-id="9d9a2-872">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-872">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-873">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-873">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-874">Produto 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-874">Product 2</span></span></td>
<td><span data-ttu-id="9d9a2-875">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-875">10001</span></span></td>
<td><span data-ttu-id="9d9a2-876">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-876">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-877">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-877">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-878">178.44</span><span class="sxs-lookup"><span data-stu-id="9d9a2-878">178.44</span></span></td>
<td><span data-ttu-id="9d9a2-879">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-879">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-880">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-880">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-881">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-881">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-882">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-882">10001</span></span></td>
<td><span data-ttu-id="9d9a2-883">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-883">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-884">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-884">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-885">-5.982,83</span><span class="sxs-lookup"><span data-stu-id="9d9a2-885">-5,982.83</span></span></td>
<td><span data-ttu-id="9d9a2-886">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-886">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-887">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-887">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-888">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-888">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-889">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-889">10001</span></span></td>
<td><span data-ttu-id="9d9a2-890">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-890">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-891">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-891">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-892">4,487.12</span><span class="sxs-lookup"><span data-stu-id="9d9a2-892">4,487.12</span></span></td>
<td><span data-ttu-id="9d9a2-893">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-893">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-894">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-894">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-895">Produto 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-895">Product 2</span></span></td>
<td><span data-ttu-id="9d9a2-896">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-896">10001</span></span></td>
<td><span data-ttu-id="9d9a2-897">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-897">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-898">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-898">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-899">1,495.71</span><span class="sxs-lookup"><span data-stu-id="9d9a2-899">1,495.71</span></span></td>
<td><span data-ttu-id="9d9a2-900">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-900">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-901">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-901">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-902">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-902">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-903">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-903">10001</span></span></td>
<td><span data-ttu-id="9d9a2-904">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-904">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-905">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-905">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-906">-286,25</span><span class="sxs-lookup"><span data-stu-id="9d9a2-906">-286.25</span></span></td>
<td><span data-ttu-id="9d9a2-907">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-907">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-908">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-908">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-909">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-909">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-910">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-910">10001</span></span></td>
<td><span data-ttu-id="9d9a2-911">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-911">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-912">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-912">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-913">241.05</span><span class="sxs-lookup"><span data-stu-id="9d9a2-913">241.05</span></span></td>
<td><span data-ttu-id="9d9a2-914">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-914">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-915">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-915">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-916">Produto 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-916">Product 2</span></span></td>
<td><span data-ttu-id="9d9a2-917">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-917">10001</span></span></td>
<td><span data-ttu-id="9d9a2-918">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-918">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-919">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-919">Fixed cost</span></span></td>
<td><span data-ttu-id="9d9a2-920">45.20</span><span class="sxs-lookup"><span data-stu-id="9d9a2-920">45.20</span></span></td>
<td><span data-ttu-id="9d9a2-921">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-921">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-922">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-922">CC003</span></span></td>
<td><span data-ttu-id="9d9a2-923">Montagem</span><span class="sxs-lookup"><span data-stu-id="9d9a2-923">Assembly</span></span></td>
<td><span data-ttu-id="9d9a2-924">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-924">10001</span></span></td>
<td><span data-ttu-id="9d9a2-925">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-925">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-926">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-926">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-927">-2.977,17</span><span class="sxs-lookup"><span data-stu-id="9d9a2-927">-2,977.17</span></span></td>
<td><span data-ttu-id="9d9a2-928">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-928">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-929">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-929">Prod 1</span></span></td>
<td><span data-ttu-id="9d9a2-930">Produto 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-930">Product 1</span></span></td>
<td><span data-ttu-id="9d9a2-931">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-931">10001</span></span></td>
<td><span data-ttu-id="9d9a2-932">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-932">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-933">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-933">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-934">2,507.09</span><span class="sxs-lookup"><span data-stu-id="9d9a2-934">2,507.09</span></span></td>
<td><span data-ttu-id="9d9a2-935">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-935">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="9d9a2-936">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-936">Prod 2</span></span></td>
<td><span data-ttu-id="9d9a2-937">Produto 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-937">Product 2</span></span></td>
<td><span data-ttu-id="9d9a2-938">10001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-938">10001</span></span></td>
<td><span data-ttu-id="9d9a2-939">eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-939">Electricity</span></span></td>
<td><span data-ttu-id="9d9a2-940">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-940">Variable cost</span></span></td>
<td><span data-ttu-id="9d9a2-941">470.08</span><span class="sxs-lookup"><span data-stu-id="9d9a2-941">470.08</span></span></td>
<td><span data-ttu-id="9d9a2-942">31 de janeiro, 2017</span><span class="sxs-lookup"><span data-stu-id="9d9a2-942">January 31, 2017</span></span></td>
</tr>
</tbody>
</table>

## <a name="conclusion"></a><span data-ttu-id="9d9a2-943">Conclusão</span><span class="sxs-lookup"><span data-stu-id="9d9a2-943">Conclusion</span></span>
<span data-ttu-id="9d9a2-944">Na contabilidade financeira, um custo de 10,000.00 para a eletricidade é lançado para um ID fictício de centro de custos.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-944">In Financial accounting, a cost of 10,000.00 for Electricity is posted to a dummy cost center ID.</span></span> <span data-ttu-id="9d9a2-945">Portanto, os contadores de custo saberão que esses custos devem ser alocados.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-945">Therefore, cost accountants will know that this cost must be allocated.</span></span> <span data-ttu-id="9d9a2-946">Na contabilização de custo, os custos fluem nas unidades organizacionais e nos níveis, com base nas políticas e regras que são aplicadas.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-946">In Cost accounting, the costs flow across organizational units and levels, based on the policies and rules that are applied.</span></span> <span data-ttu-id="9d9a2-947">Cada custo foi associado a uma base de alocação que fornece a melhor apuração para a alocação de custos.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-947">Each cost has been associated with an allocation base that provides the best assessment for the allocation of costs.</span></span>

<table>
<thead>
<tr>
<th colspan="2" rowspan="2"><span data-ttu-id="9d9a2-948">Elemento de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-948">Cost element</span></span></th>
<th colspan="9"><span data-ttu-id="9d9a2-949">Objeto de custo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-949">Cost object</span></span></th>
<th rowspan="2"><span data-ttu-id="9d9a2-950">Total</span><span class="sxs-lookup"><span data-stu-id="9d9a2-950">Total</span></span></th>
</tr>
<tr>
<th><span data-ttu-id="9d9a2-951">CC099</span><span class="sxs-lookup"><span data-stu-id="9d9a2-951">CC099</span></span></th>
<th><span data-ttu-id="9d9a2-952">CC001</span><span class="sxs-lookup"><span data-stu-id="9d9a2-952">CC001</span></span></th>
<th><span data-ttu-id="9d9a2-953">CC002</span><span class="sxs-lookup"><span data-stu-id="9d9a2-953">CC002</span></span></th>
<th><span data-ttu-id="9d9a2-954">CC003</span><span class="sxs-lookup"><span data-stu-id="9d9a2-954">CC003</span></span></th>
<th><span data-ttu-id="9d9a2-955">CC004</span><span class="sxs-lookup"><span data-stu-id="9d9a2-955">CC004</span></span></th>
<th><span data-ttu-id="9d9a2-956">Proj. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-956">Proj 1</span></span></th>
<th><span data-ttu-id="9d9a2-957">Proj. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-957">Proj 2</span></span></th>
<th><span data-ttu-id="9d9a2-958">Prod. 1</span><span class="sxs-lookup"><span data-stu-id="9d9a2-958">Prod 1</span></span></th>
<th><span data-ttu-id="9d9a2-959">Prod. 2</span><span class="sxs-lookup"><span data-stu-id="9d9a2-959">Prod 2</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td colspan="2"><span data-ttu-id="9d9a2-960">10001 Eletricidade</span><span class="sxs-lookup"><span data-stu-id="9d9a2-960">10001 Electricity</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-961"><strong>0.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-961"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-962"><strong>0.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-962"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-963"><strong>0.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-963"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-964"><strong>0.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-964"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-965"><strong>30.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-965"><strong>30.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-966"><strong>10.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-966"><strong>10.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-967"><strong>7,770.57</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-967"><strong>7,770.57</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-968"><strong>2,189.43</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-968"><strong>2,189.43</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-969"><strong>10,000.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-969"><strong>10,000.00</strong></span></span></td>
</tr>
<tr>
<td></td>
<td style="text-align: left;"><span data-ttu-id="9d9a2-970">Não classificado</span><span class="sxs-lookup"><span data-stu-id="9d9a2-970">Unclassified</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-971">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-971">0.00</span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
...
<tr>
<td style="text-align: right;"></td>
<td style="text-align: left;"><span data-ttu-id="9d9a2-972">Custo fixo</span><span class="sxs-lookup"><span data-stu-id="9d9a2-972">Fixed cost</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-973">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-973">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-974">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-974">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-975">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-975">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-976">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-976">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-977">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-977">0.00</span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-978">776.36</span><span class="sxs-lookup"><span data-stu-id="9d9a2-978">776.36</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-979">223.64</span><span class="sxs-lookup"><span data-stu-id="9d9a2-979">223.64</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-980"><strong>1,000.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-980"><strong>1,000.00</strong></span></span></td>
</tr>
<tr>
<td style="text-align: right;"></td>
<td style="text-align: left;"><span data-ttu-id="9d9a2-981">Custo variável</span><span class="sxs-lookup"><span data-stu-id="9d9a2-981">Variable cost</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-982">000</span><span class="sxs-lookup"><span data-stu-id="9d9a2-982">000</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-983">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-983">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-984">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-984">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-985">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-985">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-986">0,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-986">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-987">30,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-987">30.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-988">10,00</span><span class="sxs-lookup"><span data-stu-id="9d9a2-988">10.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-989">6,994.21</span><span class="sxs-lookup"><span data-stu-id="9d9a2-989">6,994.21</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-990">1,965.79</span><span class="sxs-lookup"><span data-stu-id="9d9a2-990">1,965.79</span></span></td>
<td style="text-align: right;"><span data-ttu-id="9d9a2-991"><strong>9,000.00</strong></span><span class="sxs-lookup"><span data-stu-id="9d9a2-991"><strong>9,000.00</strong></span></span></td>
</tr>
</tbody>
</table>

> [!NOTE]
> <span data-ttu-id="9d9a2-992">Esse tópico mostra como um elemento de custo principal, 10001 Eletricidade flui pelos objetos de custo.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-992">This topic shows how a primary cost element, 10001 Electricity, flows through the cost objects.</span></span> <span data-ttu-id="9d9a2-993">Portanto, esse custo geral indireto é alocado no nível mais baixo na organização.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-993">Therefore, this overhead cost is allocated to the lowest level in the organization.</span></span> <span data-ttu-id="9d9a2-994">Em outras palavras, os objetos de custo no nível mais baixo assumem o custo.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-994">In other words, the cost objects at the lowest level bear the cost.</span></span> <span data-ttu-id="9d9a2-995">Se você exigir um fluxo visual de custo entre objetos de custo, é possível usar as regras de política de acúmulo de custos para visualizar o fluxo de custo.</span><span class="sxs-lookup"><span data-stu-id="9d9a2-995">If you require a visual flow of the cost between the cost objects, you can use the cost roll-up policy rules to visualize the flow of the cost.</span></span> <span data-ttu-id="9d9a2-996">Para obter mais informações, consulte [Política de acúmulo de custo e cálculo de custos indiretos](cost-rollup.md).</span><span class="sxs-lookup"><span data-stu-id="9d9a2-996">For more information, see [Cost rollup policy and overhead calculation](cost-rollup.md).</span></span>
