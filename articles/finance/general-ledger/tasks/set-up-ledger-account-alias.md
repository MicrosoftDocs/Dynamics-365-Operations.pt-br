...
5. No campo Empresa, clique no botão suspenso para abrir a pesquisa.
6. Na lista, localize e selecione a empresa à qual o apelido se aplica.
7. Na lista, clique no link na linha selecionada.
8. No campo Definição do apelido da conta contábil, especifique a conta e as dimensões.
    * A conta e as dimensões serão preenchidas quando o atalho for usado.  
