...
description: Este tópico fornece informações sobre diferentes tipos de lançamento de pedido de produção.
...
ms.locfileid: "8802976"
---
# <a name="production-postings"></a>Lançamentos de produção

Este tópico fornece informações sobre diferentes tipos de lançamento no processo de pedido de produção.
