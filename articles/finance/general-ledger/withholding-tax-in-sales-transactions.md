...
description: Este artigo lista as etapas para evitar o cálculo do imposto retido na fonte para clientes selecionados. Para clientes que especificam o imposto retido na fonte em seus pagamentos, você pode atribuir o grupo de retenção de imposto na fonte padrão.
author: kailiang
ms.date: 01/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8910074"
---
# <a name="withholding-tax-in-sales-transactions"></a>Imposto retido na fonte em transações de venda

Este artigo lista as etapas para evitar o cálculo do imposto retido na fonte para clientes selecionados. Para clientes que especificam o imposto retido na fonte em seus pagamentos, você pode atribuir o **Grupo de retenção de imposto na fonte** padrão na página **Clientes**. 
