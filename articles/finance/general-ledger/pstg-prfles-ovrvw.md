...
Muitos módulos no Dynamics 365 Finance, no Dynamics 365 Supply Chain Management, no Dynamics 365 Commerce e no Dynamics 365 Project Operations têm um perfil de lançamento ou configurações adicionais que controlam como funciona o lançamento na contabilidade. Use os seguintes tópicos para saber mais sobre os perfis de lançamentos e as configurações de lançamento em cada módulo:
