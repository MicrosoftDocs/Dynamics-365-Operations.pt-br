...
description: Este artigo fornece informações sobre como solucionar problemas que podem ajudar quando um registro TaxTrans não é gerado.
author: qire
ms.date: 04/13/2021
ms.topic: article
ms.prod: ''
