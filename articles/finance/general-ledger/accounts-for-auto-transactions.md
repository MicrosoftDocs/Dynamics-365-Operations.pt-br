...
description: Este artigo explica como as contas para transações automáticas são usadas para lançamento pelo Microsoft Dynamics 365 e fornece exemplos de contas principais para transações automáticas.
