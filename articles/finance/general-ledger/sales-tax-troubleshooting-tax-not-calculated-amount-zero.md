...
description: Este artigo fornece informações sobre como solucionar problemas que podem ajudar quando o valor do imposto for 0 (zero) ou o imposto não for calculado.
author: shtao
ms.date: 04/01/2021
ms.topic: article
ms.prod: ''
