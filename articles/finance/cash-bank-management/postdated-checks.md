...
description: Este artigo fornece informações sobre o suporte para cheques pré-datados. Cheques pré-datados são emitidos com a finalidade de realizar e receber pagamentos em uma data futura.
author: angelad116
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
