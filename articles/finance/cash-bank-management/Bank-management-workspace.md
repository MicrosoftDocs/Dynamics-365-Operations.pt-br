...
description: Este artigo fornece informações sobre o espaço de trabalho de gerenciamento de banco. Este workspace mostra informações relacionadas a contas bancárias da empresa.
author: angelad116
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
