...
4. Clique em **Fechar**.
    * Cada linha abaixo é uma fatura de texto livre recorrente. Você pode selecionar uma linha e clicar no botão de **Detalhes** para exibir detalhes da fatura em texto livre.  
5. Clique em **Validar**.
