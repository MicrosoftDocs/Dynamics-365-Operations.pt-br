...
5. No campo **Imprimir**, selecione 'Depois'.
6. Selecione **Sim** para **Imprimir fatura**. O gerenciamento de impressão pode imprimir várias cópias de notas fiscais e também enviar a nota fiscal por email como um arquivo PDF.  
