...
Esta guia ajudará a configurar uma definição do período de classificação por vencimento, para classificar por vencimento saldos do cliente e saldos de exibição na lista **Saldos classificados por vencimento**, além da página **Coleções**. Este registro usa a empresa de dados de demonstração USMF.
