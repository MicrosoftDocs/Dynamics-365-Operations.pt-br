...
description: Este artigo explica como usar sequências numéricas compartilhadas para copiar um cliente para outra entidade legal mantendo a mesma ID.
author: abruer
ms.date: 08/31/2018
ms.topic: index-page
ms.prod: ''
