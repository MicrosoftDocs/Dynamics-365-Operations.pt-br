...
description: Os ativos fixos são itens de valor pertencentes a um indivíduo ou uma organização. Os itens incluem imóveis, veículos, terrenos e equipamentos.
...
ms.locfileid: "6753543"
---
# <a name="fixed-assets-home-page"></a>Home page de Ativos fixos

[!include [banner](../includes/banner.md)]

Os ativos fixos são itens de valor pertencentes a um indivíduo ou uma organização. Os itens incluem imóveis, veículos, terrenos e equipamentos. 
