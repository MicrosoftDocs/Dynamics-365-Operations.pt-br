...
description: Este artigo oferece uma lista de tópicos da Ajuda e outros recursos para o gerenciamento financeiro do Microsoft Dynamics 365 Finance.
author: kfend
ms.date: 11/04/2021
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "9539223"
---
# <a name="finance-home-page"></a>Home page do Finance

[!include [banner](includes/banner.md)]

Este artigo oferece uma lista de tópicos da Ajuda e outros recursos para o gerenciamento financeiro do Microsoft Dynamics 365 Finance. 
...
- [Blog do Microsoft Dynamics 365](https://community.dynamics.com/b/msftdynamicsblog?c=Enterprise)
...
Para obter informações sobre os recursos para gerenciar as compras, o estoque e a fabricação, consulte a [home page do Supply Chain Management](../supply-chain/index.md).

## <a name="elearning-courses"></a>Cursos de eLearning

Para saber sobre cursos e treinamentos online, confira [Roteiros de aprendizagem do Dynamics 365 Finance](/training/browse/?products=dynamics-finance&resource_type=learning+path).
