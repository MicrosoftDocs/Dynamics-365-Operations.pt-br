...
description: Este artigo explica como configurar o espaço de trabalho que está relacionado às faturas de fornecedor e que mostra as informações que estão disponíveis pelo Microsoft Power BI.
author: abruer
ms.date: 02/14/2022
ms.topic: article
ms.prod: ''
