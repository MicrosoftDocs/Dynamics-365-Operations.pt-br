...
Se uma tentativa de aplicar um pré-pagamento falhar, a configuração da opção **Bloquear processo de automação de acompanhamento em caso de falha na aplicação de pagamento antecipado** determinará as próximas etapas:
