...
> [!NOTE]
> Essa funcionalidade será preterida em 2022 de setembro, os novos usuários devem usar a emissão de relatórios eletrônicos. Para obter mais informações, consulte [Configurar arquivos de pagamento positivos usando o Relatório eletrônico](set-up-positive-pay-er.md).
