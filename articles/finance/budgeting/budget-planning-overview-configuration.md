...
Quando você compreender os conceitos e a terminologia usados no Microsoft Dynamics 365 Finance, será mais fácil implementar o planejamento de orçamento na organização.
...
O planejamento de orçamento é integrado a outros módulos. Consequentemente, você poderá exibir as informações de orçamento anteriores, despesa atuais, ativos fixos e recursos humanos. Como o planejamento de orçamento também é integrado ao Microsoft Excel e ao Microsoft Word, você pode usar esses programas para trabalhar com os dados pertinentes. Por exemplo, um gerente de orçamento pode importar a solicitação de orçamento de um cenário do plano de orçamento na planilha do Excel. Os dados podem ser analisados, atualizados e representados em gráfico na planilha e, em seguida, publicados de volta nas linhas do plano de orçamento.
...
Você cria o fluxo de trabalho do orçamento para o plano na página **Fluxos de trabalho do orçamento**. O processo se parece com o processo para criar outros fluxos de trabalho. A ilustração a seguir mostra um exemplo de um fluxo de trabalho da matriz. 
