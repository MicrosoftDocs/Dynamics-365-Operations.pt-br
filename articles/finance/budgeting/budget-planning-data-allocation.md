...
description: Este artigo descreve os métodos de alocação disponíveis no Microsoft Dynamics 365 Finance e como eles podem ser usados.
author: panolte
ms.date: 03/05/2020
ms.topic: article
ms.prod: ''
