...
description: Este artigo descreve o recurso Arrendamento de ativos e percorre as etapas para criar um arrendamento de ativos e exibir informações para esses arrendamentos.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
