...
description: Este artigo descreve as informações que são mantidas em registros de arrendamento. Os registros de arrendamento contêm as políticas contábeis que determinam como um arrendamento é contabilizado no sistema.
author: moaamer
ms.date: 07/16/2021
ms.topic: article
ms.prod: ''
