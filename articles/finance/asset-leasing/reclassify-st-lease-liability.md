...
description: Este artigo explica como criar uma entrada de diário mensal para reclassificar uma parte da responsabilidade com arrendamento como um curto prazo.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
