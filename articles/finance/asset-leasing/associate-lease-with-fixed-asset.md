...
O tópico explica como associar um ativo fixo existente a um novo arrendamento. Quando você associa um ativo fixo a um arrendamento, o valor de ativo de ROU (direito de uso) no reconhecimento inicial será o custo de aquisição do ativo fixo.
...
4. Selecione **Diário de arrendamento de ativo**.
    ...
    A entrada de diário de reconhecimento inicial para os débitos de leasing do ativo fixo para o valor que geralmente é debitado na conta de ativo ROU.
