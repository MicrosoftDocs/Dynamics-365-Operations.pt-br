...
description: Este artigo explica como anexar guias de pagamento impressas a faturas de projeto e fornecer uma referência de pagamento para lançamento e liquidação.
