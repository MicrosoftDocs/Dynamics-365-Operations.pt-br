...
description: Este tópico fornece uma visão geral dos recursos do Regulatory Configuration Service (RCS) e explica como acessar o serviço.
author: JaneA07
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
Para obter mais informações sobre os componentes relacionados, veja a documentação abaixo:
