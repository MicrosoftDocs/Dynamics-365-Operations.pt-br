...
description: Este artigo contém informações sobre o relatório Intrastat na Polônia.
author: AdamTrukawka
ms.date: 11/09/2021
ms.topic: article
...
16. Selecione **OK** e revise o relatório no formato XML que foi gerado. A tabela a seguir mostra os valores no relatório de exemplo.
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informações sobre o documento</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informações sobre a empresa</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informações sobre a mercadoria</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informações do contato</strong></p>
    </td>
    </tr>
    <tr>
    <td>
