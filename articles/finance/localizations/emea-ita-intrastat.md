...
- **Seção 1. Bens** — esta seção contém informações sobre transações normais e notas de crédito relacionadas às faturas para bens no mesmo período do relatório que o período de declaração Intrastat.
...
Para obter mais informações, consulte [Visão geral do Intrastat](emea-intrastat.md).
...
2.  Em Dynamics 365 Finance, acesse **Imposto** &gt; **Configuração** &gt; **Parâmetros de troca estrangeiros**.
...
3.  Na guia **Intrastat**, na Guia Rápida **Geral**, configure os seguintes campos:
    ...
    - **Nota de crédito** – Selecione o código de transação para o devolução de bens. Esse código será usado para o retorno de bens após a transação original ser registrada no código da transação.
    ...
    - **Comprar período do relatório** – Selecione o período do relatório para a declaração de importação: **Mês** ou **Trimestre**. As declarações trimestrais são exportadas no formato simplificado.
...
8.  Acesse **Contas a pagar** &gt; **Configurar** &gt; **Termos de entrega**.
...
-   Acesse **Imposto** &gt; **Configuração** &gt; **Imposto de vendas** &gt; **Números de isenção de impostos** e insira todos os números de isenção de impostos para seus clientes e fornecedores. Em cada parceiro, defina os seguintes campos:
...
-   Acesse **Contas a receber** &gt; **Clientes** &gt; **Todos os clientes** e siga estas etapas para cada cliente:
...
-   Acesse **Contas a pagar** &gt; **Fornecedores** &gt; **Todos os fornecedores** e siga estas etapas para cada fornecedor:
...
Para cada transação, você pode definir vários parâmetros específicos da Itália na guia **Geral**.
...
<tr>
<td colspan="2">
<p style="text-align: center;">Seção <strong>Geral</strong></p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Este campo pode ser definido como <strong>Bens</strong> ou <strong>Serviços</strong>.</p>
<p>Para que uma transação seja considerada um serviço, a linha da fatura deve ser configurada de uma das seguintes maneiras:</p>
<p>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Não há código de mercadoria.</p>
<p>&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Há um código de mercadoria de seis dígitos</p>
</td>
</tr>
<tr>
<td colspan="2">
<p style="text-align: center;">Seção <strong>País/região de origem</strong></p>
</td>
</tr>
<tr>
<td>
<p>Região de origem</p>
</td>
<td>
<p>A região de origem do produto ou serviço. Esse valor é especificado na página <strong>Produtos lançados</strong>.</p>
</td>
</tr>
<tr>
<td colspan="2">
<p style="text-align: center;">Seção <strong>Códigos</strong></p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>O modo de entrega. Para especificar o modo de entrega, acesse <strong>Vendas e marketing</strong> &gt; <strong>Configuração</strong> &gt; <strong>Distribuição</strong> &gt; <strong>Modos de entrega</strong>.</p>
</td>
</tr>
<tr>
<td colspan="2">
<p style="text-align: center;">Seção <strong>Correções</strong></p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>O mês da transação original.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>O trimestre da transação original.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>O ano da transação original.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Para correções de serviço, insira o número do registro original do Intrastat.</p>
</td>
</tr>
<tr>
<td colspan="2">
<p style="text-align: center;">Seção <strong>Valor da fatura</strong></p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>A moeda nacional do parceiro.</p>
</td>
</tr>
<tr>
<td>
<p>Valor da fatura na moeda da transação</p>
</td>
<td>
<p>O valor da fatura na moeda nacional do parceiro.</p>
</td>
</tr>
<tr>
<td>
<p>Valor dos encargos da fatura na moeda da transação</p>
</td>
<td>
<p>A fatura é cobrada na moeda nacional do parceiro.</p>
</td>
</tr>
<tr>
<td>
...
1.  Para gerar um relatório do Intrastat, acesse **Impostos** &gt; **Declarações** &gt; **Comércio exterior** &gt; **Intrastat**.
...
<td>
<p>Selecione a data de início do relatório.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Selecione a data de término do relatório.</p>
</td>
</tr>
<tr>
<td colspan="2">
<p>Seção <strong>Opções de exportação</strong></p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Defina esta opção como <strong>Sim</strong> para gerar um arquivo .txt.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Insira o nome do arquivo. txt do relatório do Intrastat.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Defina esta opção como <strong>Sim</strong> para gerar um arquivo .xlsx.</p>
</td>
</tr>
<tr>
<td>
<p>Nome do arquivo de relatório</p>
</td>
<td>
<p>Insira o nome do arquivo. xlsx do relatório do Intrastat.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Selecione <strong>Recebimento</strong> para ver um relatório sobre as recebimentos dentro da comunidade. Selecione <strong>Envios</strong> para ver um relatório sobre envios de dentro da comunidade.</p>
</td>
</tr>
<tr>
<td colspan="2">
<p>Seção <strong>Mapeamento de formato de arquivo</strong></p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Inserir o número do documento. Esse valor afetará o código <strong>Número de arquivo</strong> no relatório do arquivo do Intrastat. Para obter mais informações, consulte Formato de arquivo.</p>
</td>
</tr>
</tbody>
</table>
