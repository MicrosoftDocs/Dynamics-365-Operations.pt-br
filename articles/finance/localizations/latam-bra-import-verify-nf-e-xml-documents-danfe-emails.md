...
-   Lance as notas fiscais eletrônicas que possuem as chaves de acesso que não foram validadas pela SEFAZ. Como alternativa, você pode configurar o Dynamics 365 Finance para lançar somente as notas fiscais eletrônicas com as chaves de acesso validadas pelo SEFAZ.
...
É possível configurar o Finance para consultar o status das chaves de acesso da NF-e na SEFAZ várias vezes. Neste caso, a última consulta é feita depois do período no qual o fornecedor deve cancelar uma NF-e aprovada.
