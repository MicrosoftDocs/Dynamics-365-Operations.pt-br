...
description: Este artigo fornece um exemplo que mostra como lançar entradas e expedições para o Intrastat.
author: anasyash
ms.date: 8/23/2021
ms.topic: article
...
ms.locfileid: "8862954"
---
# <a name="post-arrivals-and-dispatches-for-intrastat"></a>Lançar entradas e expedições para o Intrastat

[!include [banner](../includes/banner.md)]

Este artigo fornece um exemplo que mostra como lançar entradas e expedições para o Intrastat. O exemplo usa a entidade legal **ITCO**.
