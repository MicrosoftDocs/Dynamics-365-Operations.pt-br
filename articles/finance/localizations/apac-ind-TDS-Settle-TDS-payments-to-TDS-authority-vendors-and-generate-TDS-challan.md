...
description: Este artigo explica como liquidar pagamentos de imposto deduzido na origem (TDS) para fornecedores de autoridade TDS.
author: kailiang
ms.date: 03/12/2021
ms.topic: article
ms.prod: ''
...
Este artigo explica como liquidar pagamentos de imposto deduzido na origem (TDS) para fornecedores de autoridade TDS.
