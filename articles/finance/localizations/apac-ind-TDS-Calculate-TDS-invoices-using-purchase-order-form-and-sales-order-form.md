...
description: Este artigo lista as etapas para calcular o Imposto Deduzido na Origem (TDS) em vários tipos de faturas.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Este artigo lista as etapas para calcular o Imposto Deduzido na Origem (TDS) em vários tipos de faturas usando as páginas **Ordem de compra**, **Diário de compras**, **Ordem ampla** e **Ordem de venda**.
