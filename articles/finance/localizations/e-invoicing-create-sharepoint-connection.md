...
description: Este tópico explica como configurar uma conexão para que o faturamento eletrônico possa acessar um site da Microsoft SharePoint.
author: dkalyuzh
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
