...
- [Titulares avançados](emea-advance-holders.md)
 ...
 - [Pagamento adiantado a um funcionário (Europa Oriental)](tasks/advance-payment-employee.md)
- [​Faturamento avançado​](emea-advance-invoice.md)
- [Reconciliação bancária](emea-bank-reconciliation.md)
- [​Faturamento corretivo​](emea-corrective-invoice.md)
- [​Criar e lançar diários periódicos​](emea-create-post-periodic-journals.md)
...
- Arquivos ISO20022
  ...
  - [Configurar método de pagamento do débito direto ISO20022](tasks/setup-method-payment-iso20022-direct-debit.md)
...
- [Ferramenta de geração de referência de pagamento (Europa Oriental)](tasks/ee-00015-payment-reference-generation-tool.md)
...
- Imposto sobre Valor Agregado (IVA)
  - [nome: Configurar a ID do IVA](tasks/eur-00015-vat-id.md)
  - [Registrar uma ID do IVA do fornecedor](tasks/eur-00015-registration-vendor-vat-id.md)
  ...
  - [Data pontual de imposto (Data do registro do IVA)](emea-tax-point-date.md)
