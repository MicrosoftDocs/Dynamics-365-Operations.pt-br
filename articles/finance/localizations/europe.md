...
- [Visão geral de titulares avançados](emea-advance-holders.md)
 ...
 - [Pagamento avançado para funcionário](tasks/advance-payment-employee.md)
- [Faturas antecipadas para o Leste Europeu](emea-advance-invoice.md)
- [Extrato bancário e reconciliação de pagamento](emea-bank-reconciliation.md)
- [​Faturamento corretivo​](emea-corrective-invoice.md)
- [Dividir períodos em diários periódicos](emea-create-post-periodic-journals.md)
- [Criar pagamentos para um cliente que tenha cartas de ordem de débito direto](tasks/create-payments-customers-who-have-direct-debit-mandates.md)
...
- Arquivos ISO20022
  ...
  - [Configuração de transferência de crédito ISO20022 de importação](tasks/import-iso20022-credit-transfer-configuration.md)
  - [Configurar contas bancárias de empresa para transferências de crédito de ISO20022](tasks/set-up-company-bank-accounts-iso20022-credit-transfers.md)
  - [Configurar contas bancárias de empresa para débitos diretos de ISO20022](tasks/set-up-company-bank-accounts-iso20022-direct-debits.md)
  - [Configurar método de pagamento para transferência de crédito de ISO20022](tasks/set-up-method-payment-iso20022-credit-transfer.md)
  - [Configurar método de pagamento para débito direto de ISO20022](tasks/setup-method-payment-iso20022-direct-debit.md)
  - [Configurar clientes e contas bancárias de cliente para débitos diretos de ISO20022](tasks/set-up-bank-accounts-iso20022-direct-debits.md)
  - [Configurar fornecedores e contas bancárias de fornecedor para transferências de crédito de ISO20022](tasks/set-up-vendor-iso20022-credit-transfers.md)
...
- [Visão geral do intrastat](emea-intrastat.md)
  - [Transferir transações para o Intrastat](tasks/transfer-transactions-intrastat.md)
  - [Especificar um endereço de embarque para uma transação intracomunidade](tasks/eur-00002-specify-lading-address-intra-community.md)
...
- [Prazo final de emissão da fatura](emea-invoice-issue-deadline.md)
- [Processamento de faturas](emea-invoice-processing.md)
- [Emitir um certificado de entrada da UE](tasks/eur-00012-issue-eu-entry-certificate.md)
- [Padrões com suporte para faturas eletrônicas](emea-oioubl-standards-electronic-invoicing.md)
- [Geração forçada de faturas eletrônicas](emea-eur-forced-einvoices.md)
- [Referência da fatura original (Europa Oriental)](tasks/ee-00004-original-invoice-reference.md)
- [Pesquisa de participante usando ID de IVA](tasks/eur-00015-party-search-vat-id.md)
- [Ferramenta de geração de referência de pagamento](tasks/ee-00015-payment-reference-generation-tool.md)
- [​Relatório de guia de pagamento​](emea-eur-payment-slip-report-giro.md)
- [Caixa pequeno para o Leste Europeu e a Rússia](emea-petty-cash.md)
...
- Imposto sobre Valor Agregado (IVA)
  - [Configurar a ID do IVA](tasks/eur-00015-vat-id.md)
  - [Registro do ID de VAT do fornecedor](tasks/eur-00015-registration-vendor-vat-id.md)
  - [Visão geral de taxa de câmbio de IVA](emea-vat-exchange-rate.md)
  ...
  - [Exibir transações de liquidação para o Leste Europeu](emea-transactions-settlement-form.md)
  - [Data pontual de imposto (data de registro do IVA)](emea-tax-point-date.md)
  - [Data do registro de IVA do fornecedor](emea-date-vendor-VAT-register.md)
- [Extensão do recurso de motivo financeiro](emea-financial-reason.md)
