---
title: Configurar números de registro de TDS para entidades legais
description: Este tópico explica como configurar números de registro de Imposto Deduzido na Origem (TDS) para entidades legais.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Este tópico explica como configurar números de registro de Imposto Deduzido na Origem (TDS) para entidades legais.
...
4. No campo **Número da divisão**, insira o número da divisão da autoridade de TDS.
5. No campo **Responsável pela avaliação**, insira os detalhes do responsável pela avaliação para a autoridade de TDS.
6. No campo **Tipo de dedutor**, selecione a categoria do tipo de dedutor da entidade legal.
