...
description: Este artigo lista as Guias de tarefas novas ou atualizadas que foram lançadas para a Biblioteca Unificada APQC (novembro de 2016 - todos idiomas) para o Microsoft Dynamics 365 for Operations. Nenhuma nova biblioteca Introdução foi lançada.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8886575"
---
# <a name="new-or-updated-task-guides-november-2016"></a>Guias de tarefas novos ou atualizados (novembro de 2016)

[!include [banner](../includes/banner.md)]

Este artigo lista as Guias de tarefas novas ou atualizadas que foram lançadas para a Biblioteca Unificada APQC (novembro de 2016 – todos idiomas) para o Microsoft Dynamics 365 for Operations. Nenhuma nova biblioteca Introdução foi lançada.

A Biblioteca Unificada APQC (novembro de 2016 - todos os idiomas) contém as Guias de tarefas que devem ser usadas para Ajuda com a atualização 3 da plataforma do Microsoft Dynamics 365 for Operations, Microsoft Dynamics 365 for Operations, a atualização 2 da plataforma do Microsoft Dynamics AX a atualização 3 de maio de 2016 do Dynamics AX e a versão de fevereiro de 2016 do Microsoft Dynamics AX. Para obter mais informações sobre essas versões, consulte [Novidades ou alterações na home page do Finance and Operations](whats-new-changed.md). Versões localizadas nas guias de tarefas estão disponíveis nesta biblioteca. Para obter mais informações sobre como conectar o sistema da Ajuda à uma biblioteca de Guia de tarefas, consulte [Sistema da Ajuda](help-overview.md).

> [!NOTE]
> Um asterisco (\*) ao lado do título de uma linha de Modelador de processo de negócios (BPM) indica que a guia de tarefas para esse processo de negócios foi criado para a atualização de novembro de 2016 do Dynamics 365 for Operations e não tem suporte em versões anteriores do Microsoft Dynamics AX.

### <a name="accounts-payable"></a>Contas a Pagar

| Linha de BPM                                                                                           | País/região |
|----------------------------------------------------------------------------------------------------|----------------|
| Dados principais de fatura no sistema AP usando a aprovação de diário                                               | Global         |
| Dados principais de fatura no sistema AP usando fatura de fornecedor (Inserir e lançar uma fatura de fornecedor com compatibilidade) | Global         |
...
| Registrar o recebimento de fatura do fornecedor e corresponder com as quantidades recebidas                           | Global         |
...
| Calcular juros, criar, imprimir e lançar notas de juros (processar nota de juros) | Global         |
...
| Linha de BPM                    | País/região |
|-----------------------------|----------------|
| Modificar um layout de plano de orçamento | Global         |

### <a name="cash-management"></a>Gerenciamento de pagamento à vista
...
| \*Verificação de continuidade de comprovante chinês                                                                                               | China                             |
...
| \*Lançar comprovantes de outros módulos, como notas fiscais de vendas                                                                          | China                             |
...
| \*EUR-00018 Relatório de reconciliação VAT                                                                                            | Islândia                           |
...
| Manter modelos de dimensão financeira         | Global         |
...
| Linha de BPM                                                                   | País/região |
|----------------------------------------------------------------------------|----------------|
| \*Alterar a propriedade de estoque de consignação com base na demanda de produção | Global         |
| \*Criar uma ordem de reabastecimento de consignação                                 | Global         |
| \*Monitorar o estoque de consignação usando a colaboração de fornecedor                 | Global         |
...
| \*Criar uma avaliação de desempenho                                | Global         |
...
| \*Criar uma nomenclatura de produtos de grades de produto predefinidas | Global         |
| \*Criar uma nomenclatura de produtos de grades de produto configuradas | Global         |
| \* Definir configurações de ordem padrão para um item                            | Global         |
...
| Criar um campo personalizado para o código de cobrança                                      | Global         |
...
| Criar folha de rosto e páginas de assinatura para um relatório de pagamento do setor público   | Global         |
...
| \*Configurar recomendações de produto fornecidas pelo aprendizado de máquina   | Global         |
| Configure o perfil de funcionalidade para determinado representante de vendas | Global         |
| \*Crie um perfil visual de PDV (novembro de 2016)                  | Global         |
...
### <a name="supply-relationship-management"></a>Gerenciamento de relacionamento com o fornecedor
...
| \*Criar um item de menu de dispositivo móvel para consolidação de placa de licença          | Global         |
