...
| Configurar e gerar informações de classificação por vencimento de contas a receber   | Global         |
...
| Liquidar um cheque pré-datado de um cliente                             | Global         |
| Visão geral de pagamentos de fornecedor                                              | Global         |
...
| Exibir demonstrativo de estoque e KPI por objeto de custo                     | Global         |
...
| Pagamento de cliente de importação com o formato de arquivo JBA                                                           | Japão                           |
...
| Linha de BPM                                                  | País/região |
|-----------------------------------------------------------|----------------|
| Alterar convenções de depreciação para vários ativos fixos | Global         |
...
| Linha de BPM                                                      | País/região |
|---------------------------------------------------------------|----------------|
| Adicionar uma política de cálculo de quantidade de kanbans a uma regra kanban     | Global         |
...
| Crie uma ordem de produção                                     | Global         |
...
| Modificar uma previsão de demanda manualmente                 | Global         |
...
| Linha de BPM                                                           | País/região |
|--------------------------------------------------------------------|----------------|
| Adicionar um cálculo a um modelo de configuração de produto                 | Global         |
| Aprovar um modelo de configuração de produto                              | Global         |
| Completar a instalação básica de um produto mestre lançado              | Global         |
| Criar um produto mestre ..\\de dimensões financeiras\\baseado em dimensão  | Global         |
...
| Lançar um produto mestre ..\\de dimensões financeiras\\baseado em dimensão | Global         |
...
| Criar uma entrada avançada no livro razão para o setor Público                                       | Global         |
...
| Configurações de parâmetro para obter demonstrativos de varejo                                            | Global         |
...
| Configurações de loja para demonstrativos de varejo                                                | Global         |
...
| Linha de BPM                                                                          | País/região |
|-----------------------------------------------------------------------------------|----------------|
| Associar um índice de combustível a uma transportadora como um encargo suplementar                    | Global         |
...
| Configurar códigos de disposição                                                         | Global         |
