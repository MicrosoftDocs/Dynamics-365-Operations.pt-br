...
+ Finance and Operations (nuvem)
+ Finance + Operations (local)
...
## <a name="finance-and-operations-applications"></a>Aplicativos do Finance and Operations
...
### <a name="development-and-administration"></a>Desenvolvimento e administração
