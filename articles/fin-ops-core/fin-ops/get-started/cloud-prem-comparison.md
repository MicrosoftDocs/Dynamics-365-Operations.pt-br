...
description: O artigo mostra quais recursos são suportados na Nuvem e locais.
author: sericks007
ms.date: 01/14/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9644132"
---
# <a name="comparison-of-cloud-and-on-premises-features"></a>Comparação de recursos de nuvem e locais

[!include [banner](../includes/banner.md)]

Este artigo mostra comparação recursos disponíveis na nuvem versus na infraestrutura local para os seguintes aplicativos:
...
|                                      | Otimização do planejamento                                                                     | Sim       | Número              |
|                                      | Previsão de demanda                                                                        | Sim       | Número              |
| Aplicativo móvel, espaços de trabalho e plataforma |                                                                                           | Sim       | Sim             |
| Integração do Office                   |                                                                                           | Sim       | Sim             |
| Administração da organização          |                                                                                           | Sim       | Sim             |
