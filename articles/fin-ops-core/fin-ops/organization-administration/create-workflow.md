...
description: Este artigo explica como criar um fluxo de trabalho.
author: ChrisGarty
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
3. Siga os procedimentos no artigo [Configurar propriedades do fluxo de trabalho](configure-workflow-properties.md).
