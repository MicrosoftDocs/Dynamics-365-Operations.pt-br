...
description: Este artigo explica como configurar um elemento do fluxo de trabalho de item de linha.
author: ChrisGarty
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
...
Este artigo explica como configurar um elemento do fluxo de trabalho de item de linha.
