---
title: Criar regras para o Assistente de otimização
description: Este artigo discute como adicionar novas regras ao Optimization advisor.
author: kamaybac
ms.date: 02/04/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9273907"
---
# <a name="create-rules-for-optimization-advisor"></a>Criar regras para o Assistente de otimização
...
Para obter mais informações, assista a este breve vídeo no YouTube: [Optimization advisor in Dynamics 365 Finance](https://www.youtube.com/watch?v=MRsAzgFCUSQ)
