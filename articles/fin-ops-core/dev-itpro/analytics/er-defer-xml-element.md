---
title: Adiar a execução de elementos XML nos formatos ER
description: Este artigo explica como adiar a execução de um elemento de XML em um formato de ER (Relatório eletrônico).
author: kfend
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
...
Se você ainda não tiver concluído o exemplo no artigo [Adiar a execução de elementos de sequência nos formatos de ER](er-defer-sequence-element.md#Example), baixe as [configurações](general-electronic-reporting.md#Configuration) a seguir do exemplo da solução ER.
