...
description: Este artigo descreve o conteúdo de benefícios do Power BI.
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848799"
---
# <a name="benefits-power-bi-content"></a>Conteúdo de benefícios do Power BI

[!include [banner](../includes/banner.md)]

Este artigo descreve o conteúdo de **Benefícios** do Microsoft Power BI. Ele explica como acessar os relatórios incluídos no conteúdo, além de fornecer informações sobre o modelo de dados e as entidades usadas para criar o conteúdo.
