---
title: Armazenamento em backup de modelos ER
description: Este artigo explica como usar o armazenamento de backup de relatórios eletrônicos (ER) para a recuperação de modelos.
author: kfend
ms.date: 04/29/2020
ms.topic: article
ms.prod: ''
...
Cópias de backup de modelos são migradas para uma nova instância de finanças e operações como parte do banco de dados do aplicativo.
...
1. Em finanças e operações, abra a página **Administração da organização \> Relatório eletrônico \> Configurações**.
