...
description: Este artigo explica como organizar objetos no report designer, blocos de construção e relatórios existentes.
author: aprilolson
ms.date: 11/22/2022
ms.topic: article
ms.prod: ''
...
Você pode renomear pastas, relatórios, blocos de construção e outros objetos no Report Designer para ajudar a organizar arquivos. Dependendo do tipo de objeto que você renomear, talvez seja necessário atualizar associações a esse objeto.

## <a name="rename-a-folder-or-building-block-in-report-designer"></a>Renomear uma pasta ou um bloco de construção no Report Designer
No Report Designer, você pode renomear pastas, além de definições de relatórios, de linhas, de colunas e de hierarquia organizacional.
...
1. No Report Designer, clique em **Grupos de relatórios** no painel de navegação.
...
3. Clique na guia **Grupo de relatórios** e faça as alterações desejadas.
...
> [NOTE] Se você agendou relatórios para que sejam gerados em intervalos definidos, poderá substituir essas configurações e gerar logo um relatório.
...
<tbody>
<tr>
<td>Substituir configurações de empresa, detalhe e data de definições de relatório individuais</td>
...
<td>Todas as moedas de relatório adicionais configuradas no sistema Microsoft Dynamics 365 Finance são listadas aqui. Marque esta caixa de seleção para que os relatórios adicionais sejam gerados nas moedas indicadas. Para exibir esses relatórios no Visualizador da Web, clique no botão <strong>Moeda</strong> e selecione uma moeda.</td>
</tr>
<tr>
