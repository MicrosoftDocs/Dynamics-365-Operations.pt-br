...
description: O artigo descreve como um usuário do Regulatory Configuration Service (RCS) pode criar um novo mapeamento de modelo de relatório eletrônico usando os metadados.
author: kfend
ms.date: 06/28/2019
