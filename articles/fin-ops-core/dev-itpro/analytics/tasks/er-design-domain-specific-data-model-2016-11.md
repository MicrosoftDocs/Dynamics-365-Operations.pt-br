...
description: Este artigo descreve como criar uma nova configuração de Relatório Eletrônico (ER) que contém um modelo de dados para documentos de pagamento eletrônico.
author: kfend
ms.date: 08/29/2018
