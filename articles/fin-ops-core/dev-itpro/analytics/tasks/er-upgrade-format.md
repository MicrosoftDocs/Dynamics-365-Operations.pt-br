...
description: Este artigo descreve como fazer manutenção de uma configuração de formato para relatórios eletrônicos (ER).
author: NickSelin
ms.date: 08/29/2018
