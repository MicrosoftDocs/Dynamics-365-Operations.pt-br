...
---
# <a name="er-configure-format-to-do-counting-and-summing-part-2-configure-computations"></a>ER Configurar formato para fazer contagem e soma (parte 2: configurar computações)
