...
description: Este artigo descreve o que está incluído no conteúdo do Power BI de análise de gastos da compra.
author: FrankDahl
ms.date: 04/24/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9206681"
---
# <a name="purchase-spend-analysis-power-bi-content"></a>Conteúdo de análise de gastos em compras do Power BI

[!include [banner](../includes/banner.md)]

Este artigo descreve o que está incluído no conteúdo do Microsoft Power BI de **Análise de gastos da compra**. Ele explica como acessar os relatórios do Power BI e fornece informações sobre o modelo de dados e entidades que são usados para criar o conteúdo.
