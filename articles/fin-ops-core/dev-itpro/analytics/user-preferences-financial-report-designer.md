...
description: Este artigo descreve como definir as preferências do usuário para personalizar as interações do usuário no Report Designer financeiro e controlar a experiência de logon inicial.
author: aprilolson
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
