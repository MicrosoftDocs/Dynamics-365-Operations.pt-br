...
description: Este artigo lista soluções do PowerBI.com que estão disponíveis e indica os recursos onde você pode aprender mais sobre as soluções.
author: sericks007
ms.date: 10/02/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9273050"
---
# <a name="power-bi-content-home-page"></a>Home page de conteúdo do Power BI

[!include [banner](../includes/banner.md)]

As soluções do PowerBI.com a seguir estão disponíveis para os ambientes de aplicativos.
...
> [!NOTE]
> A maioria das soluções do PowerBI.com na lista a seguir foram inseridas em espaços de trabalho analíticos em versões recentes. Usar espaços de trabalho analíticos elimina a necessidade de baixar essas soluções da biblioteca de ativos compartilhados no LCS. Os tópicos desta lista indicam que essas soluções do PowerBI.com foram inseridas quando aplicável.

- [Real vs. orçamento](ledger-budgets-power-bi.md)
- [Visão geral do caixa](../../../finance/cash-bank-management/Cash-Overview-Power-BI-content.md)
...
- [Gerenciamento de crédito e cobranças](../../../finance/accounts-receivable/credit-collections-power-bi.md)
...
- [Gerenciamento de ativo fixo](../../../finance/fixed-assets/Fixed-asset-management-workspace.md)
...
- [Pagamentos de fornecedor](../../../finance/accounts-payable/Vendor-payments-workspace.md)
...
> [!NOTE]
> Essas soluções foram preteridas, conforme documentado nos [pacotes de conteúdo do Power BI disponíveis em AppSource](../migration-upgrade/deprecated-features.md#power-bi-content-packs-available-on-appsource).
