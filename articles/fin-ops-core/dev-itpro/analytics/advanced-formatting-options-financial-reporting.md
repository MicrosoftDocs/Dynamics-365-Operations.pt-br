...
description: Este artigo descreve as funções de formatação avançadas, incluindo filtros, restrições, linhas não imprimíveis e instruções condicionais em cálculos.
author: panolte
ms.date: 04/26/2019
ms.topic: article
ms.prod: ''
...
|           Formatar             | A   | E    | E        | B      | E      | S    |
|------------------------------|-----|------|----------|--------|--------|------|
| Cabeçalho 1                     |     |      |          |        |        |      |
| Cabeçalho 2                     | A   | E    | E        | B      | E      | S    |
| Cabeçalho 3                     |     |      |          |        |        |      |
...
|    Formatar                    | A   | E    | E      | B            | E     | S            |
|------------------------------|-----|------|--------|--------------|-------|--------------|
| Cabeçalho 1                     | A   | E    | E      | B            | E     | S            |
| Cabeçalho 2                     | -   | -    | Até a presente data    | Vendas Anuais | Operador | $ Por Pessoa |
| Cabeçalho 3                     |     |      |        |              |       |              |
