...
---
# <a name="EmailDestinationType">Destino de email</a>
...
[![Configurar conta de origem de email](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)
