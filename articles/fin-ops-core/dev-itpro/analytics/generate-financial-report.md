...
À medida que a geração do relatórios avança, os indicadores a seguir de status da fila de relatórios podem ficar visíveis na página **Status da Fila de Relatórios**.
...
À medida que agendas de relatório são criados e salvas, elas são exibidas no painel de navegação em Agendamentos de Relatórios. Você pode criar pastas para organizar seus relatórios. Se um único relatório em um plano não é for executado, todos os relatórios que continuarão em execução.
