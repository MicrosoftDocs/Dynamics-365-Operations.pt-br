...
description: Este artigo descreve o que está incluído no conteúdo do Power BI Desempenho de vendas e lucratividade.
...
Este artigo descreve o que está incluído no conteúdo **Desempenho de vendas e lucratividade** do Microsoft Power BI. Ele explica como acessar os relatórios do Power BI e fornece informações sobre o modelo de dados e entidades que são usados para criar o conteúdo.
