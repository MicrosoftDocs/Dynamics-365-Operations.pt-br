...
Para obter mais informações sobre as próximas alterações, consulte [Dados no Common Data Service – fase 1 e 2](https://docs.microsoft.com/dynamics365-release-plan/2019wave2/finance-operations-crossapp-capabilities/data-common-data-service-phase-1).
