...
description: Este artigo descreve como a integração da gravação dupla oferece suporte a criação de ordens de compra e atualizações do Supply Chain Management e do Field Service.
