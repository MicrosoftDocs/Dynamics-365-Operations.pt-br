...
Os três modelos de Data Factory a seguir são fornecidos. Eles ajudam a reconciliar os dados dos aplicativos de finanças e operações e de participação do cliente.
...
|---|---|
| FONewParty.csv | Este arquivo ajuda a criar novos registros de **Participante** no aplicativo de finanças e operações. |
| ImportFONewPostalAddressLocation.csv | Este arquivo ajuda a criar registros de **Localização do Endereço Postal** no aplicativo de finanças e operações. |
| ImportFONewPartyPostalAddress.csv | Este arquivo ajuda a criar registros de **Endereço Postal do Participante** no aplicativo de finanças e operações. |
| ImportFONewPostalAddress.csv | Este arquivo ajuda a criar novos registros de **Endereço Postal** no aplicativo de finanças e operações. |
| ImportFONewElectronicAddress.csv | Este arquivo ajuda a criar novos registros de **Endereço Eletrônico** no aplicativo de finanças e operações. |
...
+ **Instantâneo**: tire instantâneos dos aplicativos de finanças e operações e de participação do cliente. Você pode usar os instantâneos para restaurar o estado anterior, se necessário.
...
1. Faça login nos aplicativos do Customer Engagement e acesse **Configurações** \> **Configurações de Personalização**. Na guia **Geral**, defina a configuração de fuso horário para a conta de administrador do sistema. O fuso horário precisar estar no Tempo Universal Coordenado (UTC) para atualizar as datas "válido desde" e "válido até" dos endereços postais dos aplicativos de finanças e operações.
...
2. No Data Factory, na guia **Gerenciar**, em **Parâmetros Globais**, crie o seguinte parâmetro global:
    ...
    |---|---|---|---|
    | 1 | PostalAddressIdPrefix | cadeia de caracteres | Esse parâmetro anexa um número de série a endereços postais criados recém-criados como um prefixo. Forneça uma cadeia de caracteres que não entre em conflito com endereços postais nos aplicativos de finanças e operações e nos aplicativos de participação do cliente. Por exemplo, use **ADF-PAD-**. |
...
1. No Data Factory, na guia **Gerenciar**, em **Parâmetros Globais**, crie os seguintes parâmetros globais:
    ...
    | Número | Nome | Tipo | Valor |
    |---|---|---|---|
    | 1 | IsFOSource | bool | Esse parâmetro determina quais endereços principais do sistema serão substituídos no caso de conflitos. Se o valor for **verdadeiro**, os endereços principais nos aplicativos de finanças e operações substituirão os endereços principais nos aplicativos de participação do cliente. Se o valor for **falso**, os endereços principais nos aplicativos de participação do cliente substituirão os endereços principais nos aplicativos de finanças e operações. |
    | 2 | ElectronicAddressIdPrefix | cadeia de caracteres | Esse parâmetro anexa um número de série a endereços eletrônicos criados recém-criados como um prefixo. Forneça uma cadeia de caracteres que não entre em conflito com endereços eletrônicos nos aplicativos de finanças e operações e de participação do cliente. Por exemplo, use **ADF-EAD-**. |
...
4. No aplicativo de finanças e operações, execute a **Sincronização Inicial** para as tabelas a seguir que tiverem dados:
...
8. Importe os novos registros de **Participante** para o aplicativo de finanças e operações.
...
9. Na data factory, execute os modelos de Endereço eletrônico do participante e de Endereço postal do participante, um após o outro.
...
2. As etapas de 7-1 a 7-9 recuperam dados dos aplicativos de finanças e operações e de participação do cliente, e transferem as informações para atualização.
3. As etapas de 8 a 9 comparam o número do participante dos registros de **Conta**, **Contato** e **Fornecedor** entre o aplicativo de finanças e operações e o aplicativo de participação do cliente. Os registros sem um número de participante são ignorados.
4. A etapa 10 gera dois arquivos .csv para os registros de participante que devem ser criados nos aplicativos de participação do cliente e de finanças e operações.
...
1. As etapas de 1-1 a 1-10 recuperam dados dos aplicativos de finanças e operações e de participação do cliente, e transferem as informações para atualização.
2. A etapa 2 desnormaliza os dados do endereço postal no aplicativo de finanças e operações unindo o endereço postal e o endereço postal do participante.
...
4. A etapa 4 cria arquivos .csv para o aplicativo de finanças e operações criar dados de endereço com base nos endereços de conta, contato e fornecedor.
5. A etapa 5-1 cria arquivos .csv para o aplicativo de participação cliente criar todos os dados de endereço com base nos aplicativos de finanças e operações e de participação do cliente.
6. A etapa 5-2 converte os arquivos .csv no formato de importação de finanças e operações para a importação manual.
...
1. As etapas de 1-1 a 1-5 recuperam dados dos aplicativos de finanças e operações e de participação do cliente, e transferem as informações para atualização.
...
3. A etapa 3 mescla os dados do endereço eletrônico principal dos aplicativos de participação do cliente e de finanças e operações.
4. A etapa 4 cria os arquivos .csv.

    - Crie dados de endereço eletrônico para o aplicativo de finanças e operações com base nos endereços de conta, contato e fornecedor.
    - Crie dados de endereço eletrônico para o aplicativo de participação do cliente com base nos endereços eletrônico, de conta, contato e fornecedor no aplicativo de finanças e operações.
