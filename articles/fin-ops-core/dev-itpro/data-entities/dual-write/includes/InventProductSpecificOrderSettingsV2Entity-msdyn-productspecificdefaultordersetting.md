## <a name="product-default-order-settings-v2-to-msdyn_productspecificdefaultordersettings"></a>Configurações de ordem padrão de produto V2 para msdyn_productspecificdefaultordersettings
