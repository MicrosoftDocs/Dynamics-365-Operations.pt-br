...
1. <span data-ttu-id="4b8ea-109">Clique em Novo.</span><span class="sxs-lookup"><span data-stu-id="4b8ea-109">Click New.</span></span>
2. <span data-ttu-id="4b8ea-110">Selecione um tipo para agrupar perguntas relacionadas.</span><span class="sxs-lookup"><span data-stu-id="4b8ea-110">Select a Type to group related questions.</span></span>
3. <span data-ttu-id="4b8ea-111">Na lista, localize e selecione o PDV desejado.</span><span class="sxs-lookup"><span data-stu-id="4b8ea-111">In the list, find and select the desired record.</span></span>
4. <span data-ttu-id="4b8ea-112">Na lista, clique no link na linha selecionada.</span><span class="sxs-lookup"><span data-stu-id="4b8ea-112">In the list, click the link in the selected row.</span></span>
    * <span data-ttu-id="4b8ea-113">Os tipos de entrada de texto, inteiro, real, data, hora e nota são usados para questões de conclusão abertas.</span><span class="sxs-lookup"><span data-stu-id="4b8ea-113">Input types of Text, Integer, Real, Date, Time, and Note are used for open-ended questions.</span></span>  
5. <span data-ttu-id="4b8ea-114">No campo Tipo de entrada, selecione uma opção.</span><span class="sxs-lookup"><span data-stu-id="4b8ea-114">In the Input type field, select an option.</span></span>
    * <span data-ttu-id="4b8ea-115">Um tipo de entrada ou de nota de texto é usado para uma pergunta em aberto.</span><span class="sxs-lookup"><span data-stu-id="4b8ea-115">An input type of Text or Note is used for an open-ended question.</span></span>  
6. <span data-ttu-id="4b8ea-116">No campo Texto, digite sua pergunta.</span><span class="sxs-lookup"><span data-stu-id="4b8ea-116">In the Text field, enter your question.</span></span>
