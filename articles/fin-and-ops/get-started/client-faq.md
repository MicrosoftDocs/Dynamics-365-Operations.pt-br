...
Se você clicar com o botão direito do mouse em um campo editável (ou se o texto for selecionada), o menu de atalho do navegador será exibido. Esse menu fornece acesso aos comandos **Recortar**, **Copiar**, e **Colar**. Não podemos inserir esses comandos nos menus de atalho do Finance and Operations. Por motivo de segurança, os navegadores não permitem acessar a área de transferência do sistema de forma programática.
...
Para facilitar o acesso do teclado, planejamos implementar no futuro um atalho de teclado que abre o menu de atalho do Finance and Operations.

## <a name="where-is-the-view-details-functionality-in-finance-and-operations"></a>Onde está o recurso de exibição de detalhes no Finance and Operations?
