...
Este tópico descreve os elementos da interface do usuário (IU) usados no Dynamics 365 for Finance and Operations. Para que os usuários possam navegar na interface, é importante saber os nomes e funções dos elementos que constituem a interface.
