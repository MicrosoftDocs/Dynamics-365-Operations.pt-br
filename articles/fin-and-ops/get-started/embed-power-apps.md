...
- **isPowerAppPersonalizationEnabled** – Se este método retornar falso para uma página específica, então o botão de menu PowerApps não aparecerá e os usuários não poderão inserir PowerApps em algum lugar desta página, incluindo uma guia.
- **isPowerAppTabPersonalizationEnabled** – Se este método retornar falso para uma página específica, os usuários não poderão inserir PowerApps diretamente na página como uma guia, Guia Rápida, ou a seção do panorama. Os usuários ainda poderão inserir o PowerApps através do botão de menu do PowerApps, se a inserção for permitida na página.
