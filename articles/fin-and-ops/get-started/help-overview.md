...
> [!IMPORTANT]
> Os dados inseridos quando você executa um guia de tarefas são reais. Se você estiver em um ambiente de produção, os dados serão inseridos na empresa que você estiver usando no momento.
...
No painel de Ajuda, você pode acessar artigos que se aplicam ao cliente do Finance and Operations. Ao abrir pela primeira vez o painel de Ajuda e clicar na guia **Ajuda**, você verá os artigos que se aplicam à página que estiver utilizando no Finance and Operations. Se nenhum artigo for encontrado, você poderá inserir palavras-chave para refinar a pesquisa. Quando você clicar em um artigo no painel de Ajuda, uma nova aba será aberta no seu navegador e exibirá o artigo.
...
Assim que um Administrador do sistema concluir essas etapas, você poderá abrir o painel de Ajuda e clicar em **Guias de tarefas**. Agora você verá as guias de tarefas que se aplicam à página que você está utilizando no momento no Finance and Operations. Se nenhum guia de tarefas for encontrado, você poderá inserir palavras-chave para refinar a pesquisa. Depois de clicar em um guia de tarefas no painel de Ajuda, o painel de Ajuda exibirá as instruções passo a passo, e você pode executar o guia de tarefas.
...
| [Blog de suporte](https://aka.ms/AXSupportBlog)                                                    | Fornece dicas e truques postadas pela Equipe de suporte do Dynamics 365 for Finance and Operations. |
