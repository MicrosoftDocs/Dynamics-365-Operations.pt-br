...
Esse recurso pode ser usado para validar se uma ação ocorreu. Por exemplo, quando uma ordem de produção é criada, prevista e iniciada o Microsoft Dynamics 365 for Finance and Operations mostra uma mensagem de "Produção – Iniciar" para notificar que a ordem de produção foi iniciada.
...
Depois que o caso de teste for executado, a mensagem no arquivo de parâmetro do Excel é comparada à mensagem mostrada no Finance and Operations. Se as mensagens não forem correspondentes, o caso de teste falhará.
