...
#### [Versões e política do ciclo de vida](../dev-itpro/migration-upgrade/versions-update-policy.md?toc=/fin-and-ops/toc.json)
...
#### [Segurança e entidades de dados](../dev-itpro/data-entities/security-data-entities.md?toc=/fin-and-ops/toc.json)
...
#### [Modificar um formato reaplicando um modelo do Microsoft Excel para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-modify-format-by-reapplying-microsoft-excel-template-july-2017.md?toc=/fin-and-ops/toc.json)
...
##### [Criar modelo de dados para usar dimensões financeiras como uma fonte de dados para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-1.md?toc=/fin-and-ops/toc.json)
##### [Mapear modelos para usar dimensões financeiras como uma fonte de dados para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-2.md?toc=/fin-and-ops/toc.json)
##### [Criar um relatório para usar dimensões financeiras como uma fonte de dados para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-3.md?toc=/fin-and-ops/toc.json)
##### [Executar um relatório que use dimensões financeiras como uma fonte de dados para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-4.md?toc=/fin-and-ops/toc.json)
##### [Criar formato para contagem e soma para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-format-counting-summing-1.md?toc=/fin-and-ops/toc.json)
##### [Configurar cálculos para contagem e soma para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-format-counting-summing-2.md?toc=/fin-and-ops/toc.json)
##### [Usar cálculos para criar a saída para contagem e soma para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-format-counting-summing-3.md?toc=/fin-and-ops/toc.json)
##### [Executar o formato para fazer a contagem e soma para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-format-counting-summing-4.md?toc=/fin-and-ops/toc.json)
##### [Criar um formato para usar intervalos expansíveis horizontalmente para adicionar dinamicamente colunas em relatórios do Excel para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-horizontal-1.md?toc=/fin-and-ops/toc.json)
##### [Executar um formato que usa intervalos expansíveis horizontalmente para adicionar dinamicamente colunas em relatórios do Excel para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-horizontal-2.md?toc=/fin-and-ops/toc.json)
##### [Preparar modelo de dados para usar arquivos de Gerenciamento de Documentos em saídas de formato para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-document-management-files-1.md?toc=/fin-and-ops/toc.json)
##### [Estender modelo de dados para usar arquivos de Gerenciamento de Documentos em saídas de formato para relatório eletrônico](../dev-itpro/analytics/tasks/er-document-management-files-2.md?toc=/fin-and-ops/toc.json)
##### [Criar formato para usar arquivos de Gerenciamento de Documentos em saídas de formato para relatório eletrônico](../dev-itpro/analytics/tasks/er-document-management-files-3.md?toc=/fin-and-ops/toc.json)
##### [Executar formato para usar arquivos de Gerenciamento de Documentos em saídas de formato para relatório eletrônico](../dev-itpro/analytics/tasks/er-document-management-files-4.md?toc=/fin-and-ops/toc.json)
##### [Modificar e executar formato para usar arquivos de Gerenciamento de Documentos em saídas de formato para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-document-management-files-5.md?toc=/fin-and-ops/toc.json)
##### [Criar configurações para gerar relatórios em formatos do Microsoft Office com imagens incorporadas para relatórios eletrônicos (ER) (Parte 1) ](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md?toc=/fin-and-ops/toc.json)
##### [Revisar configurações para criar relatórios em formatos do Microsoft Office com imagens incorporadas para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-2-review-configurations.md?toc=/fin-and-ops/toc.json)
##### [Gerar relatórios em formatos do Microsoft Office com imagens incorporadas para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-3-generate-reports.md?toc=/fin-and-ops/toc.json)
#### [Gerar documentos eletrônicos e atualizar dados do aplicativo com a ferramenta de Relatório eletrônico](../dev-itpro/analytics/generate-electronic-documents-update-application-data.md?toc=/fin-and-ops/toc.json)
##### [Importar configurações para gerar documentos com a atualização de dados do aplicativo para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-1-import-configurations.md?toc=/fin-and-ops/toc.json)
##### [Gerar documentos com a atualização de dados do aplicativo para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-2-generate-documents.md?toc=/fin-and-ops/toc.json)
##### [Modificar modelo e mapeamento para gerar documentos com a atualização de dados do aplicativo para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-3-modify-model-mapping.md?toc=/fin-and-ops/toc.json)
##### [Modificar formato para gerar documentos com a atualização de dados do aplicativo para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-4-modify-format.md?toc=/fin-and-ops/toc.json)
##### [Gerar documentos com a atualização de dados do aplicativo para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-5-generate-documents-application-data-update.md?toc=/fin-and-ops/toc.json)
#### [Inserir imagem e formas em documentos comerciais geradas usando a ferramenta de relatórios eletrônicos](../dev-itpro/analytics/electronic-reporting-embed-images-shapes.md?toc=/fin-and-ops/toc.json)
...
##### [Gerenciar configurações de mapeamentos de modelo para relatórios eletrônicos](../dev-itpro/analytics/tasks/er-manage-model-mapping-configurations-july-2017.md?toc=/fin-and-ops/toc.json)
...
#### [Analisar documentos de entrada para atualizar os dados do aplicativo](../dev-itpro/analytics/parse-incoming-electronic-documents.md?toc=/fin-and-ops/toc.json)
#### [Analisar documentos de entrada no formato de CSV](../dev-itpro/analytics/parse-incoming-electronic-documents-csv-format.md?toc=/fin-and-ops/toc.json)

##### [Alterações na API da estrutura do relatório eletrônico para Application update 7.3](../dev-itpro/analytics/er-apis-app73.md?toc=/fin-and-ops/toc.json)
